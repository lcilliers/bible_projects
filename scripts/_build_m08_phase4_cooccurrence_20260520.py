"""M08 Phase 4 co-occurrence list (informational, per v2_8 §7.3.1).
...
Transfers in scope (per M08 Phase 3 verdicts, 2026-05-20):
- G0830 authairetos (mti_id=3081) -> M29 (Desire)  — self-chosen volition
- H1984I ha.lal      (mti_id=4335) -> M16 (Folly)   — to rave / be mad (homonymic sense-split)
- H7989 shal.lit     (mti_id=1312) -> M23 (Strength)— institutional authority / ruler

BOUNDARY (no Phase 4 DB write, carries forward to Phase 5/6):
- G0193 akrates      (mti_id=1113) — supportive/qualifying (§6.3.1 reason 3)
"""
import sys, io
...
OUT = Path('Sessions/Session_Clusters/M08/WA-M08-phase4-cooccurrence-list-v1-20260520.md')

TRANSFERS = [
    (3081, 'G0830', 'authairetos', 'M29', 'self-chosen volition (positive register)'),
    (4335, 'H1984I', 'ha.lal',     'M16', 'rave / be mad — homonymic sense-split from boast/praise'),
    (1312, 'H7989', 'shal.lit',    'M23', 'institutional authority / ruler (Joseph)'),
]
...
lines.append("# M08 Phase 4 co-occurrence list (informational)")
lines.append("")
lines.append(f"**Date:** {NOW}")
lines.append("**Source cluster:** M08")
lines.append("**Per:** v2_8 §7.3.1 — informational input to Phase 4 directive MOTIVATION.")
lines.append("")
