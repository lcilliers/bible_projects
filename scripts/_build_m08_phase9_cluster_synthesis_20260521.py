...
Outputs:
  Sessions/Session_Clusters/M08/WA-M08-phase9-cluster-synthesis-brief-v1-{date}.md
  Sessions/Session_Clusters/M08/WA-M08-phase9-cluster-synthesis-input-v1-{date}.md
"""
...
BRIEF = Path(f"Sessions/Session_Clusters/M08/WA-M08-phase9-cluster-synthesis-brief-v1-{TODAY}.md")
INPUT = Path(f"Sessions/Session_Clusters/M08/WA-M08-phase9-cluster-synthesis-input-v1-{TODAY}.md")
...
def main():
    ...
    B.append("")
    B.append(f"1. Save the output as `Sessions/Session_Clusters/M08/WA-M08-phase9-cluster-synthesis-findings-v1-{TODAY}.md`.")
    B.append(f"2. If segmenting by tier-pair: filename pattern `WA-M08-phase9-cluster-synthesis-findings-seg{{N}}-T#T#-v1-{TODAY}.md` in a sub-folder.")
