...
def main():
    ...
    B.append("| 3 | **Citation discipline** | Every E finding cites at least one verse-reference or VCG code (e.g. `Pro 16:5`, `M08-A1-VCG-01`) | ALERT — name the uncited E prompts; do NOT proceed |")
