...
Outputs (per characteristic):
    Sessions/Session_Clusters/M08/WA-M08-phase9-char{N}-{short_name}-brief-v1-{date}.md
    Sessions/Session_Clusters/M08/WA-M08-phase9-char{N}-{short_name}-input-v1-{date}.md
"""
...
def main():
    ...
    # ===== File paths =====
    BRIEF = Path(f"Sessions/Session_Clusters/M08/WA-M08-phase9-char{args.char_seq}-{safe_short}-brief-v1-{TODAY}.md")
    INPUT = Path(f"Sessions/Session_Clusters/M08/WA-M08-phase9-char{args.char_seq}-{safe_short}-input-v1-{TODAY}.md")
    ...
    B.append("")
    B.append(f"1. Drop the output in `Sessions/Session_Clusters/M08/WA-M08-phase9-char{args.char_seq}-{safe_short}-findings-v1-20260521.md`")
