# Session A — Term `H4253` *ma.cha.la.phah* — lock

**Registry:** 134 renewal  
**mti_term_id:** 6134  
**Language:** Hebrew  
**md_version:** `v1`  ⚠ the patch's `_patch_meta.input_versions[6134]` must equal `1` at submission time or the applicator will reject it as stale (A-03 version gate).  
...
a single OWNER term — `H4253` *ma.cha.la.phah* (lock) from registry
...
`mti_term_id = 6134`. On apply, Claude Code flips
...
*End of Session A prose for term H4253
(134 renewal).*
