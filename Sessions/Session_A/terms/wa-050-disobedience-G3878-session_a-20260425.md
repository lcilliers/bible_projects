# Session A — Term `G3878` *parakouō* — to ignore

**Registry:** 050 disobedience  
**mti_term_id:** 5111  
**Language:** Greek  
**md_version:** `v1`  ⚠ the patch's `_patch_meta.input_versions[5111]` must equal `1` at submission time or the applicator will reject it as stale (A-03 version gate).  
...
a single OWNER term — `G3878` *parakouō* (to ignore) from registry
...
- **Language:** Greek
- **mti_term_id:** 5111
- **STEP gloss:** to ignore
- **Word-analysis gloss:** to ignore
- **Mounce short def:** to refuse to listen, ignore
- **Occurrence count:** 7

**Parsed senses:**

- `1` to refuse to listen, ignore 
to overhear, Mk. 5:36; to hear amiss, to fail to listen, refuse to listen, neglect to obey, disregard, Mt. 18:17 (2x)*
...
- `PROSE_ONLY_MEANING` — Meaning for G3878 stored as single prose block. STEP medium_def contains no structured sense numbering. No further subdivision available.
- `VERSE_EVIDENCE_CONCENTRATED` — Only 2 confirmed verse records for G3878. Threshold is 5.
...
### G3878 · *parakouō* — 2 active verse(s)
...
|---|---|---|
| `5111-001` | Term names the wilful refusal to hear — the inner orientation of closed attention or contempt expressed through the repeated failure to receive the voice of the community | active |

**Verses:**

**vid=155906** — `Mat 18:17`
*target word in verse:* `listen`

> Mat 18:17 If he refuses to listen to them , tell it to the church . And if he refuses to listen even to the church , let him be to you as a Gentile and a tax collector .

_Prior classification: **relevant** · **anchor** · group=`5111-001`_


**vid=155905** — `Mar 5:36`
*target word in verse:* `overhearing`
...
| `G0545` | apeithēs | disobedient | Greek |
| `G0545` | apeithēs | disobedient | Greek |
| `G3876` | parakoē | disobedience | Greek |
...
`mti_term_id = 5111`. On apply, Claude Code flips
...
*End of Session A prose for term G3878
(050 disobedience).*
