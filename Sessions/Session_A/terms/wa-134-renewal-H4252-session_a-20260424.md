# Session A — Term `H4252` *ma.cha.laph* — knife

**Registry:** 134 renewal  
**mti_term_id:** 6137  
**Language:** Hebrew  
**md_version:** `v1`  ⚠ the patch's `_patch_meta.input_versions[6137]` must equal `1` at submission time or the applicator will reject it as stale (A-03 version gate).  
...
a single OWNER term — `H4252` *ma.cha.laph* (knife) from registry
...
This term has **0 active** prior `verse_context_group`
...
`mti_term_id = 6137`. On apply, Claude Code flips
...
*End of Session A prose for term H4252
(134 renewal).*
