# Session A — Term `H6293` *pa.ga* — to fall on
...
a single OWNER term — `H6293` *pa.ga* (to fall on) from registry
...
- **Language:** Hebrew
- **mti_term_id:** 937
- **STEP gloss:** to fall on
- **Word-analysis gloss:** to fall on
- **Occurrence count:** 46
...
- `H4645` *miph.ga* — target
- `H6294` *pe.ga* — chance
- `H6295` *pag.i.el* — Pagiel

**Root family:**

- `PAGA` (Hebrew) — target — Backfilled 2026-04-09 from wa_term_related_words clustering

**Data-quality flags (informational):**

- `NO_WORD_ANALYSIS` — meaning field is null for H6293. STEP returned no word analysis block for this term.
...
### H6293 · *pa.ga* — 43 active verse(s)

- **mti_term_id:** 937
- **Language:** Hebrew
- **Gloss:** to fall on
- **Total verses:** 43 (43 active, 0 delete_flagged)
...
|---|---|---|
| `937-001` | Term names the inner act of intercession — entreaty or pleading on behalf of another before God, or the absence of such intercession as a moral absence | active |
| `937-002` | Term names the substitutionary laying of iniquity on another — the moral burden of the many placed on the one who bears it | active |

**Verses:**

**vid=28154** — `Gen 23:8`
*target word in verse:* `entreat`
...
**vid=175156** — `Rut 2:22`
*target word in verse:* `assaulted`
...
**vid=28159** — `Isa 53:6`
*target word in verse:* `laid`

> Isa 53:6 All we like sheep have gone astray ; we have turned —every one —to his own way ; and the Lord has laid on him the iniquity of us all .

_Prior classification: **relevant** · **anchor** · group=`937-002`_


**vid=28158** — `Isa 53:12`
*target word in verse:* `makes intercession`

> Isa 53:12 Therefore I will divide him a portion with the many , and he shall divide the spoil with the strong , because he poured out his soul to death and was numbered with the transgressors ; yet he bore the sin of many , and makes intercession for the transgressors .

_Prior classification: **relevant** · **anchor** · group=`937-001`_


**vid=28160** — `Isa 59:16`
*target word in verse:* `intercede`
...
`mti_term_id = 937`. On apply, Claude Code flips
...
*End of Session A prose for term H6293
(094 intercession).*
