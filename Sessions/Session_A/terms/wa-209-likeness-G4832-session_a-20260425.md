# Session A — Term `G4832` *summorfos* — conformed

**Registry:** 209 likeness  
**mti_term_id:** 7360  
**Language:** Greek  
**md_version:** `v1`  ⚠ the patch's `_patch_meta.input_versions[7360]` must equal `1` at submission time or the applicator will reject it as stale (A-03 version gate).  
...
a single OWNER term — `G4832` *summorfos* (conformed) from registry
209 likeness. It contains the STEP-sourced data for this one term only.
...
- **Language:** Greek
- **mti_term_id:** 7360
- **STEP gloss:** conformed
- **Word-analysis gloss:** conformed
- **Mounce short def:** conformed, being like
- **Occurrence count:** 2

**Parsed senses:**

- `1` conformed, being like 
...
- `SUMMORF` (Greek) — conformed — Backfilled 2026-04-09 from wa_term_related_words clustering

**Data-quality flags (informational):**

- `NO_WORD_ANALYSIS` — meaning field is null for G4832. STEP returned no word analysis block for this term.
- `PROSE_ONLY_MEANING` — Meaning for G4832 stored as single prose block. STEP medium_def contains no structured sense numbering. No further subdivision available.
- `VERSE_EVIDENCE_CONCENTRATED` — Only 2 confirmed verse records for G4832. Threshold is 5.
...
### G4832 · *summorfos* — 2 active verse(s)
...
|---|---|---|
| `7360-001` | Term describes the person's conformity to the image and likeness of Christ — the inner and eschatological telos of the person's transformation | active |

**Verses:**

**vid=231145** — `Rom 8:29`
*target word in verse:* `conformed`

> Rom 8:29 For those whom he foreknew he also predestined to be conformed to the image of his Son , in order that he might be the firstborn among many brothers .

_Prior classification: **relevant** · **anchor** · group=`7360-001`_


**vid=231144** — `Phili 3:21`
*target word in verse:* `like`

> Phili 3:21 who will transform our lowly body to be like his glorious body , by the power that enables him even to subject all things to himself .

_Prior classification: **relevant** · related · group=`7360-001`_
...
|---|---|---|---|
| `G4833` | summorfoomai | to make like | Greek |
...
| `G3339` | metamorfoō | to transform | — | to transform |
| `G3339` | metamorfoō | to transform | — | to transform |
| `G3339` | metamorfoō | to transform | — | to transform |
| `G3339` | metamorfoō | to transform | 202 | transformation |
...
| `G3345` | metaschēmatizō | to transform | — | to transform |
| `G3345` | metaschēmatizō | to transform | — | to transform |
| `G3345` | metaschēmatizō | to transform | 202 | transformation |
| `G3345` | metaschēmatizō | to transform | — | to transform |
| `G3346` | metatithēmi | to transport | — | to transport |
| `G3346` | metatithēmi | to transport | — | to transport |
| `G3346` | metatithēmi | to transport | — | to transport |
| `G3346` | metatithēmi | to transport | 135 | to transport |
| `G3445` | morfoō | to form | — | to form |
| `G3445` | morfoō | to form | 202 | to form |
| `H1819` | da.mah | to resemble | — | to resemble |
| `H1819` | da.mah | to resemble | — | to resemble |
| `H1819` | da.mah | to resemble | 160 | thought |
| `H1821` | de.mah | be like | — | be like |
| `H1821` | de.mah | be like | 201 | be like |
| `H1823` | de.mut | likeness | — | likeness |
| `H1823` | de.mut | likeness | 201 | image |
| `H1825` | dim.yon | likeness | — | likeness |
| `H1825` | dim.yon | likeness | 201 | likeness |
...
`mti_term_id = 7360`. On apply, Claude Code flips
...
*End of Session A prose for term G4832
(209 likeness).*
