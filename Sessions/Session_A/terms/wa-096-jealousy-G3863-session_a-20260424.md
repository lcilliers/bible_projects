# Session A — Term `G3863` *parazēloō* — to make envious
...
a single OWNER term — `G3863` *parazēloō* (to make envious) from registry
096 jealousy. It contains the STEP-sourced data for this one term only.
...
- **Language:** Greek
- **mti_term_id:** 939
- **STEP gloss:** to make envious
- **Word-analysis gloss:** to make envious
- **Mounce short def:** to make envious, arouse jealousy
- **Occurrence count:** 11

**Parsed senses:**

- `1` to make envious, arouse jealousy 
to provoke to jealousy, Rom. 10:19; to excite to emulation, Rom. 11:11, 14; to provoke to indignation, 1Cor. 10:22*
...
- `G2208` *zēlōtēs* — Zealot
- `G3844` *para* — from/with/beside
- `G4442` *pur* — fire
- `G4443` *pura* — fire
- `G4445` *puressō* — be feverish
- `G4446` *puretos* — fever
- `G4447` *purinos* — fiery
- `G4448` *puroō* — to burn
- `G4449` *purrazō* — be (fiery) red
- `G4450` *purros* — fiery red
- `G4451` *purōsis* — burning

**Root family:**

- `PARAZĒL` (Greek) — to make envious — Backfilled 2026-04-09 from wa_term_related_words clustering

**Data-quality flags (informational):**

- `NO_WORD_ANALYSIS` — meaning field is null for G3863. STEP returned no word analysis block for this term.
- `PROSE_ONLY_MEANING` — Meaning for G3863 stored as single prose block. STEP medium_def contains no structured sense numbering. No further subdivision available.
- `VERSE_EVIDENCE_CONCENTRATED` — Only 4 confirmed verse records for G3863. Threshold is 5.
...
### G3863 · *parazēloō* — 4 active verse(s)
...
|---|---|---|
| `939-001` | Term names the provocation of human jealousy as a divine redemptive instrument — the inner state of jealousy stirred to draw the displaced toward returning to God | active |
| `939-002` | Term names the provocation of divine jealousy — the inner disposition of God stirred when his people turn to idols | active |

**Verses:**

**vid=28178** — `Rom 10:19`
*target word in verse:* `jealous`
...
_Prior classification: **relevant** · related · group=`939-001`_
...
_Prior classification: **relevant** · **anchor** · group=`939-001`_
...
**vid=28177** — `1Cor 10:22`
*target word in verse:* `jealousy`

> 1Cor 10:22 Shall we provoke the Lord to jealousy ? Are we stronger than he ?

_Prior classification: **relevant** · **anchor** · group=`939-002`_
...
|---|---|---|---|
| `G3863` | parazēloō | to make envious | Greek |
| `G3863` | parazēloō | to make envious | Greek |
...
`mti_term_id = 939`. On apply, Claude Code flips
...
*End of Session A prose for term G3863
(096 jealousy).*
