# Session A — Term `G0342` *anakainōsis* — renewal

**Registry:** 134 renewal  
**mti_term_id:** 1097  
**Language:** Greek  
**md_version:** `v1`  ⚠ the patch's `_patch_meta.input_versions[1097]` must equal `1` at submission time or the applicator will reject it as stale (A-03 version gate).  
...
a single OWNER term — `G0342` *anakainōsis* (renewal) from registry
...
`mti_term_id = 1097`. On apply, Claude Code flips
...
*End of Session A prose for term G0342
(134 renewal).*
