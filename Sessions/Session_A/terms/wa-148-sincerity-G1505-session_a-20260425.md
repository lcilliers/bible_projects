# Session A — Term `G1505` *eilikrineia* — sincerity

**Registry:** 148 sincerity  
**mti_term_id:** 1126  
**Language:** Greek  
**md_version:** `v1`  ⚠ the patch's `_patch_meta.input_versions[1126]` must equal `1` at submission time or the applicator will reject it as stale (A-03 version gate).  
...
a single OWNER term — `G1505` *eilikrineia* (sincerity) from registry
148 sincerity. It contains the STEP-sourced data for this one term only.
...
- `1` sincerity, the positive moral quality of purity (especially in motives), a figurative extension of an unadulterated or unmixed substance 
clearness, purity;, metaphorically sincerity, integrity, ingenuousness, 1Cor. 5:8; 2Cor. 1:12; 2:17*
...
- `VERSE_EVIDENCE_CONCENTRATED` — Only 3 confirmed verse records for G1505. Threshold is 5.
...
### G1505 · *eilikrineia* — 3 active verse(s)
...
|---|---|---|
| `1126-001` | Term names sincerity as an inner quality of unmixed, genuine motivation — the condition of acting from pure inner integrity before God rather than from calculation or performance | active |

**Verses:**

**vid=40441** — `1Cor 5:8`
*target word in verse:* `sincerity`
...
_Prior classification: **relevant** · related · group=`1126-001`_
...
_Prior classification: **relevant** · **anchor** · group=`1126-001`_
...
|---|---|---|---|
| `G1506` | eilikrinēs | pure | Greek |

### XREF terms (OWNER elsewhere)

| Strong's | Translit. | Gloss | OWNER registry | OWNER word |
|---|---|---|---:|---|
| `G0572` | haplotēs | openness | — | openness |
| `G0572` | haplotēs | openness | — | openness |
| `G0572` | haplotēs | openness | 46 | devotion |
| `G0573` | haplous | sound | — | sound |
| `G0573` | haplous | sound | — | sound |
| `G0573` | haplous | sound | 46 | sound |
| `G0574` | haplōs | without reserve | — | without reserve |
| `G0574` | haplōs | without reserve | — | without reserve |
| `G0574` | haplōs | without reserve | 46 | without reserve |
...
| `H8538` | tum.mah | integrity | — | integrity |
| `H8538` | tum.mah | integrity | — | integrity |
| `H8538` | tum.mah | integrity | 92 | integrity |
| `H8549G` | ta.mim | unblemished | — | unblemished |
| `H8549G` | ta.mim | unblemished | — | unblemished |
| `H8549G` | ta.mim | unblemished | 92 | integrity |
...
`mti_term_id = 1126`. On apply, Claude Code flips
...
*End of Session A prose for term G1505
(148 sincerity).*
