# Session A — Term `G3116` *makrothumōs* — patiently

**Registry:** 115 passion  
**mti_term_id:** 1432  
**Language:** Greek  
**md_version:** `v1`  ⚠ the patch's `_patch_meta.input_versions[1432]` must equal `1` at submission time or the applicator will reject it as stale (A-03 version gate).  
...
a single OWNER term — `G3116` *makrothumōs* (patiently) from registry
...
### G3116 · *makrothumōs* · patiently

- **Language:** Greek
- **mti_term_id:** 1432
- **STEP gloss:** patiently
- **Word-analysis gloss:** patiently
- **Mounce short def:** patiently
- **Occurrence count:** 1

**Parsed senses:**

- `1` patiently, Acts 26:3*
...
- `G3117` *makros* — long/distant

**Root family:**

- `MAKROTHUMŌ` (Greek) — patiently — Backfilled 2026-04-09 from wa_term_related_words clustering

**Data-quality flags (informational):**

- `NO_WORD_ANALYSIS` — meaning field is null for G3116. STEP returned no word analysis block for this term.
- `PROSE_ONLY_MEANING` — Meaning for G3116 stored as single prose block. STEP medium_def contains no structured sense numbering. No further subdivision available.
- `VERSE_EVIDENCE_CONCENTRATED` — Only 1 confirmed verse records for G3116. Threshold is 5.
...
### G3116 · *makrothumōs* — 1 active verse(s)
...
|---|---|---|
| `1432-001` | Term names the inner posture of patient attentiveness — the disposition of measured, unhurried receptiveness toward another's speech | active |

**Verses:**

**vid=184119** — `Act 26:3`
*target word in verse:* `patiently`
...
_Prior classification: **relevant** · **anchor** · group=`1432-001`_
...
`mti_term_id = 1432`. On apply, Claude Code flips
...
*End of Session A prose for term G3116
(115 passion).*
