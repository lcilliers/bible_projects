# Session A — Term `G3713` *oregō* — to aspire

**Registry:** 193 craving  
**mti_term_id:** 1296  
**Language:** Greek  
**md_version:** `v1`  ⚠ the patch's `_patch_meta.input_versions[1296]` must equal `1` at submission time or the applicator will reject it as stale (A-03 version gate).  
...
a single OWNER term — `G3713` *oregō* (to aspire) from registry
...
- **Word-analysis gloss:** to aspire
- **Mounce short def:** (<i>middle</i>) to set one’s heart on, strive for, aspire to, desire
- **Occurrence count:** 3

**Parsed senses:**

- `1` (middle) to set one’s heart on, strive for, aspire to, desire 
to extend, stretch out;, middle to stretch one's self out, to reach forward to, metaphorically to desire earnestly, long after, 1Tim. 3:1; Heb. 11:16; by implication to indulge in, be devoted to, 1Tim. 6:10*
...
- `OREGŌ` (Greek) — to aspire — Backfilled 2026-04-09 from wa_term_related_words clustering

**Data-quality flags (informational):**

- `NO_WORD_ANALYSIS` — meaning field is null for G3713. STEP returned no word analysis block for this term.
- `PROSE_ONLY_MEANING` — Meaning for G3713 stored as single prose block. STEP medium_def contains no structured sense numbering. No further subdivision available.
- `VERSE_EVIDENCE_CONCENTRATED` — Only 1 confirmed verse records for G3713. Threshold is 5.
...
|---|---|---|
| `1296-001` | Term names the inner aspiration toward the heavenly — the deep desire that orients the inner person beyond the earthly toward what God has prepared | active |

**Verses:**

**vid=50978** — `Heb 11:16`
*target word in verse:* `desire`
...
_Prior classification: **relevant** · **anchor** · group=`1296-001`_
...
`mti_term_id = 1296`. On apply, Claude Code flips
...
*End of Session A prose for term G3713
(193 craving).*
