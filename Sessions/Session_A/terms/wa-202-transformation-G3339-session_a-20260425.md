# Session A — Term `G3339` *metamorfoō* — to transform

**Registry:** 202 transformation  
**mti_term_id:** 1362  
**Language:** Greek  
**md_version:** `v1`  ⚠ the patch's `_patch_meta.input_versions[1362]` must equal `1` at submission time or the applicator will reject it as stale (A-03 version gate).  
...
a single OWNER term — `G3339` *metamorfoō* (to transform) from registry
202 transformation. It contains the STEP-sourced data for this one term only.
...
### G3339 · *metamorfoō* · to transform

- **Language:** Greek
- **mti_term_id:** 1362
- **STEP gloss:** to transform
- **Word-analysis gloss:** to transform
- **Mounce short def:** (<i>passive</i>) to be transformed, transfigured, changed in form transform
- **Occurrence count:** 4 (to transform)

**Parsed senses:**

- `1` (passive) to be transformed, transfigured, changed in form transform 
to change the external form, transfigure;, middle to change one's form, be transfigured, Mt. 17:2; Mk. 9:2; to undergo a spiritual transformation Rom. 12:2; 2Cor. 3:18*

**Related words:**

- `G0276` *ametathetos* — unchangeable
- `G3326` *meta* — with/after
- `G3327` *metabainō* — to depart
- `G3328` *metaballō* — to change mind
- `G3329` *metagō* — to turn
- `G3331` *metathesis* — removal/change
- `G3332` *metairō* — to leave
- `G3334` *metakineō* — to shift
- `G3335` *metalambanō* — to partake
- `G3337` *metallassō* — to exchange
- `G3338` *metamellomai* — to repent
- `G3340` *metanoeō* — to repent
- `G3341` *metanoia* — repentance
- `G3344` *metastrefō* — to change
- `G3345` *metaschēmatizō* — to transform
- `G3346` *metatithēmi* — to transport
- `G3445` *morfoō* — to form

**Root family:**

- `MORF` (Greek) — to form — Backfilled 2026-04-09 from wa_term_related_words clustering

**Data-quality flags (informational):**

- `NO_WORD_ANALYSIS` — meaning field is null for G3339. STEP returned no word analysis block for this term.
- `PROSE_ONLY_MEANING` — Meaning for G3339 stored as single prose block. STEP medium_def contains no structured sense numbering. No further subdivision available.
- `VERSE_EVIDENCE_CONCENTRATED` — Only 4 confirmed verse records for G3339. Threshold is 5.
...
### G3339 · *metamorfoō* — 4 active verse(s)
...
|---|---|---|
| `1362-001` | Term describes the inner transformation of the person toward conformity with God — renewal of mind and progressive conformity to divine glory | active |
| `1362-002` | Term describes Christ's visible transformation, which mediates an inner encounter between the disciples and divine reality | active |

**Verses:**

**vid=54734** — `Mat 17:2`
*target word in verse:* `transfigured`

> Mat 17:2 And he was transfigured before them , and his face shone like the sun , and his clothes became white as light .

_Prior classification: **relevant** · related · group=`1362-002`_
...
_Prior classification: **relevant** · **anchor** · group=`1362-002`_


**vid=54735** — `Rom 12:2`
*target word in verse:* `transformed`

> Rom 12:2 Do not be conformed to this world , but be transformed by the renewal of your mind , that by testing you may discern what is the will of God , what is good and acceptable and perfect .

_Prior classification: **relevant** · **anchor** · group=`1362-001`_
...
_Prior classification: **relevant** · related · group=`1362-001`_
...
|---|---|---|---|
| `G3339` | metamorfoō | to transform | Greek |
| `G3339` | metamorfoō | to transform | Greek |
| `G3339` | metamorfoō | to transform | Greek |
| `G3445` | morfoō | to form | Greek |
| `G3445` | morfoō | to form | Greek |
| `H2498` | cha.laph | to pass | Hebrew |
| `H2498` | cha.laph | to pass | Hebrew |
...
|---|---|---|---:|---|
| `G0276` | ametathetos | unchangeable | — | unchangeable |
| `G0276` | ametathetos | unchangeable | — | unchangeable |
| `G0276` | ametathetos | unchangeable | — | unchangeable |
| `G0276` | ametathetos | unchangeable | 135 | unchangeable |
| `G0303` | ana | each | — | each |
| `G0303` | ana | each | — | each |
| `G0303` | ana | each | — | each |
| `G0303` | ana | each | 51 | each |
| `G0341` | anakainoō | to renew | — | to renew |
| `G0341` | anakainoō | to renew | 134 | to renew |
| `G0342` | anakainōsis | renewal | — | renewal |
| `G0342` | anakainōsis | renewal | 134 | renewal |
| `G2537` | kainos | new | — | new |
| `G2537` | kainos | new | — | new |
| `G2537` | kainos | new | 34 | covenant |
| `G3327` | metabainō | to depart | — | to depart |
| `G3327` | metabainō | to depart | — | to depart |
| `G3327` | metabainō | to depart | — | to depart |
| `G3327` | metabainō | to depart | 135 | to depart |
| `G3328` | metaballō | to change mind | — | to change mind |
| `G3328` | metaballō | to change mind | — | to change mind |
| `G3328` | metaballō | to change mind | 112 | to change mind |
| `G3328` | metaballō | to change mind | 112 | to change mind |
| `G3329` | metagō | to turn | — | to turn |
| `G3329` | metagō | to turn | — | to turn |
| `G3329` | metagō | to turn | — | to turn |
| `G3329` | metagō | to turn | 135 | to turn |
| `G3331` | metathesis | removal/change | — | removal/change |
| `G3331` | metathesis | removal/change | — | removal/change |
| `G3331` | metathesis | removal/change | — | removal/change |
| `G3331` | metathesis | removal/change | 135 | removal/change |
| `G3332` | metairō | to leave | — | to leave |
| `G3332` | metairō | to leave | — | to leave |
| `G3332` | metairō | to leave | — | to leave |
| `G3332` | metairō | to leave | 135 | to leave |
| `G3334` | metakineō | to shift | — | to shift |
| `G3334` | metakineō | to shift | — | to shift |
| `G3334` | metakineō | to shift | — | to shift |
| `G3334` | metakineō | to shift | 135 | to shift |
| `G3335` | metalambanō | to partake | — | to partake |
| `G3335` | metalambanō | to partake | — | to partake |
| `G3335` | metalambanō | to partake | — | to partake |
| `G3335` | metalambanō | to partake | 135 | to partake |
| `G3337` | metallassō | to exchange | — | to exchange |
| `G3337` | metallassō | to exchange | — | to exchange |
| `G3337` | metallassō | to exchange | — | to exchange |
| `G3337` | metallassō | to exchange | 135 | to exchange |
| `G3338` | metamellomai | to repent | — | to repent |
| `G3338` | metamellomai | to repent | — | to repent |
| `G3338` | metamellomai | to repent | 112 | to repent |
| `G3338` | metamellomai | to repent | 135 | repentance |
| `G3340` | metanoeō | to repent | — | to repent |
| `G3340` | metanoeō | to repent | — | to repent |
| `G3340` | metanoeō | to repent | 112 | to repent |
| `G3340` | metanoeō | to repent | 135 | repentance |
| `G3341` | metanoia | repentance | — | repentance |
| `G3341` | metanoia | repentance | — | repentance |
| `G3341` | metanoia | repentance | 112 | repentance |
| `G3341` | metanoia | repentance | 135 | repentance |
| `G3344` | metastrefō | to change | — | to change |
| `G3344` | metastrefō | to change | — | to change |
| `G3344` | metastrefō | to change | — | to change |
| `G3344` | metastrefō | to change | 135 | to change |
| `G3346` | metatithēmi | to transport | — | to transport |
| `G3346` | metatithēmi | to transport | — | to transport |
| `G3346` | metatithēmi | to transport | — | to transport |
| `G3346` | metatithēmi | to transport | 135 | to transport |
| `H2475` | cha.loph | destruction | — | destruction |
| `H2475` | cha.loph | destruction | 134 | destruction |
| `H2487` | cha.li.phah | change | — | change |
| `H2487` | cha.li.phah | change | 134 | renewal |
| `H2499` | cha.laph | to pass | — | to pass |
| `H2499` | cha.laph | to pass | 199 | to pass |
| `H2500` | che.leph | for | — | for |
| `H2500` | che.leph | for | 134 | for |
| `H4252` | ma.cha.laph | knife | — | knife |
| `H4252` | ma.cha.laph | knife | 134 | knife |
| `H4253` | ma.cha.la.phah | lock | — | lock |
| `H4253` | ma.cha.la.phah | lock | 134 | lock |
...
`mti_term_id = 1362`. On apply, Claude Code flips
...
*End of Session A prose for term G3339
(202 transformation).*
