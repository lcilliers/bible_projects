# Session A — Term `H2475` *cha.loph* — destruction
...
a single OWNER term — `H2475` *cha.loph* (destruction) from registry
...
`mti_term_id = 6136`. On apply, Claude Code flips
...
*End of Session A prose for term H2475
(134 renewal).*
