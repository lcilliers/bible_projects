# Session A — Term `H2500` *che.leph* — for

**Registry:** 134 renewal  
**mti_term_id:** 6135  
**Language:** Hebrew  
**md_version:** `v1`  ⚠ the patch's `_patch_meta.input_versions[6135]` must equal `1` at submission time or the applicator will reject it as stale (A-03 version gate).  
...
a single OWNER term — `H2500` *che.leph* (for) from registry
...
`mti_term_id = 6135`. On apply, Claude Code flips
...
*End of Session A prose for term H2500
(134 renewal).*
