# Session A — Term `H4263` *mach.mal* — compassion

**Registry:** 179 yearning  
**mti_term_id:** 1264  
**Language:** Hebrew  
**md_version:** `v2`  ⚠ the patch's `_patch_meta.input_versions[1264]` must equal `2` at submission time or the applicator will reject it as stale (A-03 version gate).  
...
a single OWNER term — `H4263` *mach.mal* (compassion) from registry
179 yearning. It contains the STEP-sourced data for this one term only.
...
- **Word-analysis gloss:** compassion
- **Occurrence count:** 1
...
- `CHMAL` (Hebrew) — compassion — Backfilled 2026-04-09 from wa_term_related_words clustering

**Data-quality flags (informational):**

- `NO_WORD_ANALYSIS` — meaning field is null for H4263. STEP returned no word analysis block for this term.
- `VERSE_EVIDENCE_CONCENTRATED` — Only 1 confirmed verse records for H4263. Threshold is 5.
...
### H4263 · *mach.mal* — 1 active verse(s)
...
|---|---|---|
| `1264-001` | Term names the deepest inner yearning of the soul — intense longing for the sanctuary as cherished object | active |

**Verses:**

**vid=54650** — `Eze 24:21`
*target word in verse:* `yearning`
...
_Prior classification: **relevant** · **anchor** · group=`1264-001`_
...
|---|---|---|---|
| `H4263` | mach.mal | compassion | Hebrew |
| `H4263` | mach.mal | compassion | Hebrew |
| `H4263` | mach.mal | compassion | Hebrew |
| `H4263` | mach.mal | compassion | Hebrew |
...
|---|---|---|---:|---|
| `H2550` | cha.mal | to spare | — | to spare |
| `H2550` | cha.mal | to spare | — | to spare |
| `H2550` | cha.mal | to spare | — | to spare |
| `H2550` | cha.mal | to spare | — | to spare |
| `H2550` | cha.mal | to spare | 43 | desire |
| `H2551` | chem.lah | compassion | — | compassion |
| `H2551` | chem.lah | compassion | — | compassion |
| `H2551` | chem.lah | compassion | — | compassion |
| `H2551` | chem.lah | compassion | — | compassion |
| `H2551` | chem.lah | compassion | 23 | compassion |
| `H4261` | mach.mad | desire | — | desire |
| `H4261` | mach.mad | desire | — | desire |
| `H4261` | mach.mad | desire | — | desire |
| `H4261` | mach.mad | desire | 43 | desire |
...
`mti_term_id = 1264`. On apply, Claude Code flips
...
*End of Session A prose for term H4263
(179 yearning).*
