# Session A — Term `G0341` *anakainoō* — to renew

**Registry:** 134 renewal  
**mti_term_id:** 6132  
**Language:** Greek  
**md_version:** `v1`  ⚠ the patch's `_patch_meta.input_versions[6132]` must equal `1` at submission time or the applicator will reject it as stale (A-03 version gate).  
...
a single OWNER term — `G0341` *anakainoō* (to renew) from registry
...
`mti_term_id = 6132`. On apply, Claude Code flips
...
*End of Session A prose for term G0341
(134 renewal).*
