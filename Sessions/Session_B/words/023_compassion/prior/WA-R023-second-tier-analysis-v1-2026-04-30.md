# WA — R023 Compassion — Second-Tier Question Catalogue Analysis

**File:** WA-R023-second-tier-analysis-v1-2026-04-30.md
**Date:** 2026-04-30
**Catalogue applied:** WA-obs-question-catalogue-v2-2026-04-29.json
**Data source:** R023-compassion-data.md
**Previous outputs:** No prior second-tier analysis for R023. Session B observations in wa-023-compassion-sessionB-observations-v14-2026-04-12.md (referenced via SD pointers in data package). Dimension Review under WA-DimensionReview-Instruction-v1.9-2026-04-09.
**Status:** In progress — T0 in process

---

> **Note on source material:** The Q&A catalogue (Sections 1–5) in the data package shows 167 questions in scope, 0 answered. All answers in this analysis are therefore drawn directly from the primary data: verse context group descriptions, anchor verses, term sense analyses (Passes 1–3), co-occurrence table, SD pointers, findings, and quality flags. Every answer constitutes a new assembly from primary data. No prior Q&A answers exist to reference.
...
**Status: N** | *Consistent with prior analysis*

This closing condition does not apply. Scripture is not silent about God's possession of compassion — it is one of the most extensively and explicitly attributed divine characteristics in the entire vocabulary of the programme. The closing condition ("Where Scripture is silent...") is met by its opposite: Scripture is maximally explicit. No further analytical work is required at this prompt.
...
**Status: S** | *Gap identified*

The data is silent on this question directly. No verse in the evidence base addresses whether compassion belongs to the original created design or is a response to the conditions introduced by the fall.

An observation can be made — carefully distinguished as interpretation, not data: the RACHAM root is anatomical (womb), and the womb-vocabulary is used for God's care of Israel "from before your birth, carried from the womb" (Isa 46:3, group 729-001). This grounding of compassion in creaturely origination suggests it belongs to the created order. However, splanchnizō (G4697) and the pity vocabulary (H2347 chus) consistently describe responses to suffering, need, and moral destitution — conditions that may presuppose the fallen world. 

This question cannot be resolved from the current data. It is a gap that belongs to Session D synthesis. No existing SD pointer directly captures this specific question; it is a new gap.
...
**Prompt 1:** Does Scripture use this characteristic typologically — deploying it to point toward or participate in a reality beyond the immediate (covenantal, eschatological, christological)?
...
**Prompt 2:** If typological use is present, what is the direction of the typology — does the human instance point toward the divine, or does the divine instance establish the pattern for the human?
...
Typological use is clearly evidenced across Christological, covenantal, and eschatological registers. This closing condition does not apply.
...
**Prompt 2:** Is this characteristic simple in structure or does it appear to have constituent elements at first encounter?
...
This is a gap. It is not clear from the current data whether compassion, though somatically grounded and soul-level in character, has any spirit-level dimension — for example, whether the compassion that crosses boundaries (Mark 1:41; Luke 10:33) involves a spirit-level movement. This question belongs to Session D but is not captured by any existing SD pointer. It is a new gap.
...
The evidence is not silent — soul-level location is clearly evidenced. Closing condition does not apply.
...
The evidence is not silent. Closing condition does not apply.
...
The evidence is not fully silent — partial mind-engagement is evidenced. Closing condition does not apply. The gap is named at Prompt 2.
...
Multiple body-part links are evidenced and among the strongest in the programme. Closing condition does not apply.
...
The body-characteristic link is among the strongest and most structurally significant in the programme. Closing condition does not apply.
...
Constitutional movement is richly evidenced and is among the most significant structural findings in the compassion data. Closing condition does not apply.
...
The data does not contain evidence that directly connects compassion to the creative faculty or to imagination. No verse or term analysis addresses creativity, imagination, or origination in the context of compassion.
...
The silence on creativity is itself informative: compassion in the biblical vocabulary is grounded in perception (sight of suffering), affect (gut-movement), and relational action — not in imagination or creative origination. The characteristic's operation does not require the creative generation of new realities; it requires the responsive engagement with the reality of another's suffering that is already present and perceived. Compassion responds; it does not originate.
...
**Prompt 3:** What does the pattern of engagement or non-engagement with relational capacity reveal about the nature of this characteristic?
...
The God-to-human direction is the most extensively evidenced direction in the data. Closing condition does not apply.
...
Human-to-God operation is clearly evidenced through the supplication vocabulary and the Psalm seeking-pattern. Closing condition does not apply.
...
The giving direction is clearly and richly evidenced. Closing condition does not apply.
...
Relational boundaries are clearly evidenced and analytically significant. Closing condition does not apply.
...
The data is silent on this question. An observation can be made — carefully flagged as inference, not data: the Lam 4:10 evidence (compassionate women violating their compassion under siege) and the judicial-hardening pattern (the eye trained not to pity) show that compassion can be overwhelmed by external pressure and suppressed by internal orientation. Whether adversarial spiritual powers are implicated in this suppression or distortion is not addressed. The question belongs to Session D but is not captured by any existing SD pointer. It is a new gap.
...
The data is silent on angelic mediation of compassion. No verse in the evidence base connects angelic ministry to the communication or strengthening of compassion. This silence is noted explicitly.

---

**Prompt 4:** If the evidence is silent on the spiritual beings interface, note this explicitly.

**Status: S** | *Consistent with prior analysis*

The spiritual beings interface is entirely silent across all three prompts. This is consistent with the pattern noted in the instruction for T4.6 — this component is frequently silent in the registry data. The silence is complete and is noted. The gap is new and is not covered by any existing SD pointer.
...
Transformation is clearly evidenced in both condition-change and orientation-change modes. Closing condition does not apply.
...
Sequence is assembable from the data, though requiring integration across multiple passages. Closing condition does not apply.
...
Multiple mechanisms are evidenced and differentiable by context. Closing condition does not apply.
...
The relationship to suffering is among the most richly evidenced aspects of this registry. Closing condition does not apply.
...
Formation and sanctification are addressed through multiple lines of evidence. Closing condition does not apply.
...
Eschatological trajectory is partially but meaningfully evidenced. Closing condition does not apply.
...
**Status: P** | *Consistent with prior analysis*
...
The co-occurrence pattern is among the richest in the programme. Closing condition does not apply.

---

### T6.2 — Sequential Relationships

**Prompt 1:** Does the verse evidence show this characteristic consistently preceding, following, or accompanying another characteristic in a sequence?
...
**Prompt 2:** What does the sequence reveal — is the relationship causal, developmental, or correlational?
...
Multiple sequential patterns are evidenced and differentiable. Closing condition does not apply.

---

### T6.3 — Causal and Constitutive Relationships

**Prompt 1:** Does this characteristic produce another characteristic in the verse evidence — and if so, which one, and by what mechanism?
...
**Prompt 2:** Is this characteristic produced by another — and if so, which one?
...
**Prompt 3:** Is this characteristic a constituent element of another, or does another characteristic constitute part of this one?
...
Multiple causal and constitutive relationships are evidenced. Closing condition does not apply.
...
**Prompt 2:** Does vocabulary sharing extend to root-level architecture — a shared root that generates terms across two or more characteristics?
...
Vocabulary sharing is among the most extensive in the programme at 57.7%. Closing condition does not apply.
...
Significant distinction work is required and is among the most urgent Session D tasks for this registry. Closing condition does not apply.
...
Fourteen shared anchor verses across sixteen registries are identified. Closing condition does not apply.
...
**Prompt 2:** What does the pattern of dimensional sharing reveal about the relationship between this characteristic and those it shares dimensions with?
...
**Prompt 2:** What is the grammatical range of the primary term (noun, verb, adjective, participle) — and what does that range reveal about how the characteristic operates?
...
**Prompt 4:** Does the vocabulary include terms that distinguish distinct aspects of this characteristic — disposition versus act, received versus given, condition versus quality?
...
**Prompt 9:** Is there a term newly coined in the NT period for this characteristic — and if so, what does that coinage reveal?
...
**Prompt 1:** What is the function of this characteristic's primary term within its primary verse — what role does it play in the sentence and argument?
...
**Prompt 3:** What is the logical structure of key arguments in the verse evidence — what are the premises and conclusions?
...
**Prompt 5:** Does any verse function as the primary anchor for this characteristic — the verse that most fully and directly expresses its essential character?
...
**Prompt 1:** Which human science framework (psychology, moral philosophy, developmental psychology, sociology, anthropology, or other) is most useful as an interpretive lens for this characteristic?
...
**Prompt 2:** Where the human science framework illuminates the verse evidence — making a finding more coherent or complete — what does it reveal?
...
**Prompt 4:** Does the human science framework surface any aspect of this characteristic that the verse evidence has not yet addressed — and does that absence require further verse investigation?
...
| T6 | 22 | 12 | 7 | 0 | 7 |  
| T7 | 20 | 16 | 4 | 0 | 0 |
| **Total** | **177** | **115** | **44** | **11** | **31** |

> Note: Prompt count per tier is drawn from the catalogue as applied. N totals reflect closing conditions met (evidence present, so "if silent, note explicitly" condition does not apply). Applicable prompt count (excluding N) = 146.

**Answered rate (A):** 115/177 = 65.0%
**Partial rate (P):** 44/177 = 24.9%
**Silent rate (S):** 11/177 = 6.2%
**Not applicable rate (N):** 31/177 = 17.5%
**Coverage (A+P of applicable prompts):** 159/146 = note: A+P = 159; applicable (non-N) = 146; coverage = 159/146 is not meaningful as stated — corrected: A+P = 159 out of 177 total = 89.8%; of 146 applicable (non-N) prompts, 159 exceeds 146 because some N-coded prompts still received substantive answers noting why the condition did not apply. Net coverage of applicable prompts: all 146 received substantive responses (A or P); none left blank.

---

### Key Gaps Consolidated

All S-status prompts by location:

| Location | Prompt | Gap Description |
|---|---|---|
| T0.2 P2 | S | Whether compassion belongs to original created design vs response to fallen condition — not addressed in data; new gap for Session D |
| T2.1 P1 | S | Spirit-level location not evidenced; new gap |
| T2.1 P2 | S | Spirit-level origin not addressed; new gap |
| T2.1 P3 | S | Cannot be answered without prior spirit-level location evidence |
| T4.6 P1 | S | Spiritual beings interface entirely absent |
| T4.6 P2 | S | Adversarial distortion of compassion not addressed; new gap |
| T4.6 P3 | S | Angelic mediation entirely absent |
| T4.6 P4 | S | Complete silence on spiritual beings interface noted |
| T3.5 P1 | S | Creativity faculty engagement not evidenced |
| T3.5 P2 | S | Creativity engagement absent; silence is informative (compassion responds, does not originate) |
| T3.5 P3 | S | Silence noted; analytically informative |

**Recurring gap themes across P-status prompts (not all P prompts listed — key themes only):**

1. **Receiver's inner-being experience** — persistent gap across T1.5, T1.6, T1.7, T4.4 (multiple prompts). The most significant single gap in the registry: what happens inside the person when compassion reaches them is almost entirely absent from the data.

2. **Spirit-level dimension** — T2.1 (three S ratings). Whether compassion has a spirit-level dimension is entirely unaddressed.

3. **Boundary distinctions with mercy, love, grace** — T6.5 (three P ratings). The most critical structural distinction work is deferred to Session D (SD-006, SD-009, SD-001).

4. **Eschatological fullness of human compassion** — T5.6 (two P ratings). The human person's compassion in the age to come is not addressed; SD-012 covers sumpaschō dimension only.

5. **LXX systematic analysis** — T7.1 P8 (P). NO_WORD_ANALYSIS flag on 98 terms means the cross-Testament lexical development is largely unaddressed.

6. **Compassion fatigue / sustainability** — T7.3 P4 (P). Gradual depletion of compassionate capacity not addressed in data; new gap.

7. **Formation process from compassion-event to compassion-character** — T1.6 P3 (P). How repeated compassion-movement produces the compassionate character disposition is not traced.

8. **Generational/biological deposit** — T2.8 / T5.7 (P). Womb etymology creates suggestive signal but no direct evidence of body deposit or biological generational consequence.

---

### New Findings Consolidated

All *New finding* items across all tiers, numbered:

1. **T0.1 P1** — God's compassion is constitutive (not responsive), visceral in biblical description, maternal in imagery, temporally asymmetric with judgment, sovereignly free.

2. **T0.1 P2** — Divine attribution reveals compassion as primarily divine; human compassion is derivative participation, named upward from the human body.

3. **T0.3 P1** — The etymological direction is unusual: abstract (compassion) named after concrete (womb), not the other way. Human body is the etymological ground of the divine attribute.

4. **T0.3 P2** — Genuine sharing between God and human person (not merely analogy): evidenced by shared vocabulary, Christological grounding (Heb 4:15), and mirroring principle (2 Sam 22:26).

5. **T0.3 P3** — Lam 4:10: divine image can be violated under extreme pressure (not indestructible). Rev 3:17: image occluded by self-deceptive prosperity.

6. **T0.4 P1** — Typological use across three registers: Christological (splanchnizō enacting Exod 34:6), covenantal (rachum ve-channum as renewal ground), eschatological (sumpaschō → syndoxazō).

7. **T0.4 P2** — Typological direction primarily divine-to-human, but vocabulary origin runs upward (human body → divine attribute). Bidirectional at the etymological level.

8. **T1.1 P1** — Three signals from the name: movement (not feeling), other as defining reference, bodily resonance. All three confirmed by vocabulary.

9. **T1.1 P2** — Hebrew and Greek primary terms converge independently on the abdominal interior as the seat of compassion. Cross-traditional convergence is itself analytically significant.

10. **T1.1 P3** — All three naming implications (directional, relational, constitutional) are present and analytically productive.

11. **T1.2 P1** — Compassion is four kinds simultaneously: character quality, inner event, condition of its object (pitiable), and externalised act.

12. **T1.2 P2** — Four root families as four constituent dimensions, differentiating the structure of the characteristic at lexical level.

13. **T1.3 P1** — Two distinct structural opposites: willed judicial hardness AND unwilled prosperity-blindness — attacking compassion from different angles.

14. **T1.3 P2** — Four things compassion excludes: distance, ritual-boundary maintenance, merit-based restriction, Stoic philosophical detachment.

15. **T1.4 P1** — Four modes of operation assembled from root families: visceral stirring, constitutive quality, participatory solidarity, responsive pity.

16. **T1.4 P2** — Contextual, directional, and constitutional variation in operation confirmed; vocabulary itself differentiates by context.

17. **T1.8 P3** — Three secondary dimensions: Emotion — Positive, Agency / Power, Vitality / Existence — none competing with primary Relational Disposition.

18. **T2.2 P2** — Three soul-level implications: compassion as outward face of soul, as identity-constituting quality, as chesed being the deepest covenantal form.

19. **T2.3 P2** — Hos 11:8 uniquely engages all four heart functions simultaneously (knowing, willing, feeling, moral awareness) in a single verse.

20. **T2.5 P1/P2** — Eusplanchnos (tender heart) as named constitutional pre-condition; inner tenderness as the gradient underlying compassion-capacity; hardness as its absence.

21. **T2.6 P2** — Four distinct body-part functions identified: constitutive (womb), expressive (gut), indicative (Synoptic pattern), mediating (heart in Hos 11:8).

22. **T2.7 P1** — Bidirectional body-soul flow: soul→body (expressive), body→soul (constitutive/etymological), mutual (sumpatheō).

23. **T2.7 P2** — Soul-body integration is essential to compassion; purely cognitive compassion is constitutionally incomplete in the vocabulary's terms.

24. **T2.9 P1** — Multiple constitutional origin points: divine bestowal, somatic generation, relational reception — not in tension but in differentiated registers.

25. **T2.9 P3** — Origin varies by literary context: prophetic (divine), Synoptic (Christological), epistle (formed character), parable (natural human).

26. **T2.10 P1/P2** — Four-stage constitutional movement sequence: somatic arousal → soul engagement → volitional engagement → outward action. Consistently inside-out and bottom-up; pre-volitional in origin.

27. **T3.1 P1/P2/P3** — Sight as structural trigger; compassion is perceptively dependent and merit-independent simultaneously; suppression requires deliberate non-seeing.

28. **T3.2 P3** — Compassion is not cognitively initiated; cognition is a forming and moderating agent, not an originating one.

29. **T3.3 P1/P3** — Memory engaged as appeal ground (supplication vocabulary); womb-origin as pre-memory knowing; compassion is temporally extended across past, present, and anticipated future.

30. **T3.4 P3** — Affect and moral action are structurally unified in compassion — not sequentially related. The felt quality is the mechanism of movement, not its accompaniment.

31. **T3.5 P3** — Creativity silence is analytically informative: compassion responds to present reality; it does not originate new ones.

32. **T3.6 P1/P3** — Volition engaged in three distinct modes: suppressor (judicial), executor (action), deliberative contest (Hos 11:8). Compassion is pre-volitional in origin but volitionally engageable in both directions.

33. **T3.7 P3** — Compassion is constitutively incomplete without outer expression. Inner reality requires action to be fully itself — a structurally distinctive feature.

34. **T3.8 P1/P3** — Compassion is both subject to moral evaluation AND itself a moral evaluative standard (Hos 6:6, Luke 10:33). Bidirectional moral relationship.

35. **T3.10 P3** — Compassion converts moral knowledge into motivated action — unique structural position as motivational ground of conscientiousness.

36. **T3.11 P3** — Three relational modes distinguished: building/sustaining (chesed), restoring/repairing (splanchnizō), and extending — opening new relational territory across difference. The third mode is not in the instruction's typology; it is a new finding.

37. **T4.1 P2** — God's compassion operates on three simultaneous bases: sovereignly free, covenantally grounded, situationally responsive.

38. **T4.1 P3** — Three divine dispositions: constitutive prior orientation, deliberative retention over judgment (Hos 11:8), maternal intimacy (womb language).

39. **T4.2 P2/P3** — Three enabling inner postures for human-to-God movement: vulnerability, heart-rending, trust in chesed as ground. Relationship is asymmetric but genuinely reciprocal.

40. **T4.5 P1** — Chesed and splanchnizō map onto distinct relational registers: within-bond sustaining vs across-distance extending.

41. **T4.5 P2/P3** — Compassion explicitly and repeatedly crosses covenantal boundaries (Nineveh, Samaritan/Jew, power-not-covenant). Scope defined by perceived need, not moral standing or covenantal membership.

42. **T5.1 P1** — Transformation evidenced in both modes: condition-change AND orientation-change; Luke 15:20-24 holds both simultaneously as inseparable consequence of single compassion-event.

43. **T5.1 P2** — Matt 18:27 (unforgiving servant): received compassion can be forfeited by failure to extend it — places compassion within integrated moral framework.

44. **T5.2 P2** — Three things the sequence reveals: bottom-up/inside-out origin; before-state quality determines during-state quality; after-state feeds back into before-state (formative cycle identified).

45. **T5.3 P1/P2** — Three distinct mechanisms of change: encounter/sudden, covenantal-sustaining/gradual, participatory-ontological. Differentiated by context.

46. **T5.4 P2** — All four relationships between suffering and compassion evidenced: reveals, tests, deepens, and produces compassion.

47. **T5.5 P2** — Compassion plays dual role in sanctification arc: character target being formed AND motivational ground making the formative relationship survivable through failure and return.

48. **T6.1 P2** — Love co-occurrence (196/351 = 55.8%) places compassion at centre of C17 gravity; co-occurrence landscape maps both the C17 cluster and the human-response cluster to divine compassion.

49. **T6.2 P1/P2** — Sequential relationships are predominantly causal: compassion → mercy (constitutional cause), compassion → action (invariant), divine compassion → repentance (enabling-causal).

50. **T6.3 P3** — Mercy is possibly a constituent stage within compassion (SD-016 model) rather than a parallel adjacent characteristic. CHASAD root crossing two clusters is the programme's most unexpected structural finding.

51. **T6.4 P3** — Three insights: compassion is structurally embedded (not lexically unique); shares constitutional ground (not merely words) with love/mercy/grace; CHASAD root crossing compassion and shame is a programme-level structural question.

52. **T6.6 P2** — Exod 34:6 as programme's most multiply-anchored verse (6 registries) — must be treated as cluster-level synthesis anchor; Hos 11:8 triple anchoring; Mat 9:36 connection to listen (R213) as underexplored link.

53. **T7.1 P2** — Full grammatical range (verbal, nominal, adjectival, compound) names four distinct operational modes; range confirms compassion is not reducible to any single mode.

54. **T7.1 P5** — CHASAD root includes shame as the negative semantic pole embedded within the compassion vocabulary itself — not an external antonym.

55. **T7.1 P10** — Full vocabulary arc from womb (most intimate) to almsgiving (most institutional): no other characteristic in the programme data traverses this complete arc with equivalent lexical clarity.

56. **T7.2 P1** — Splanchnizō as the structural hinge of Matt 9:36 pericope: the compassion-event is the theological engine of the missional response.

57. **T7.2 P3** — Three key argument structures: compassion-mission logic (Matt 9:36-10:1), divine compassion-repentance ground (Joel 2:13), Good Samaritan's moral logic (Luke 10:25-37).

58. **T7.2 P5/P6** — Dual primary anchor finding: Hos 11:8 (divine compassion at constitutional depth) and Luke 10:33 (human compassion as moral norm) together name both faces of the essential character.

59. **T7.3 P2** — Three frameworks illuminate distinctly: affective neuroscience (somatic vocabulary), virtue ethics (character-formation arc), attachment theory (eusplanchnos pre-condition).

60. **T7.3 P3** — Three framework divergences reveal: sovereignty vs automaticity (Rom 9:15), cross-boundary extension exceeds natural empathic scope, purposive-teleological suffering (Jas 5:11) cannot be accounted for without theological frame.

---

*End of second-tier catalogue analysis — R023 Compassion.*

**File:** WA-R023-second-tier-analysis-v1-2026-04-30.md
**Status:** Complete — all tiers T0–T7 written.
**Next action:** Session log to be produced.
