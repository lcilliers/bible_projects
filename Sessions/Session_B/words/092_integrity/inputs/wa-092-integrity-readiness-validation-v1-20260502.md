# Readiness Validation — R092 integrity

_Generated 2026-05-02T15:24:55Z_
...
| C07 | Readiness output present | ✓ PASS | latest .md: wa-092-integrity-readiness-output-v6-20260502.md; latest .json: wa-092-integrity-readiness-output-v6-20260502.json |
| C08 | Term inventory health | ✓ PASS | 3 OWNER terms, all with ≥1 verse |
| C09 | All groups have dimensions | ✓ PASS | 5/5 groups have dimension assignments |
| C10 | All groups have anchors | ✓ PASS | 5/5 groups have ≥1 anchor |
| C11 | Set-aside ratio | ⚠ WARN | 2 group(s) with set-aside > 90%: ['934-001 (45/5 = 900%)', '934-002 (45/1 = 4500%)']. Possible VC drift; review Stage 2a. |
| C12 | Legacy-VC caveat | ✓ PASS | all 3 OWNER terms have vc_status set under v3 contracts |
| C13 | Dimension confidence | ⚠ WARN | dimension_confidence: KEYWORD_WEAK: 5. No 'confirmed' assignments — Session B can promote during Stage 2. |
