# wa-139-righteousness — Analysis Readiness Output (v6)

_v6 generation · 2026-05-02T15:24:58Z · schema 3.17.0 · catalogue v2-2026-04-29 (T0–T7)_
...
- **Registry no:** `139` · **word:** `righteousness`
...
- `phase1_term_count`: 34  (programme-wide aggregate including XREF and historical terms — current OWNER count is 1, XREF 23)
- `phase1_verse_count`: 1190  (programme-wide aggregate; current registry verse counts shown per term in §C)

**Open flags:** 1 unresolved · **Existing session_b_findings:** 0

**Description:**

> Righteousness is the quality of being in right relationship — with God, with others, with the created order — in a way that is measurably just and true. The Hebrew (tsedaqah) and Greek (dikaiosunē) vocabulary covers both the moral quality of the righteous person and the forensic status of those declared righteous by God. Righteousness is not primarily an inner quality one cultivates but a relational status: to be righteous is to be in right standing, to be in the proper relationship of creature to Creator and person to person.
...
|---|---|---|---|---|---|---:|---:|---:|---|---:|
| `G1345` | dikaiōma | righteous act | G | `extracted` | **`vc_completed`** | 2 | 10 | 1/0 | 10/0 | 2 |
...
**Identity:** mti=1099 · ti=1189 · language=Greek · status=`extracted` · md_v=2

**Meaning parse** (parser v1.0.0, parsed 2026-03-28T14:12:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: regulation, requirement, commandment;righteous act of righteousness 
primarily a rightful act, act of justice, equity; a sentence, of condemnation, Rev. 15:4; in NT, of acquittal, justification, Rom. 5:16; a decree, law, ordinance,regulation, requirement Lk. 1:6; Rom. 1:32; 2:26; 8:4; Heb. 9:1, 10; a meritorious act, an instance of perfect righteousness, Rom. 5:18; Rev. 19:8*
...
## E. XREF Terms [Unit 2] (23)

| strongs | translit | gloss | lang | OWNER registry | status | OWNER verse count |
|---|---|---|---|---|---|---:|
| `G0091` | adikeō | to harm | G | 57 evil | `extracted` | 15 |
| `G0092` | adikēma | crime | G | 98 justice | `extracted_thin` | 3 |
| `G0093` | adikia | unrighteousness | G | 57 evil | `extracted` | 9 |
| `G0094` | adikos | unjust | G | 98 justice | `extracted` | 11 |
| `G0095` | adikōs | unjustly | G | 98 justice | `extracted_thin` | 1 |
| `G0476` | antidikos | opponent | G | 98 justice | `extracted_thin` | 4 |
| `G1341` | dikaiokrisia | justice | G | 98 justice | `extracted_thin` | 1 |
| `G1342` | dikaios | just | G | 98 justice | `extracted` | 74 |
| `G1343` | dikaiosunē | righteousness | G | 98 justice | `extracted` | 74 |
| `G1344` | dikaioō | to justify | G | 98 justice | `extracted` | 36 |
| `G1346` | dikaiōs | rightly | G | 98 justice | `extracted_thin` | 5 |
| `G1347` | dikaiōsis | justification | G | 98 justice | `extracted_thin` | 2 |
| `G1348` | dikastēs | magistrate | G | 98 justice | `extracted_thin` | 2 |
| `G1349` | dikē | condemnation | G | 98 justice | `extracted` | 3 |
| `G1738` | endikos | just | G | 98 justice | `extracted_thin` | 2 |
| `G2613` | katadikazō | to condemn | G | 98 justice | `extracted_thin` | 4 |
| `G5267` | hupodikos | accountable | G | 98 justice | `extracted_thin` | 1 |
| `H4941G` | mish.pat | justice: judgement | H | 98 justice | `extracted` | 208 |
| `H6662` | tsad.diq | righteous | H | 77 honesty | `extracted` | 184 |
...
| `H6666` | tse.da.qah | righteousness | H | 77 honesty | `extracted` | 148 |
...
- **`1099-001`** — 10 relevant · 2 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C10`
  - *Term names the dikaiōma — whether decree, standard, righteous act, or verdict — as the external reality that discloses, qualifies, or re-orients inner-being standing, moral orientation, and response (conformity, defiance, reception of verdict, or worship of divine righteousness revealed).*
...
_No verse co-occurrence at threshold._

### G.3 Shared anchors

_No shared anchor verses._
...
|---|---|---|---|---|
| `SB_FINDING` | SBF-vc139-001 | normal | Session B | 2026-04-24 |

#### SBF-vc139-001

> Group 1099-001's revised context_description under v3_5 covers a wide characteristic span across 10 verses: (Zone A) standard disclosed-in inner righteousness — Luk 1:6, Rom 2:26, Rom 8:4; (Zone B) standard known-and-defied — Rom 1:32; (Zone C) verdict received — Rom 5:16, Rom 5:18; (Zone D) obsolete external regulation contrasted with inner reality — Heb 9:1, Heb 9:10; (Zone E) revealed acts eliciting worship — Rev 15:4; (Zone F) eschatological expression of inner righteousness — Rev 19:8. This was retained as a single group at VC per the default reuse rule (§6.2 Step 3) because characteristic-level splitting is Session B's analytical task. Session B should evaluate whether these zones constitute a unified characteristic (the dikaiōma as the outer pole of the inner/outer righteousness relation) or whether material divergence warrants splitting the group via a later VCREVISE. Relevant anchors: Rom 5:16 (verdict face) and Rev 15:4 (worship-response face).
...
### `G1345` — 10/10 classified · 2 anchor verse(s)

**Group `1099-001`** (10 verses — anchors: Rom 5:16, Rev 15:4)

- **Rom 5:16** 🔵 (✓) *target: justification*
  > Rom 5:16 And the free gift is not like the result of that one man’s sin . For the judgment following one trespass brought condemnation , but the free gift following many trespasses brought justification .
- **Rev 15:4** 🔵 (✓) *target: righteous acts*
  ...
  - notes: Anchor for the worship-response / revelation-of-God's-righteous-acts face of the group. God's dikaiōmata revealed → all nations fear, glorify, worship. The verse stands alone; the inner-being worship response is explicit.
- **Luk 1:6** (✓) *target: statutes*
  > Luk 1:6 And they were both righteous before God , walking blamelessly in all the commandments and statutes of the Lord .
- **Rom 1:32** (✓) *target: decree*
  > Rom 1:32 Though they know God’s righteous decree that those who practice such things deserve to die , they not only do them but give approval to those who practice them.
- **Rom 2:26** (✓) *target: precepts*
...
- **Rom 5:18** (✓) *target: righteousness*
  > Rom 5:18 Therefore , as one trespass led to condemnation for all men , so one act of righteousness leads to justification and life for all men .
- **Rom 8:4** (✓) *target: righteous*
  > Rom 8:4 in order that the righteous requirement of the law might be fulfilled in us , who walk not according to the flesh but according to the Spirit .
- **Heb 9:1** (✓) *target: regulations*
  > Heb 9:1 Now even the first covenant had regulations for worship and an earthly place of holiness .
  - notes: External cultic regulations of the first covenant; the term names the standard set up by Hebrews' wider argument as the external-only regulation contrasted with inner reality (9:14 perfecting the conscience). Inner-being engagement via implication (GR-PROG-007 branch b).
- **Heb 9:10** (✓) *target: regulations*
  ...
  - notes: Explicit continuation of Heb 9:1 — names the dikaiōmata as 'for the body' and temporally limited, contrasting them with the inner reality of the new covenant. Filter pass via the inner/outer contrast argument.
- **Rev 19:8** (✓) *target: righteous deeds*
  ...
  - notes: Saints' dikaiōmata as the Bride's fine linen — outward expression / visible adornment of inner righteousness at the eschatological consummation. Filter pass via branch b (term qualifies inner-being characteristic by naming its outward expression).
...
### Registry-specific extensions for R139 righteousness

_None._ No active non-tiered extensions in `wa_obs_question_catalogue` are sourced from registry 139 (righteousness).
...
- **Generated at:** `2026-05-02T15:24:58Z`
- **Schema version:** `3.17.0`
- **OWNER term md_versions present:** `[2]`
...
*End of readiness output v3 — wa-139-righteousness.*