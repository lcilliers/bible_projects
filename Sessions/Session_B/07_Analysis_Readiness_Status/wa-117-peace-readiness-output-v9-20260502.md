# wa-117-peace — Analysis Readiness Output (v6)

_v6 generation · 2026-05-02T04:30:43Z · schema 3.17.0 · catalogue v2-2026-04-29 (T0–T7)_
...
- **Registry no:** `117` · **word:** `peace`
- **verse_context_status:** `Complete`
- **session_b_status:** `Verse Context Reset`
- **dim_review_status:** `Complete` (version `wa-dimensionreview-instruction-v3_3-20260418.md`)
...
- `phase1_term_count`: 125  (programme-wide aggregate including XREF and historical terms — current OWNER count is 62, XREF 6)
- `phase1_verse_count`: 2764  (programme-wide aggregate; current registry verse counts shown per term in §C)

**Open flags:** 3 unresolved · **Existing session_b_findings:** 3

**Description:**

> Peace is the condition of wholeness, right relationship, and rest — the Hebrew shalom covering far more than the absence of conflict. It means completeness, prosperity, welfare, the flourishing of everything and everyone in their proper place. It is used of the end of hostilities, of the quality of a life well-lived, of the relationship between a person and God when that relationship is restored. The New Testament declares that Christ himself is our peace: through him the fundamental rupture between humanity and God is healed. Peace is the signature of the kingdom.
...
- **Generation timestamp:** `2026-05-02T04:30:43Z`
- **Schema version:** `3.17.0`
- **OWNER term md_versions present:** `[1, 2]`
  (this is the project's audit equivalent of `meta.export_version`)
- **OWNER terms vc_completed:** 49 / 62
- **OWNER terms legacy-VC (not_done):** 13 / 62
...
|---|---|---|---|---|---|---:|---:|---:|---|---:|
| `H0136` | a.do.na | Lord [God] | H | `extracted_theological_anchor` | **`not_done`** | 1 | 187 | 0/0 | 0/0 | 0 |
| `H1180` | ba.a.li | Baal [used for God] | H | `extracted_thin` | **`vc_completed`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H1293` | be.ra.khah | blessing | H | `extracted` | **`vc_completed`** | 1 | 64 | 2/0 | 63/0 | 3 |
| `H1585` | ge.mar | to complete | H | `extracted` | **`vc_completed`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H1748` | du.mam | silence | H | `extracted` | **`vc_completed`** | 1 | 3 | 1/0 | 3/0 | 1 |
| `H1820` | da.mah | to cease | H | `extracted` | **`vc_completed`** | 1 | 13 | 1/0 | 7/0 | 1 |
| `H1826A` | da.mam | to silence: stationary | H | `extracted` | **`vc_completed`** | 1 | 9 | 1/0 | 9/0 | 2 |
| `H1826H` | da.mam | to silence: silent | H | `extracted` | **`vc_completed`** | 1 | 15 | 1/0 | 15/0 | 2 |
| `H1827` | de.ma.mah | silence | H | `extracted` | **`vc_completed`** | 1 | 3 | 1/0 | 3/0 | 1 |
| `H2010` | ha.na.chah | holiday | H | `extracted` | **`vc_completed`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H2013` | has | to silence | H | `extracted` | **`vc_completed`** | 1 | 8 | 1/0 | 8/0 | 2 |
| `H2790A` | cha.rash | to plow/plot | H | `extracted` | **`vc_completed`** | 1 | 22 | 2/0 | 11/0 | 2 |
| `H2790B` | cha.resh | be quiet | H | `extracted` | **`vc_completed`** | 1 | 43 | 6/0 | 30/0 | 10 |
| `H2814` | cha.shah | be silent | H | `extracted` | **`vc_completed`** | 1 | 16 | 4/0 | 14/0 | 5 |
| `H3071` | ye.ho.vah nis.si | YHWH-Nissi | H | `extracted_theological_anchor` | **`not_done`** | 1 | 0 | 0/0 | 0/0 | 0 |
| `H3072` | ye.ho.vah tsid.qe.nu | YHWH-Tsidkenu | H | `extracted_theological_anchor` | **`not_done`** | 1 | 0 | 0/0 | 0/0 | 0 |
| `H3073` | ye.ho.vah sha.lom | YHWH-Shalom | H | `extracted_theological_anchor` | **`not_done`** | 1 | 0 | 0/0 | 0/0 | 0 |
| `H4494` | ma.no.ach | resting | H | `extracted` | **`vc_completed`** | 1 | 6 | 1/0 | 3/0 | 2 |
| `H4496H` | me.nu.chah | resting | H | `extracted` | **`vc_completed`** | 1 | 21 | 3/0 | 14/0 | 4 |
| `H4771` | mar.go.a | rest | H | `extracted` | **`vc_completed`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H4774` | mar.ge.ah | repose | H | `extracted` | **`vc_completed`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H5117` | nu.ach | to rest | H | `extracted` | **`vc_completed`** | 1 | 140 | 6/0 | 58/0 | 11 |
| `H5118` | nu.ach | rest | H | `extracted` | **`vc_completed`** | 1 | 2 | 2/0 | 2/0 | 2 |
| `H5183A` | na.chat | quietness | H | `extracted` | **`vc_completed`** | 1 | 6 | 1/0 | 5/0 | 2 |
| `H5207` | ni.cho.ach | soothing | H | `extracted` | **`vc_completed`** | 1 | 43 | 3/0 | 43/0 | 4 |
| `H5251H` | nes | ensign | H | `extracted` | **`vc_completed`** | 1 | 20 | 1/0 | 7/0 | 2 |
| `H5769G` | o.lam | forever: enduring | H | `extracted_theological_anchor` | **`not_done`** | 1 | 272 | 0/0 | 0/0 | 0 |
| `H5769H` | o.lam | Everlasting [God] | H | `extracted_theological_anchor` | **`not_done`** | 1 | 1 | 0/0 | 0/0 | 0 |
| `H5943` | il.lay | Most High [God] | H | `extracted_theological_anchor` | **`not_done`** | 1 | 10 | 0/0 | 0/0 | 0 |
| `H5946` | el.yon | Most High [God] | H | `extracted_theological_anchor` | **`not_done`** | 1 | 4 | 0/0 | 0/0 | 0 |
| `H6635A` | tsa.va | army | H | `extracted_theological_anchor` | **`not_done`** | 1 | 136 | 0/0 | 0/0 | 0 |
| `H6635B` | tsa.va | Hosts | H | `extracted_theological_anchor` | **`not_done`** | 1 | 156 | 0/0 | 0/0 | 0 |
| `H6664H` | tse.deq | righteousness | H | `extracted_theological_anchor` | **`not_done`** | 1 | 2 | 0/0 | 0/0 | 0 |
| `H7067G` | qan.na | Jealous [God] | H | `extracted` | **`vc_completed`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H7280A` | ra.ga | to disturb | H | `extracted` | **`vc_completed`** | 1 | 6 | 1/0 | 3/0 | 1 |
| `H7280B` | ra.ga | to rest | H | `extracted` | **`vc_completed`** | 1 | 6 | 1/0 | 3/0 | 2 |
| `H7282` | ra.ge.a | restful | H | `extracted` | **`vc_completed`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H7600` | sha.a.nan | secure | H | `extracted` | **`vc_completed`** | 1 | 10 | 2/0 | 9/0 | 3 |
| `H7706` | shad.day | Almighty [God] | H | `extracted_theological_anchor` | **`not_done`** | 1 | 48 | 0/0 | 0/0 | 0 |
| `H7946` | shal.a.nan | at ease | H | `extracted` | **`vc_completed`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H7965G` | sha.lom | peace | H | `extracted` | **`vc_completed`** | 2 | 148 | 4/0 | 83/65 | 13 |
| `H7965H` | sha.lom | peace | H | `extracted_thin` | **`vc_completed`** | 2 | 1 | 1/0 | 1/0 | 1 |
| `H7965I` | sha.lom | peace: well-being | H | `extracted` | **`vc_completed`** | 2 | 46 | 2/0 | 17/29 | 3 |
| `H7965J` | sha.lom | peace: friendship | H | `extracted_thin` | **`vc_completed`** | 2 | 5 | 1/0 | 5/0 | 1 |
| `H7965K` | sha.lom | peace: greeting | H | `extracted_thin` | **`vc_completed`** | 2 | 8 | 1/0 | 1/7 | 1 |
| `H7965L` | sha.lom | peace: completely | H | `extracted_thin` | **`vc_completed`** | 2 | 1 | 0/0 | 0/1 | 0 |
| `H8252` | sha.qat | to quiet | H | `extracted` | **`vc_completed`** | 1 | 41 | 4/0 | 23/0 | 7 |
| `H8253` | she.qet | quietness | H | `extracted` | **`vc_completed`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `G0425` | anesis | rest | G | `extracted` | **`vc_completed`** | 1 | 5 | 1/0 | 5/0 | 1 |
| `G1514` | eirēneuō | be at peace | G | `extracted` | **`vc_completed`** | 1 | 4 | 1/0 | 4/0 | 1 |
| `G1515` | eirēnē | peace | G | `extracted` | **`vc_completed`** | 1 | 84 | 3/0 | 84/0 | 5 |
| `G1516` | eirēnikos | peaceful | G | `extracted` | **`vc_completed`** | 1 | 2 | 1/0 | 2/0 | 1 |
| `G1517` | eirēnopoieō | to make peace | G | `extracted_thin` | **`vc_completed`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `G2263` | ēremos | quiet | G | `extracted` | **`vc_completed`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `G2270` | hēsuchazō | be quiet/give up | G | `extracted` | **`vc_completed`** | 1 | 5 | 1/0 | 5/0 | 2 |
| `G2271` | hēsuchia | quietness | G | `extracted` | **`vc_completed`** | 1 | 4 | 1/0 | 4/0 | 1 |
| `G2272` | hēsuchios | quiet | G | `extracted` | **`vc_completed`** | 1 | 2 | 1/0 | 2/0 | 1 |
| `G4519` | sabaōth | hosts | G | `extracted_theological_anchor` | **`not_done`** | 1 | 2 | 0/0 | 0/0 | 0 |
| `G4601` | sigaō | be silent | G | `extracted` | **`vc_completed`** | 1 | 9 | 1/0 | 9/0 | 1 |
| `G4602` | sigē | silence | G | `extracted` | **`vc_completed`** | 1 | 2 | 1/0 | 2/0 | 1 |
| `G4623` | siōpaō | be quiet | G | `extracted` | **`vc_completed`** | 1 | 11 | 1/0 | 11/0 | 2 |
| `G5392` | fimoō | to muzzle | G | `extracted` | **`vc_completed`** | 1 | 8 | 1/0 | 8/0 | 2 |
...
**Identity:** mti=2513 · ti=2651 · language=Hebrew · status=`extracted_theological_anchor` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False
...
**Root family:**
- `EL` (Hebrew): army — Backfilled 2026-04-09 from wa_term_related_words clustering

**Related words (45 total; sample of 30):**
- `G0005` abba "Abba"
- `G1682` elōi "Eloi"
- `G2241` ēli "Eli"
- `G4519` sabaōth "hosts"
...
- … and 15 more shown of 45 total

### `H1180` — ba.a.li "Baal [used for God]"

**Identity:** mti=2535 · ti=2673 · language=Hebrew · status=`extracted_thin` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: The Deity; 
called LORD or LORD (KJV= Jehovah) (יהוה); or LORD (KJV= Jehovah) (יְהֹוִה); or LORD (יָהּ); or Lord (אֲדֹנָי); or God (KJV= Elohim) (אֱלֹהִים); or Baal (KJV= Baali; NIV= Master) (בַּעֲלִי); or Almighty (שַׁדַּי); or Most High (עַל); or Most High (Aramiac עִלַּי); or Most High (KJV= "most High") or Most High (KJV= Highest) (עֶלְיוֹן); or Most High (Aramiac עֶלְיוֹן); or God/ Most High (KJV= "most high God") (אֵל עֶלְיוֹן); or God (אֵל=God); or El/-Elohe (אֵל אֱלֹהִים); or El/-Elohe Israel (=Alt tag) (אֵל אֱלֹהֵי יִשְׂרָאֵל); or Banner (KJV= Nissi) (נֵס); or Banner (KJV= Nissi) (=Alt tag) (יְהֹוָה נִסִּי); or Peace (KJV= Shalom) (שָׁלוֹם); or Peace (KJV= Shalom) (=Alt tag) (יְהֹוָה שָׁלוֹם); or Provider (KJV= Jireh) (יִרְאֶה); or Provider (KJV= Jireh) (=Alt tag) (יִרְאֶה); or LORD our Righteousness (NIV= Righteous Saviour) (צִדְקֵנוּ); or LORD our Righteousness (NIV= Righteous Saviour) (יְהֹוָה צִדְקֵנוּ (=Alt tag)); or Everlasting (NIV= Eternal) (עוֹלָם); or Jealous (קַנָּא); or Hosts (NIV= Almighty) (צָבָא); or Highest (ὕψιστος); or "hosts" (KJV= "sabaoth;" NIV= Almighty) (σαβαώθ); or Abba (ἀββά); or Eli (ἠλί); or Eloi (ἐλωΐ) § a deity in the northern kingdom, variation of the name 'Baal'

**Root family:**
- `EL` (Hebrew): army — Backfilled 2026-04-09 from wa_term_related_words clustering

**Related words (24 total; sample of 24):**
- `G0005` abba "Abba"
- `G1682` elōi "Eloi"
- `G2241` ēli "Eli"
- `G4519` sabaōth "hosts"
...
- … and 9 more shown of 24 total

### `H1293` — be.ra.khah "blessing"

**Identity:** mti=410 · ti=621 · language=Hebrew · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 6 top senses · 0 stems · causative=False · domain_tags=False
...
**Root family:**
- `BEREKH` (Hebrew): knee — Backfilled 2026-04-09 from wa_term_related_words clustering

**Related words (18 total; sample of 18):**
- `H1263G` ba.rukh "Baruch"
- `H1263H` ba.rukh "Baruch"
- `H1263I` ba.rukh "Baruch"
- `H1263J` ba.rukh "Baruch"
- `H1288` ba.rakh "to bless"
- `H1290` be.rekh "knee"
- `H1292` ba.rakh.el "Barachel"
- `H1294G` be.ra.khah "Beracah"
- `H1294H` be.ra.khah "Beracah [Valley]"
- `H1295G` be.re.khah "[Shelah] Pool"
- `H1295H` be.re.khah "pool"
- `H1296G` be.rekh.yah "Berechiah"
- `H1296H` be.rekh.yah "Berechiah"
- `H1296I` be.rekh.yah "Berechiah"
- `H1296J` be.rekh.yah "Berechiah"
- … and 3 more shown of 18 total

### `H1585` — ge.mar "to complete"

**Identity:** mti=415 · ti=626 · language=Hebrew · status=`extracted` · md_v=1
...
Sub-senses (depth > 1): 1 entries — present in DB; first 15:
  - `1a` (under `None`): (P'al) perfect (pass participle)

**Root family:**
- `GAPH` (Hebrew): wing — Backfilled 2026-04-09 from wa_term_related_words clustering

**Related words (10 total; sample of 10):**
- `H1584` ga.mar "to cease"
- `H1584` ga.mar "to cease"
- `H1596` ge.naz "treasure"
- `H1596` ge.naz "treasure"
- `H1611` gaph "wing"
- `H1611` gaph "wing"
- `H1635` ge.ram "bone"
...
### `H1748` — du.mam "silence"

**Identity:** mti=2602 · ti=2740 · language=Hebrew · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 2 top senses · 0 stems · causative=False · domain_tags=False
...
**Root family:**
- `DAM` (Hebrew): blood — Backfilled 2026-04-09 from wa_term_related_words clustering

**Related words (8 total; sample of 8):**
- `H1745` du.mah "silence"
- `H1746G` du.mah "Dumah"
- `H1746H` du.mah "Dumah"
- `H1747` du.miy.yah "silence"
- `H1826A` da.mam "to silence: stationary"
- `H1826B` da.mam "to wail"
- `H1826H` da.mam "to silence: silent"
- `H1826I` da.mam "to silence: destroyed"

### `H1820` — da.mah "to cease"

**Identity:** mti=2601 · ti=2739 · language=Hebrew · status=`extracted` · md_v=1
...
Sub-senses (depth > 1): 6 entries — present in DB; first 15:
  - `1a` (under `None`): (Qal)
  - `1a1` (under `None`): to cease
  - `1a2` (under `None`): to cause to cease, destroy
  - `1b` (under `None`): (Niphal)
  - `1b1` (under `None`): to be cut off
  - `1b2` (under `None`): to be undone, be cut off at sight of the theophany
...
**Identity:** mti=2597 · ti=2735 · language=Hebrew · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=True · domain_tags=False
...
- `H1826H` da.mam "to silence: silent"
- `H1826I` da.mam "to silence: destroyed"
- `H1827` de.ma.mah "silence"

### `H1826H` — da.mam "to silence: silent"

**Identity:** mti=2596 · ti=2734 · language=Hebrew · status=`extracted` · md_v=1
...
**Identity:** mti=2603 · ti=2741 · language=Hebrew · status=`extracted` · md_v=1
...
**Identity:** mti=2589 · ti=2727 · language=Hebrew · status=`extracted` · md_v=1
...
**Root family:**
- `NUACH` (Hebrew): rest — Backfilled 2026-04-09 from wa_term_related_words clustering

**Related words (17 total; sample of 17):**
- `H3239A` ya.no.ach "Janoah"
- `H3239B` ya.no.chah "Janoah"
- `H4494` ma.no.ach "resting"
- `H4495` ma.no.ach "Manoah"
- `H4496G` me.nu.chah "Nohah"
- `H4496H` me.nu.chah "resting"
- `H4506A` ma.na.chat "Manahath"
- `H4506B` ma.na.chat "Manahath"
- `H4506G` ma.na.chat "Manahathite"
- `H4506H` ma.na.chat "Menuhoth"
- `H5117` nu.ach "to rest"
- `H5118` nu.ach "rest"
- `H5119` no.chah "Nohah"
- `H5146` no.ach "Noah"
- `H5183A` na.chat "quietness"
- … and 2 more shown of 17 total

### `H2013` — has "to silence"

**Identity:** mti=421 · ti=632 · language=Hebrew · status=`extracted` · md_v=1
...
**Root family:**
- `HAS` (Hebrew): to silence — Backfilled 2026-04-09 from wa_term_related_words clustering

### `H2790A` — cha.rash "to plow/plot"

**Identity:** mti=417 · ti=628 · language=Hebrew · status=`extracted` · md_v=1
...
Sub-senses (depth > 1): 6 entries — present in DB; first 15:
  - `1a` (under `None`): (Qal)
  - `1a1` (under `None`): to cut in, engrave
  - `1a2` (under `None`): to plough
  - `1a3` (under `None`): to devise
  - `1b` (under `None`): (Niphal) to be ploughed
  - `1c` (under `None`): (Hiphil) to plot evil

**Root family:**
- `CHARISH` (Hebrew): wood — Backfilled 2026-04-09 from wa_term_related_words clustering

**Related words (26 total; sample of 26):**
- `H2758` cha.rish "plowing"
- `H2758` cha.rish "plowing"
- `H2759` cha.ri.shi "scorching"
- `H2759` cha.ri.shi "scorching"
- `H2790B` cha.resh "be quiet"
- `H2790B` cha.resh "be quiet"
- `H2791A` che.resh "silently"
- `H2791A` che.resh "silently"
- `H2791B` che.resh "craftily"
- `H2791B` che.resh "craftily"
- `H2793G` cho.resh "Horesh"
- `H2793G` cho.resh "Horesh"
- `H2793H` cho.resh "wood"
- `H2793H` cho.resh "wood"
- `H2794` cho.resh "artificer"
- … and 11 more shown of 26 total

### `H2790B` — cha.resh "be quiet"

**Identity:** mti=408 · ti=619 · language=Hebrew · status=`extracted` · md_v=1
...
Sub-senses (depth > 1): 8 entries — present in DB; first 15:
  - `1a` (under `None`): (Qal)
  - `1a1` (under `None`): to be silent
  - `1a2` (under `None`): to be deaf
  - `1b` (under `None`): (Hiphil)
  - `1b1` (under `None`): to be silent, keep quiet
  - `1b2` (under `None`): to make silent
  - `1b3` (under `None`): to be deaf, show deafness
  - `1c` (under `None`): (Hithpael) to remain silent
...
**Identity:** mti=409 · ti=620 · language=Hebrew · status=`extracted` · md_v=1
...
Sub-senses (depth > 1): 5 entries — present in DB; first 15:
  - `1a` (under `None`): (Qal) to be silent, be still
  - `1b` (under `None`): (Hiphil)
  - `1b1` (under `None`): to be silent, exhibit silence
  - `1b2` (under `None`): to show inactivity, be inactive
  - `1b3` (under `None`): to make silent, make quiet, cause to be still

**Root family:**
- `CHASHAH` (Hebrew): be silent — Backfilled 2026-04-09 from wa_term_related_words clustering

### `H3071` — ye.ho.vah nis.si "YHWH-Nissi"

**Identity:** mti=435 · ti=646 · language=Hebrew · status=`extracted_theological_anchor` · md_v=1

**anchor_note:**

> Framework A/B intersection term. Ontological ground of inner-being peace. Session B analysis deferred until intersection question formally opened.

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: YHWH is my banner. Altar name given by Moses after the defeat of Amalek (Exod 17:15).

**Root family:**
- `YEHOVAH ` (Hebrew): YHWH-Nissi — Backfilled 2026-04-09 from wa_term_related_words clustering

### `H3072` — ye.ho.vah tsid.qe.nu "YHWH-Tsidkenu"

**Identity:** mti=434 · ti=645 · language=Hebrew · status=`extracted_theological_anchor` · md_v=1
...
Senses (top-level):
- `1`: YHWH our righteousness. Applied symbolically to Jerusalem and the Messiah (Jer 23:6; 33:16).

**Root family:**
- `YEHOVAH ` (Hebrew): YHWH-Tsidkenu — Backfilled 2026-04-09 from wa_term_related_words clustering

### `H3073` — ye.ho.vah sha.lom "YHWH-Shalom"

**Identity:** mti=433 · ti=644 · language=Hebrew · status=`extracted_theological_anchor` · md_v=1
...
Senses (top-level):
- `1`: YHWH is peace. Sacred altar name given by Gideon at Ophrah (Judg 6:24).

**Root family:**
- `YEHOVAH ` (Hebrew): YHWH-Shalom — Backfilled 2026-04-09 from wa_term_related_words clustering

### `H4494` — ma.no.ach "resting"

**Identity:** mti=2586 · ti=2724 · language=Hebrew · status=`extracted` · md_v=1
...
Sub-senses (depth > 1): 3 entries — present in DB; first 15:
  - `1a` (under `None`): resting place
  - `1b` (under `None`): rest, repose, condition of rest
  - `1c` (under `None`): coming to rest
...
**Identity:** mti=2585 · ti=2723 · language=Hebrew · status=`extracted` · md_v=1
...
Sub-senses (depth > 1): 2 entries — present in DB; first 15:
  - `1a` (under `None`): resting place
  - `1b` (under `None`): rest, quietness Also means: nu.ach (נוּחַ "rest" H5118)
...
**Identity:** mti=2593 · ti=2731 · language=Hebrew · status=`extracted` · md_v=1
...
**Root family:**
- `RAGA` (Hebrew): rest — Backfilled 2026-04-09 from wa_term_related_words clustering

**Related words (5 total; sample of 5):**
- `H4774` mar.ge.ah "repose"
- `H7280A` ra.ga "to disturb"
- `H7280B` ra.ga "to rest"
- `H7280C` ra.ga "to harden"
- `H7282` ra.ge.a "restful"

### `H4774` — mar.ge.ah "repose"

**Identity:** mti=2594 · ti=2732 · language=Hebrew · status=`extracted` · md_v=1
...
**Identity:** mti=419 · ti=630 · language=Hebrew · status=`extracted` · md_v=1
...
Sub-senses (depth > 1): 15 entries — present in DB; first 15:
  - `1a` (under `None`): (Qal)
  - `1a1` (under `None`): to rest, settle down and remain
  - `1a2` (under `None`): to repose, have rest, be quiet
  - `1b` (under `None`): (Hiphil)
  - `1b1` (under `None`): to cause to rest, give rest to, make quiet
  - `1b2` (under `None`): to cause to rest, cause to alight, set down
  - `1b3` (under `None`): to lay or set down, deposit, let lie, place
  - `1b4` (under `None`): to let remain, leave
  - `1b5` (under `None`): to leave, depart from
  - `1b6` (under `None`): to abandon
  - `1b7` (under `None`): to permit
  - `1c` (under `None`): (Hophal)
  - `1c1` (under `None`): to obtain rest, be granted rest
  - `1c2` (under `None`): to be left, be placed
  - `1c3` (under `None`): open space (subst) Also means: ya.nach (יָנַח "to rest" H3240)
...
**Identity:** mti=2588 · ti=2726 · language=Hebrew · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: resting place
Another spelling of me.nu.chah (מְנוּחָה "resting" H4496H)
...
**Identity:** mti=2587 · ti=2725 · language=Hebrew · status=`extracted` · md_v=1
...
Sub-senses (depth > 1): 2 entries — present in DB; first 15:
  - `1a` (under `None`): quietness, quiet attitude
  - `1b` (under `None`): rest (of death)
...
### `H5207` — ni.cho.ach "soothing"

**Identity:** mti=2584 · ti=2722 · language=Hebrew · status=`extracted` · md_v=1
...
**Identity:** mti=2521 · ti=2659 · language=Hebrew · status=`extracted` · md_v=1
...
Sub-senses (depth > 1): 3 entries — present in DB; first 15:
  - `1a` (under `None`): standard (as rallying point), signal
  - `1b` (under `None`): standard (pole)
  - `1c` (under `None`): ensign, signal
...
- `H5251G` nes "Banner [God]"
- `H5264` na.sas "to shine"

### `H5769G` — o.lam "forever: enduring"

**Identity:** mti=2514 · ti=2652 · language=Hebrew · status=`extracted_theological_anchor` · md_v=1
...
- `H5865` e.lom "ever"
- `H5956` a.lam "to conceal"
- `H5957` a.lam "perpetuity"

### `H5769H` — o.lam "Everlasting [God]"

**Identity:** mti=2539 · ti=2677 · language=Hebrew · status=`extracted_theological_anchor` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: The Deity; 
called LORD or LORD (KJV= Jehovah) (יהוה); or LORD (KJV= Jehovah) (יְהֹוִה); or LORD (יָהּ); or Lord (אֲדֹנָי); or God (KJV= Elohim) (אֱלֹהִים); or Baal (KJV= Baali; NIV= Master) (בַּעֲלִי); or Almighty (שַׁדַּי); or Most High (עַל); or Most High (Aramiac עִלַּי); or Most High (KJV= "most High") or Most High (KJV= Highest) (עֶלְיוֹן); or Most High (Aramiac עֶלְיוֹן); or God/ Most High (KJV= "most high God") (אֵל עֶלְיוֹן); or God (אֵל=God); or El/-Elohe (אֵל אֱלֹהִים); or El/-Elohe Israel (=Alt tag) (אֵל אֱלֹהֵי יִשְׂרָאֵל); or Banner (KJV= Nissi) (נֵס); or Banner (KJV= Nissi) (=Alt tag) (יְהֹוָה נִסִּי); or Peace (KJV= Shalom) (שָׁלוֹם); or Peace (KJV= Shalom) (=Alt tag) (יְהֹוָה שָׁלוֹם); or Provider (KJV= Jireh) (יִרְאֶה); or Provider (KJV= Jireh) (=Alt tag) (יִרְאֶה); or LORD our Righteousness (NIV= Righteous Saviour) (צִדְקֵנוּ); or LORD our Righteousness (NIV= Righteous Saviour) (יְהֹוָה צִדְקֵנוּ (=Alt tag)); or Everlasting (NIV= Eternal) (עוֹלָם); or Jealous (קַנָּא); or Hosts (NIV= Almighty) (צָבָא); or Highest (ὕψιστος); or "hosts" (KJV= "sabaoth;" NIV= Almighty) (σαβαώθ); or Abba (ἀββά); or Eli (ἠλί); or Eloi (ἐλωΐ) §This name means long duration, everlasting, perpetual

**Root family:**
- `EL` (Hebrew): army — Backfilled 2026-04-09 from wa_term_related_words clustering

**Related words (46 total; sample of 30):**
- `G0005` abba "Abba"
- `G1682` elōi "Eloi"
- `G2241` ēli "Eli"
- `G4519` sabaōth "hosts"
...
- `H3050` yah "LORD"
- `H3068G` ye.ho.vah "LORD"
- … and 15 more shown of 46 total

### `H5943` — il.lay "Most High [God]"

**Identity:** mti=2524 · ti=2662 · language=Hebrew · status=`extracted_theological_anchor` · md_v=1
...
**Identity:** mti=2530 · ti=2668 · language=Hebrew · status=`extracted_theological_anchor` · md_v=1
...
**Identity:** mti=2515 · ti=2653 · language=Hebrew · status=`extracted_theological_anchor` · md_v=1
...
**Identity:** mti=436 · ti=647 · language=Hebrew · status=`extracted_theological_anchor` · md_v=1
...
**Related words (92 total; sample of 30):**
- `G0005` abba "Abba"
- `G0005` abba "Abba"
- `G1682` elōi "Eloi"
- `G1682` elōi "Eloi"
...
- `H0410G` el "God"
- `H0410I` el "El [Elohe]"
- … and 15 more shown of 92 total

### `H6664H` — tse.deq "righteousness"

**Identity:** mti=438 · ti=649 · language=Hebrew · status=`extracted_theological_anchor` · md_v=1
...
Senses (top-level):
- `1`: The Deity; 
called LORD or LORD (KJV= Jehovah) (יהוה); or LORD (KJV= Jehovah) (יְהֹוִה); or LORD (יָהּ); or Lord (אֲדֹנָי); or God (KJV= Elohim) (אֱלֹהִים); or Baal (KJV= Baali; NIV= Master) (בַּעֲלִי); or Almighty (שַׁדַּי); or Most High (עַל); or Most High (Aramiac עִלַּי); or Most High (KJV= "most High") or Most High (KJV= Highest) (עֶלְיוֹן); or Most High (Aramiac עֶלְיוֹן); or God/ Most High (KJV= "most high God") (אֵל עֶלְיוֹן); or God (אֵל=God); or El/-Elohe (אֵל אֱלֹהִים); or El/-Elohe Israel (=Alt tag) (אֵל אֱלֹהֵי יִשְׂרָאֵל); or Banner (KJV= Nissi) (נֵס); or Banner (KJV= Nissi) (=Alt tag) (יְהֹוָה נִסִּי); or Peace (KJV= Shalom) (שָׁלוֹם); or Peace (KJV= Shalom) (=Alt tag) (יְהֹוָה שָׁלוֹם); or Provider (KJV= Jireh) (יִרְאֶה); or Provider (KJV= Jireh) (=Alt tag) (יִרְאֶה); or LORD our Righteousness (NIV= Righteous Saviour) (צִדְקֵנוּ); or LORD our Righteousness (NIV= Righteous Saviour) (יְהֹוָה צִדְקֵנוּ (=Alt tag)); or Everlasting (NIV= Eternal) (עוֹלָם); or Jealous (קַנָּא); or Hosts (NIV= Almighty) (צָבָא); or Highest (ὕψιστος); or "hosts" (KJV= "sabaoth;" NIV= Almighty) (σαβαώθ); or Abba (ἀββά); or Eli (ἠλί); or Eloi (ἐλωΐ) §This name means justice, righteousness
...
**Identity:** mti=439 · ti=650 · language=Hebrew · status=`extracted` · md_v=1
...
Senses (top-level):
- `1`: The Deity; 
called LORD or LORD (KJV= Jehovah) (יהוה); or LORD (KJV= Jehovah) (יְהֹוִה); or LORD (יָהּ); or Lord (אֲדֹנָי); or God (KJV= Elohim) (אֱלֹהִים); or Baal (KJV= Baali; NIV= Master) (בַּעֲלִי); or Almighty (שַׁדַּי); or Most High (עַל); or Most High (Aramiac עִלַּי); or Most High (KJV= "most High") or Most High (KJV= Highest) (עֶלְיוֹן); or Most High (Aramiac עֶלְיוֹן); or God/ Most High (KJV= "most high God") (אֵל עֶלְיוֹן); or God (אֵל=God); or El/-Elohe (אֵל אֱלֹהִים); or El/-Elohe Israel (=Alt tag) (אֵל אֱלֹהֵי יִשְׂרָאֵל); or Banner (KJV= Nissi) (נֵס); or Banner (KJV= Nissi) (=Alt tag) (יְהֹוָה נִסִּי); or Peace (KJV= Shalom) (שָׁלוֹם); or Peace (KJV= Shalom) (=Alt tag) (יְהֹוָה שָׁלוֹם); or Provider (KJV= Jireh) (יִרְאֶה); or Provider (KJV= Jireh) (=Alt tag) (יִרְאֶה); or LORD our Righteousness (NIV= Righteous Saviour) (צִדְקֵנוּ); or LORD our Righteousness (NIV= Righteous Saviour) (יְהֹוָה צִדְקֵנוּ (=Alt tag)); or Everlasting (NIV= Eternal) (עוֹלָם); or Jealous (קַנָּא); or Hosts (NIV= Almighty) (צָבָא); or Highest (ὕψιστος); or "hosts" (KJV= "sabaoth;" NIV= Almighty) (σαβαώθ); or Abba (ἀββά); or Eli (ἠλί); or Eloi (ἐλωΐ) §jealous (only of God)
...
**Identity:** mti=2591 · ti=2729 · language=Hebrew · status=`extracted` · md_v=1
...
Sub-senses (depth > 1): 2 entries — present in DB; first 15:
  - `1a` (under `None`): (Qal) to stir up, disturb
  - `1b` (under `None`): (Hiphil) to make a twinkling
...
**Identity:** mti=420 · ti=631 · language=Hebrew · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=True · domain_tags=False

Senses (top-level):
- `1`: to rest or repose, be at rest or repose, settle, quiet, give rest

Sub-senses (depth > 1): 6 entries — present in DB; first 15:
  - `1a` (under `None`): (Niphal)
  - `1a1` (under `None`): to cause to rest (of sword, of the sea)
  - `1a2` (under `None`): to wink (with prep)
  - `1b` (under `None`): (Hiphil)
  - `1b1` (under `None`): to give rest to
  - `1b2` (under `None`): to rest, repose
...
**Identity:** mti=2595 · ti=2733 · language=Hebrew · status=`extracted` · md_v=1
...
### `H7600` — sha.a.nan "secure"

**Identity:** mti=413 · ti=624 · language=Hebrew · status=`extracted` · md_v=1
...
**Root family:**
- `SHAANAN` (Hebrew): secure — Backfilled 2026-04-09 from wa_term_related_words clustering

**Related words (2 total; sample of 2):**
- `H7599` sha.an "to rest"
- `H7946` shal.a.nan "at ease"

### `H7706` — shad.day "Almighty [God]"

**Identity:** mti=2517 · ti=2655 · language=Hebrew · status=`extracted_theological_anchor` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: The Deity; 
called LORD or LORD (KJV= Jehovah) (יהוה); or LORD (KJV= Jehovah) (יְהֹוִה); or LORD (יָהּ); or Lord (אֲדֹנָי); or God (KJV= Elohim) (אֱלֹהִים); or Baal (KJV= Baali; NIV= Master) (בַּעֲלִי); or Almighty (שַׁדַּי); or Most High (עַל); or Most High (Aramiac עִלַּי); or Most High (KJV= "most High") or Most High (KJV= Highest) (עֶלְיוֹן); or Most High (Aramiac עֶלְיוֹן); or God/ Most High (KJV= "most high God") (אֵל עֶלְיוֹן); or God (אֵל=God); or El/-Elohe (אֵל אֱלֹהִים); or El/-Elohe Israel (=Alt tag) (אֵל אֱלֹהֵי יִשְׂרָאֵל); or Banner (KJV= Nissi) (נֵס); or Banner (KJV= Nissi) (=Alt tag) (יְהֹוָה נִסִּי); or Peace (KJV= Shalom) (שָׁלוֹם); or Peace (KJV= Shalom) (=Alt tag) (יְהֹוָה שָׁלוֹם); or Provider (KJV= Jireh) (יִרְאֶה); or Provider (KJV= Jireh) (=Alt tag) (יִרְאֶה); or LORD our Righteousness (NIV= Righteous Saviour) (צִדְקֵנוּ); or LORD our Righteousness (NIV= Righteous Saviour) (יְהֹוָה צִדְקֵנוּ (=Alt tag)); or Everlasting (NIV= Eternal) (עוֹלָם); or Jealous (קַנָּא); or Hosts (NIV= Almighty) (צָבָא); or Highest (ὕψιστος); or "hosts" (KJV= "sabaoth;" NIV= Almighty) (σαβαώθ); or Abba (ἀββά); or Eli (ἠλί); or Eloi (ἐλωΐ) §Shaddai, the Almighty (God) 
...
**Identity:** mti=2577 · ti=2715 · language=Hebrew · status=`extracted` · md_v=1
...
- `H0814` esh.kar "gift"
- `H7600` sha.a.nan "secure"
- `H7944` shal "irreverence"

### `H7965G` — sha.lom "peace"

**Identity:** mti=2508 · ti=2646 · language=Hebrew · status=`extracted` · md_v=2
...
**Related words (81 total; sample of 30):**
- `H4918G` me.shul.lam "Meshullam"
- `H4918H` me.shul.lam "Meshullam"
- `H4918I` me.shul.lam "Meshullam"
- `H4918J` me.shul.lam "Meshullam"
- `H4918K` me.shul.lam "Meshullam"
- `H4918L` me.shul.lam "Meshullam"
- `H4918M` me.shul.lam "Meshullam"
- `H4918N` me.shul.lam "Meshullam"
- `H4918O` me.shul.lam "Meshullam"
- `H4918P` me.shul.lam "Meshullam"
- `H4918Q` me.shul.lam "Meshullam"
- `H4918R` me.shul.lam "Meshullam"
- `H4918S` me.shul.lam "Meshullam"
- `H4918T` me.shul.lam "Meshullam"
- `H4918U` me.shul.lam "Meshullam"
- … and 15 more shown of 81 total

### `H7965H` — sha.lom "peace"

**Identity:** mti=406 · ti=617 · language=Hebrew · status=`extracted_thin` · md_v=2

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: The Deity; 
called LORD or LORD (KJV= Jehovah) (יהוה); or LORD (KJV= Jehovah) (יְהֹוִה); or LORD (יָהּ); or Lord (אֲדֹנָי); or God (KJV= Elohim) (אֱלֹהִים); or Baal (KJV= Baali; NIV= Master) (בַּעֲלִי); or Almighty (שַׁדַּי); or Most High (עַל); or Most High (Aramiac עִלַּי); or Most High (KJV= "most High") or Most High (KJV= Highest) (עֶלְיוֹן); or Most High (Aramiac עֶלְיוֹן); or God/ Most High (KJV= "most high God") (אֵל עֶלְיוֹן); or God (אֵל=God); or El/-Elohe (אֵל אֱלֹהִים); or El/-Elohe Israel (=Alt tag) (אֵל אֱלֹהֵי יִשְׂרָאֵל); or Banner (KJV= Nissi) (נֵס); or Banner (KJV= Nissi) (=Alt tag) (יְהֹוָה נִסִּי); or Peace (KJV= Shalom) (שָׁלוֹם); or Peace (KJV= Shalom) (=Alt tag) (יְהֹוָה שָׁלוֹם); or Provider (KJV= Jireh) (יִרְאֶה); or Provider (KJV= Jireh) (=Alt tag) (יִרְאֶה); or LORD our Righteousness (NIV= Righteous Saviour) (צִדְקֵנוּ); or LORD our Righteousness (NIV= Righteous Saviour) (יְהֹוָה צִדְקֵנוּ (=Alt tag)); or Everlasting (NIV= Eternal) (עוֹלָם); or Jealous (קַנָּא); or Hosts (NIV= Almighty) (צָבָא); or Highest (ὕψιστος); or "hosts" (KJV= "sabaoth;" NIV= Almighty) (σαβαώθ); or Abba (ἀββά); or Eli (ἠλί); or Eloi (ἐλωΐ) §This name means completeness, peace
...
**Identity:** mti=2509 · ti=2647 · language=Hebrew · status=`extracted` · md_v=2
...
**Identity:** mti=2510 · ti=2648 · language=Hebrew · status=`extracted_thin` · md_v=2
...
**Identity:** mti=2511 · ti=2649 · language=Hebrew · status=`extracted_thin` · md_v=2
...
**Identity:** mti=2512 · ti=2650 · language=Hebrew · status=`extracted_thin` · md_v=2
...
### `H8252` — sha.qat "to quiet"

**Identity:** mti=418 · ti=629 · language=Hebrew · status=`extracted` · md_v=1
...
Sub-senses (depth > 1): 9 entries — present in DB; first 15:
  - `1a` (under `None`): (Qal)
  - `1a1` (under `None`): to be quiet, be undisturbed
  - `1a1a` (under `1a`): to be at peace (of land)
  - `1a2` (under `None`): to be quiet, be inactive
  - `1b` (under `None`): (Hiphil)
  - `1b1` (under `None`): to show quietness
  - `1b1a` (under `1b`): quietness, display of quietness (subst)
  - `1b2` (under `None`): to quiet, be quiet
  - `1b3` (under `None`): to cause quietness, pacify, allay

**Root family:**
- `SHAQAT` (Hebrew): to quiet — Backfilled 2026-04-09 from wa_term_related_words clustering

**Related words (2 total; sample of 2):**
- `H8253` she.qet "quietness"
- `H8253` she.qet "quietness"

### `H8253` — she.qet "quietness"

**Identity:** mti=2583 · ti=2721 · language=Hebrew · status=`extracted` · md_v=1
...
**Identity:** mti=429 · ti=640 · language=Greek · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: primarily the relaxing of a state of constraint; relaxation of rigor of confinement, Acts 24:23; metaphorically ease, rest, peace, relief, tranquility, 2Cor. 2:13; 7:5; 8:13; 2Thess. 1:7*

**Root family:**
- `ANE` (Greek): rest — Backfilled 2026-04-09 from wa_term_related_words clustering

**Related words (2 total; sample of 2):**
- `G0447` aniēmi "to loosen/leave"
- `G0447` aniēmi "to loosen/leave"
...
**Identity:** mti=422 · ti=633 · language=Greek · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: to live in peace, be at peace 
to be at peace, live at peace; to cultivate peace, concord, or harmony, Mt. 9:50; Rom. 12:18; 2Cor. 13:11; 1Thess. 5:13*

**Root family:**
- `EIRĒN` (Greek): peace — Backfilled 2026-04-09 from wa_term_related_words clustering
...
**Identity:** mti=426 · ti=637 · language=Greek · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: peace, harmony, tranquility; 
peace, Lk. 14:32; Acts 12:20; tranquillity, safety, welfare, health; often with an emphasis on lack of strife or reconciliation in a relation, as when one has "peace with God." Often used as a verbal and written greeting. This word generally follows the meanings and usage of H8934; peace, Lk. 14:32; Acts 12:20; tranquillity, Lk. 11:21; Jn. 16:33; 1Thess. 5:3; concord, unity, love of peace, harmony Mt. 10:34; Lk. 12:51; meton. the author of peace, Eph. 2:14; from the Hebrew every kind of blessing and good, Lk. 1:79; 2:14, 29; metonymy a salutation expressive of good wishes, a benediction, blessing, Mt. 10:13
...
**Identity:** mti=427 · ti=638 · language=Greek · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: peace-loving, peaceable, peaceful, with a focus of having freedom from emotional worry and frustration 
...
**Identity:** mti=430 · ti=641 · language=Greek · status=`extracted_thin` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: to make peace, to cause reconciliation between two parties, as in Christ causing the believer’s peace with God reconcile 
...
**Identity:** mti=428 · ti=639 · language=Greek · status=`extracted` · md_v=1
...
**Root family:**
- `ERĒ` (Greek): quiet — Backfilled 2026-04-09 from wa_term_related_words clustering

**Related words (2 total; sample of 2):**
- `G2048` erēmos "deserted"
- `G2048` erēmos "deserted"
...
**Identity:** mti=424 · ti=635 · language=Greek · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: to be silent, have no objection; to rest; to lead a quiet life; to give up 
to be still, at rest; to live peaceably, be quiet, 1Thess. 4:11; to rest from labor, Lk. 23:56; to be silent or quiet, acquiesce, to desist from discussion, Lk. 14:4; Acts 11:18; 21:14*

**Root family:**
- `HĒSUCH` (Greek): quiet — Backfilled 2026-04-09 from wa_term_related_words clustering

**Related words (4 total; sample of 4):**
- `G2271` hēsuchia "quietness"
- `G2271` hēsuchia "quietness"
- `G2272` hēsuchios "quiet"
- `G2272` hēsuchios "quiet"
...
**Identity:** mti=2558 · ti=2696 · language=Greek · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: quietness, silence; settling down, lack of disturbance 
rest, quiet, tranquillity; a quiet, tranquil life, 2Thess. 3:12; silence, silent attention, Acts 22:2; 1Tim. 2:11, 12*
...
**Identity:** mti=2559 · ti=2697 · language=Greek · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: quiet, tranquil, peaceful, 1Tim. 2:2; 1Pet. 3:4*
...
**Identity:** mti=437 · ti=648 · language=Greek · status=`extracted_theological_anchor` · md_v=1
...
**Related words (76 total; sample of 30):**
- `G0005` abba "Abba"
- `G0005` abba "Abba"
- `G1682` elōi "Eloi"
- `G1682` elōi "Eloi"
...
- `H0410G` el "God"
- `H0410I` el "El [Elohe]"
- … and 15 more shown of 76 total

**LSJ:** _not parsed for this term (LSJ data is sparse — meaning work proceeds without it)._

### `G4601` — sigaō "be silent"

**Identity:** mti=425 · ti=636 · language=Greek · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: to be or become silent; (passive) to be hidden, concealed 
to be silent, keep silence, Lk. 9:36; 20:26; Acts 15:12f.; 1Cor. 14:28, 30, 34; Lk. 18:39; transitive to keep in silence, not to reveal, to conceal; passive to be concealed, not to be revealed, Rom. 16:25*

**Root family:**
- `SIG` (Greek): silence — Backfilled 2026-04-09 from wa_term_related_words clustering
...
**Identity:** mti=2560 · ti=2698 · language=Greek · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: silence, Acts 21:40; Rev. 8:1*
...
**Related words (2 total; sample of 2):**
- `G4601` sigaō "be silent"
- `G4623` siōpaō "be quiet"

**LSJ:** _not parsed for this term (LSJ data is sparse — meaning work proceeds without it)._

### `G4623` — siōpaō "be quiet"

**Identity:** mti=423 · ti=634 · language=Greek · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: to be quiet, remain silent; to be calm, not agitated 
to be silent, keep silence, hold one's peace, Mt. 20:31; 26:63; Mk. 3:4; 9:34; 10:48; 14:61; Lk. 19:40; Acts 18:9; σιωπῶν, silent, dumb, Lk. 1:20; metaphorically to be silent, still, hushed, calm, not agitated as the sea, Mk. 4:39*
...
### `G5392` — fimoō "to muzzle"

**Identity:** mti=431 · ti=642 · language=Greek · status=`extracted` · md_v=1

**Meaning parse** (parser v1.0.0, parsed 2026-03-25T12:52:31): 1 top senses · 0 stems · causative=False · domain_tags=False

Senses (top-level):
- `1`: to muzzle; to silence; (pass.) to be quiet
to muzzle, 1Tim. 5:18; metaphorically and by implication to silence, put to silence; passive to be silent, speechless, Mt. 22:12, 34; 1Pet. 2:15; Mk. 1:25; troponym passive to be hushed, as winds and waves, Mk. 4:39; Lk. 4:35*

**Root family:**
- `FIM` (Greek): to muzzle — Backfilled 2026-04-09 from wa_term_related_words clustering

**LSJ:** _not parsed for this term (LSJ data is sparse — meaning work proceeds without it)._

---

## E. XREF Terms [Unit 2] (6)

| strongs | translit | gloss | lang | OWNER registry | status | OWNER verse count |
|---|---|---|---|---|---|---:|
| `G1518` | eirēnopoios | peacemaker | G | 103 love | `extracted` | 1 |
| `H1288` | ba.rakh | to bless | H | 194 blessing | `extracted` | 249 |
| `H3070` | yir.eh | Provider [God] | H | 58 experience | `extracted_theological_anchor` | 0 |
| `H6664G` | tse.deq | righteousness | H | 98 justice | `extracted` | 110 |
| `H7067H` | qan.na | jealous | H | 56 envy | `extracted` | 5 |
| `H7599` | sha.an | to rest | H | 7 anxiety | `extracted` | 5 |
...
- **`2535-001`** — 1 relevant · 1 anchor verse(s) · dimension: `08 — Transformation` · cluster: `C17`
  - *Term names the relational orientation of Israel toward God — the shift from servile master to intimate husband naming the transformation of inner relationship*

### `H1293` — 2 groups

- **`410-001`** — 47 relevant · 2 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names divine blessing as the inner-dispositioned gift of God — the overflow of God's favour toward persons, bringing flourishing, peace, and life*
- **`410-002`** — 16 relevant · 1 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names the inner act of bestowing blessing — the patriarch, leader, or friend invoking divine favour upon another as an act of love, covenant, or relationship*

### `H1585` — 1 groups

- **`415-001`** — 1 relevant · 1 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Wellbeing expressed in greeting — the inner orientation of goodwill and wholeness directed toward another through formal invocation of peace*
  - notes: Revised during Dimension Review Phase B.5: characteristic-perspective rewrite. Old: Term names the formal salutation of peace — the invocation of wholeness and wellbeing at the opening of official correspondence

### `H1748` — 1 groups

- **`2602-001`** — 3 relevant · 1 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names the inner disposition of hushed stillness — silence as judgment's response or as the posture of patient waiting for divine salvation*

### `H1820` — 1 groups

- **`2601-001`** — 7 relevant · 1 anchor verse(s) · dimension: `02 — Emotion — Negative` · cluster: `C17`
  - *Term names the cessation or ruination of the inner person — the collapse of human dignity, prophetic undoing before holiness, or unceasing grief*

### `H1826A` — 1 groups

- **`2597-001`** — 9 relevant · 2 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names the inner state of stillness or its absence — being motionless before God in awe, patient waiting, or unceasing distress*

### `H1826H` — 1 groups

- **`2596-001`** — 15 relevant · 2 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names the inner act of becoming or keeping silent — the stilling of the self before God, in grief, in reverence, or in wise restraint*

### `H1827` — 1 groups

- **`2603-001`** — 3 relevant · 1 anchor verse(s) · dimension: `10 — Dependence / Creatureliness` · cluster: `C17`
  - *Term names the stillness from which the divine voice is heard — the profound inner and outer silence that attends divine self-disclosure*

### `H2010` — 1 groups

- **`2589-001`** — 1 relevant · 1 anchor verse(s) · dimension: `01 — Emotion — Positive` · cluster: `C17`
  - *Term names the granting of relief — a remission that brings rest and lightening of burden to those who receive it*

### `H2013` — 1 groups

- **`421-001`** — 8 relevant · 2 anchor verse(s) · dimension: `10 — Dependence / Creatureliness` · cluster: `C17`
  - *Term names the commanded inner silence — the hush of reverence, awe, or holy restraint before God or in the face of his coming*

### `H2790A` — 2 groups

- **`417-001`** — 6 relevant · 1 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names the inner devising of evil — the heart plotting harm or crafting schemes against another*
- **`417-002`** — 5 relevant · 1 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names the metaphorical plowing of iniquity — inner sin etched deeply into the heart or expressed as a pattern of moral cultivation*

### `H2790B` — 6 groups

- **`408-001`** — 6 relevant · 2 anchor verse(s) · dimension: `04 — Volition` · cluster: `C17`
  - *Term names the posture of inner restraint — holding silence in response to emotional provocation, injustice, or the desire to speak*
- **`408-002`** — 9 relevant · 2 anchor verse(s) · dimension: `10 — Dependence / Creatureliness` · cluster: `C17`
  - *Term names the receptive posture of silence — an inner orientation of attentive submission, readiness to hear or receive*
- **`408-003`** — 2 relevant · 1 anchor verse(s) · dimension: `03 — Cognition` · cluster: `C17`
  - *Term names the posture of wisdom — silence as an expression of inner discernment, understanding, or moral restraint*
- **`408-004`** — 6 relevant · 2 anchor verse(s) · dimension: `10 — Dependence / Creatureliness` · cluster: `C17`
  - *Term names the inner condition when an appeal is made for God not to be silent — the psalmist's existential need for divine responsiveness*
- **`408-005`** — 4 relevant · 2 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names God's own posture of silence or its breaking — divine inner restraint, patience, or deliberate withholding*
- **`408-006`** — 3 relevant · 1 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term applied to ethical-existential confrontation — the moral weight of remaining silent at a critical moment of injustice or crisis*

### `H2814` — 4 groups

- **`409-001`** — 4 relevant · 1 anchor verse(s) · dimension: `02 — Emotion — Negative` · cluster: `C17`
  - *Term names the inward suppression of speech under emotional or spiritual pressure, with deteriorating inner consequence*
- **`409-002`** — 3 relevant · 1 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names the moral dimension of silence — the choice to be silent or not at a moment of ethical weight*
- **`409-003`** — 4 relevant · 2 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names God's posture of silence and its breaking — divine restraint, patience, or resolve*
- **`409-004`** — 3 relevant · 1 anchor verse(s) · dimension: `04 — Volition` · cluster: `C17`
  - *Term names prophetic inner resolve — refusing silence in advocacy for God's purposes*
...
- **`2586-001`** — 3 relevant · 2 anchor verse(s) · dimension: `02 — Emotion — Negative` · cluster: `C17`
  - *Term names a state of existential restlessness — the absence of resting-place as the condition of the whole person, particularly in exile or distress*

### `H4496H` — 3 groups

- **`2585-001`** — 4 relevant · 1 anchor verse(s) · dimension: `01 — Emotion — Positive` · cluster: `C17`
  - *Term names the soul's own rest — the inner condition of peace, security, and settled orientation toward God*
- **`2585-002`** — 7 relevant · 2 anchor verse(s) · dimension: `01 — Emotion — Positive` · cluster: `C17`
  - *Term names the covenantal rest given by God to his people — a condition of settled security, peace, and inheritance promised and fulfilled*
- **`2585-003`** — 3 relevant · 1 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names an eschatological or divine resting-place — where God dwells, and the orientation of his own will and delight*

### `H4771` — 1 groups

- **`2593-001`** — 1 relevant · 1 anchor verse(s) · dimension: `01 — Emotion — Positive` · cluster: `C17`
  - *Term names rest as the condition of the soul that walks in the right way — an inner-being orientation of peace attained through faithful obedience*

### `H4774` — 1 groups

- **`2594-001`** — 1 relevant · 1 anchor verse(s) · dimension: `01 — Emotion — Positive` · cluster: `C17`
  - *Term names divine repose offered to the weary — the condition of inner rest available through God's provision*

### `H5117` — 6 groups

- **`419-001`** — 4 relevant · 1 anchor verse(s) · dimension: `08 — Transformation` · cluster: `C17`
  - *Term names the Spirit resting upon a person — divine inner-being impartation resulting in transformed capacities*
- **`419-002`** — 26 relevant · 2 anchor verse(s) · dimension: `01 — Emotion — Positive` · cluster: `C17`
  - *Term names God's gift of rest to his people — the settled condition of security, peace, and wholeness bestowed as covenant blessing*
- **`419-003`** — 10 relevant · 2 anchor verse(s) · dimension: `02 — Emotion — Negative` · cluster: `C17`
  - *Term names the inner restlessness or rest of the human person — the condition of the inner life in the absence or presence of peace*
- **`419-004`** — 6 relevant · 2 anchor verse(s) · dimension: `03 — Cognition` · cluster: `C17`
  - *Term names wisdom, anger, or another inner quality resting in a place within the person*
- **`419-005`** — 9 relevant · 2 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names God's own inner rest, restraint, satisfaction, or calm — the inner orientation of God expressed through this root*
- **`419-006`** — 3 relevant · 2 anchor verse(s) · dimension: `10 — Dependence / Creatureliness` · cluster: `C17`
  - *Term names the call or appeal not to be abandoned by God — the inner-being distress of one fearing divine withdrawal*

### `H5118` — 2 groups

- **`5118-001`** — 1 relevant · 1 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names the dwelling of God's presence as an inner-oriented rest-place, where his people find salvation and joy*
- **`5118-002`** — 1 relevant · 1 anchor verse(s) · dimension: `01 — Emotion — Positive` · cluster: `C17`
  - *Term names relief as a condition of the inner life freed from threat*

### `H5183A` — 1 groups

- **`2587-001`** — 5 relevant · 2 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names quietness as an inner-being condition of peace, receptivity to wisdom, and strength before God*

### `H5207` — 3 groups

- **`2584-001`** — 37 relevant · 1 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names the soothing/pleasing quality of sacrifice as a relational act — the inner-being dimension of worship as something God receives with pleasure, establishing a condition of divine acceptance*
- **`2584-002`** — 3 relevant · 2 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names God's inner response to the aroma — the explicit disclosure of God's heart orientation through the receiving or withholding of acceptance*
- **`2584-003`** — 3 relevant · 1 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names the misdirected inner-being act of worship — the offering of pleasing aroma to idols as an expression of unfaithful inner orientation*

### `H5251H` — 1 groups

- **`2521-001`** — 7 relevant · 2 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names a signal or banner that orients the inner life — the object to which hope, fear, or trust is directed, or from which the inner life flees in panic*
...
- **`439-001`** — 1 relevant · 1 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names the jealousy of God as a defining inner characteristic — God's exclusive passionate claim on his people's worship and loyalty*

### `H7280A` — 1 groups

- **`2591-001`** — 3 relevant · 1 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names God's disturbing/stirring power in creation — an expression of divine inner capacity and sovereignty*

### `H7280B` — 1 groups

- **`420-001`** — 3 relevant · 2 anchor verse(s) · dimension: `02 — Emotion — Negative` · cluster: `C17`
  - *Term names the rest or respite sought or denied — the inner-being condition of peace in exile, distress, or covenant promise*

### `H7282` — 1 groups

- **`2595-001`** — 1 relevant · 1 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names the restful inner posture of the peaceable person — the quality of quietness as a character orientation, in contrast to those who devise deceit*

### `H7600` — 2 groups

- **`413-001`** — 8 relevant · 2 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names the inner condition of complacent ease — the self-secure, untroubled disposition that produces contempt, moral blindness, or judgment*
- **`413-002`** — 1 relevant · 1 anchor verse(s) · dimension: `01 — Emotion — Positive` · cluster: `C17`
  - *Term names the divinely intended condition of secure quietness — the ease of God's people living in peace and safety as a condition of shalom*
...
- **`2577-001`** — 1 relevant · 1 anchor verse(s) · dimension: `01 — Emotion — Positive` · cluster: `C17`
  - *Term names the inner condition of ease and security — the state of the person wholly undisturbed, here in the context of unjust prosperity*

### `H7965G` — 4 groups

- **`2508-001`** — 19 relevant · 5 anchor verse(s) · dimension: `01 — Emotion — Positive` · cluster: `C17`
  - *Term names shalom as the inner condition of the whole person — peace, welfare, and wholeness experienced inwardly; the opposite of fear, distress, or restlessness; the condition of the God-oriented soul*
- **`2508-002`** — 24 relevant · 3 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names shalom as the covenantal peace between God and his people — given by God, grounded in covenant, expressed in blessing, and capable of being withdrawn or eternally confirmed*
- **`2508-003`** — 25 relevant · 2 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names shalom as the inner orientation of the person toward peace — as character, disposition, and telos; both its authentic pursuit and its false simulation*
- **`2508-004`** — 15 relevant · 3 anchor verse(s) · dimension: `11 — Divine-Human Correspondence` · cluster: `C17`
  - *Term names shalom as the peace that belongs to and proceeds from the messianic king — eschatological, comprehensive, embodied in his person and reign, and purchased through his suffering*

### `H7965H` — 1 groups

- **`406-001`** — 1 relevant · 1 anchor verse(s) · dimension: _NULL_ · cluster: _NULL_
  - *Term names shalom as the divine identity commemorated in the altar name YHWH-Shalom — God identified as peace in the altar built after the peace-theophany, sealing the inner peace given in divine encounter*

### `H7965I` — 2 groups

- **`2509-001`** — 13 relevant · 2 anchor verse(s) · dimension: _NULL_ · cluster: _NULL_
  - *Term names shalom as the comprehensive inner condition of welfare and well-being — the wholeness of the person as divinely given, sustained, or promised*
- **`2509-002`** — 4 relevant · 1 anchor verse(s) · dimension: _NULL_ · cluster: _NULL_
  - *Term names shalom as the falsely promised or self-deceived condition of welfare — the inner state wrongly claimed when judgment or correction is the reality*

### `H7965J` — 1 groups

- **`2510-001`** — 5 relevant · 1 anchor verse(s) · dimension: _NULL_ · cluster: _NULL_
  - *Term names shalom as the inner relational bond of close friendship — the bond of trust, loyalty, and mutual allegiance whose violation by the sha.lom-friend constitutes the deepest relational betrayal*

### `H7965K` — 1 groups

- **`2511-001`** — 1 relevant · 1 anchor verse(s) · dimension: _NULL_ · cluster: _NULL_
  - *Term names shalom as the substantive peace-blessing invoked in greeting — the comprehensive peace of the whole person called upon as the content of the greeting act*
...
- **`418-001`** — 5 relevant · 2 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names the inner condition of quietness, rest, and trust as the spiritual posture of the person before God — the condition from which strength and salvation flow*
- **`418-002`** — 4 relevant · 2 anchor verse(s) · dimension: `02 — Emotion — Negative` · cluster: `C17`
  - *Term names the inner restlessness of the wicked or troubled person — the inability to be quiet as an expression of inner moral or emotional disorder*
- **`418-003`** — 5 relevant · 2 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names the quiet of God — God's own inner posture of watchful stillness, or the breaking of it in response to his people's need or his own resolve*
- **`418-004`** — 9 relevant · 1 anchor verse(s) · dimension: `01 — Emotion — Positive` · cluster: `C17`
  - *Term names the promised rest of God's people — the condition of quiet and ease as covenant blessing, contrasted with restlessness under judgment*

### `H8253` — 1 groups

- **`2583-001`** — 1 relevant · 1 anchor verse(s) · dimension: `01 — Emotion — Positive` · cluster: `C17`
  - *Term names quietness as a condition of divinely bestowed peace — the character of a reign and its people under God's gift of rest*

### `G0425` — 1 groups

- **`429-001`** — 5 relevant · 1 anchor verse(s) · dimension: `02 — Emotion — Negative` · cluster: `C17`
  - *Term names relief from pressure or affliction — the inner-being experience of rest when burdens are lifted, or its absence when they persist*

### `G1514` — 1 groups

- **`422-001`** — 4 relevant · 1 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names the inner disposition and active practice of relational peace — the will directed toward harmony with others*

### `G1515` — 3 groups

- **`426-001`** — 14 relevant · 2 anchor verse(s) · dimension: `01 — Emotion — Positive` · cluster: `C17`
  - *Term names the inner-being peace given by God through Christ — the reconciled state before God and the interior experience of divine peace guarding the heart and mind*
- **`426-002`** — 35 relevant · 1 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names peace as apostolic blessing and greeting — the invocation of divine shalom upon persons in the community of Christ*
- **`426-003`** — 35 relevant · 2 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names peace as the eschatological and relational fruit of the kingdom — achieved by Christ, to be pursued in community and received as the Spirit's gift*

### `G1516` — 1 groups

- **`427-001`** — 2 relevant · 1 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names peaceableness as an inner character quality — the disposition of the trained person or the wisdom from above, producing righteous fruit*

### `G1517` — 1 groups

- **`430-001`** — 1 relevant · 1 anchor verse(s) · dimension: `06 — Relational Disposition` · cluster: `C17`
  - *Term names the act of making peace — Christ's reconciling work that restores the broken relationship between humanity and God*

### `G2263` — 1 groups

- **`428-001`** — 1 relevant · 1 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names peaceful quietude as an inner-being quality of life — the disposition of undisturbed, godly calm in social context*

### `G2270` — 1 groups

- **`424-001`** — 5 relevant · 2 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names the inner disposition of settling into quiet — the ceasing of noise, argument, or resistance, whether in reverence, acceptance, or godly aspiration*

### `G2271` — 1 groups

- **`2558-001`** — 4 relevant · 1 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names a disposition of quiet attentiveness or ordered restraint — the inner quality of settled quiet that enables learning, work, or worship*

### `G2272` — 1 groups

- **`2559-001`** — 2 relevant · 1 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names a gentle, quiet spirit as an inner-being quality — the disposition of settled peace within, precious in God's sight*
...
- **`425-001`** — 9 relevant · 1 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names the inner discipline of silence — the restraint of voice in reverence, receptiveness, or ordered worship*

### `G4602` — 1 groups

- **`2560-001`** — 2 relevant · 1 anchor verse(s) · dimension: `02 — Emotion — Negative` · cluster: `C17`
  - *Term names profound silence as an inner-being atmosphere — the hush of awe before a significant moment*

### `G4623` — 1 groups

- **`423-001`** — 11 relevant · 2 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names the inner state and act of silence — holding the voice still in the presence of power, shame, or reverence*

### `G5392` — 1 groups

- **`431-001`** — 8 relevant · 2 anchor verse(s) · dimension: `05 — Moral Character` · cluster: `C17`
  - *Term names the silencing of voice or argument — the constraint of expression, whether as shame, spiritual authority, or the witness of righteous action*
...
|---|---:|---|
| 34 covenant | 6 | `H7965H,H7965G,H7965I,H7965J,H7965K,H7965L` |
| 163 trust | 6 | `H7965H,H7965G,H7965I,H7965J,H7965K,H7965L` |
| 103 love | 4 | `G1514,G1515,G1516,G1517` |
| 213 listen | 2 | `H2790B,H2790A` |
| 7 anxiety | 1 | `H7600` |
| 56 envy | 1 | `H7067G` |
| 77 honesty | 1 | `H6664H` |
| 96 jealousy | 1 | `H7067G` |
| 98 justice | 1 | `H6664H` |
| 139 righteousness | 1 | `H6664H` |
| 181 zeal | 1 | `H7067G` |
| 194 blessing | 1 | `H1293` |
| 199 dominion | 1 | `H1180` |
...
| 67 goodness | Gal 5:22 |
| 73 guilt | Jer 17:1 |
| 76 holiness | Isa 30:15 |
| 78 hope | Jer 29:11 |
| 78 hope | Lam 3:26 |
| 78 hope | Psa 62:5 |
| 80 humility | 1Pe 3:4 |
| 86 impurity | Isa 6:5 |
| 93 intention | Isa 26:3 |
| 97 joy | Gal 5:22 |
| 100 knowledge | Isa 11:2 |
| 102 longing | Deu 28:65 |
| 103 love | Gal 5:22 |
| 103 love | Rom 1:7 |
| 107 meaning | 1Cor 14:28 |
| 111 mercy | Jam 3:17 |
| 112 mind | Jer 29:11 |
| 116 patience | Gal 5:22 |
| 120 perverseness | Pro 6:14 |
| 125 purity | Jam 3:17 |
| 135 repentance | Act 11:18 |
| 146 shame | Job 12:5 |
| 151 sorrow | Deu 28:65 |
| 151 sorrow | Isa 53:5 |
| 153 stubbornness | Deu 29:19 |
| 160 thought | Job 12:5 |
| 160 thought | Psa 35:20 |
| 163 trust | Isa 30:15 |
| 163 trust | Psa 4:8 |
| 167 unity | 1Ch 12:17 |
| 175 wonder | Isa 9:6 |
...
- **`VERSE_EVIDENCE_MINIMAL`** — Minimal biblical evidence for this term in the extraction. Does NOT mean the term is irrelevant — triggers research investigation per research_actions column. Investigation open until catalogue questions Q-COV-01..04 are addressed (M31).
...
### `H0136` — 0/187 classified · 0 anchor verse(s)

**Group `UNCLASSIFIED`** (187 verses)

- **Gen 15:2** (—) *target: Lord*
...
- **Isa 7:14** (—) *target: Lord*
  > Isa 7:14 Therefore the Lord himself will give you a sign . Behold , the virgin shall conceive and bear a son , and shall call his name Immanuel .
- **Isa 7:20** (—) *target: Lord*
...
- **Obd 1** (—) *target: Lord*
  > Obd 1 The vision of Obadiah . Thus says the Lord God concerning Edom : We have heard a report from the Lord , and a messenger has been sent among the nations : “ Rise up! Let us rise against her for battle !”
- **Mic 1:2** (—) *target: Lord*
...
### `H1180` — 1/1 classified · 1 anchor verse(s)

**Group `2535-001`** (1 verse — anchors: Hos 2:16)
...
### `H1293` — 63/64 classified · 3 anchor verse(s)

**Group `410-001`** (47 verses — anchors: Psa 133:3, Pro 10:22)

- **Psa 133:3** 🔵 (✓) *target: blessing*
...
- **2Sa 7:29** (✓) *target: blessing*
  > 2Sa 7:29 Now therefore may it please you to bless the house of your servant , so that it may continue forever before you . For you, O Lord God , have spoken , and with your blessing shall the house of your servant be blessed forever .”
- **2Ki 18:31** (✓) *target: peace*
...
**Group `410-002`** (16 verses — anchors: Gen 27:38)

- **Gen 27:38** 🔵 (✓) *target: blessing*
...
- **Judg 1:15** (✓) *target: blessing*
  > Judg 1:15 She said to him, “ Give me a blessing . Since you have given me the land of the Negeb , give me also springs of water .” And Caleb gave her the upper springs and the lower springs .
- **1Sa 25:27** (✓) *target: present*
  > 1Sa 25:27 And now let this present that your servant has brought to my lord be given to the young men who follow my lord .
- **1Sa 30:26** (✓) *target: present*
...
- **Obd 5** (—) *target: destroyed*
  > Obd 5 If thieves came to you, if plunderers came by night — how you have been destroyed !— would they not steal only enough for themselves? If grape gatherers came to you, would they not leave gleanings ?
- **Zep 1:11** (—) *target: are no*
  > Zep 1:11 Wail , O inhabitants of the Mortar ! For all the traders are no more; all who weigh out silver are cut off .

### `H1826A` — 9/9 classified · 2 anchor verse(s)

**Group `2597-001`** (9 verses — anchors: Job 30:27, Psa 37:7)

- **Job 30:27** 🔵 (✓) *target: still*
  > Job 30:27 My inward parts are in turmoil and never still ; days of affliction come to meet me.
- **Psa 37:7** 🔵 (✓) *target: still*
...
### `H1826H` — 15/15 classified · 2 anchor verse(s)

**Group `2596-001`** (15 verses — anchors: Psa 62:5, Psa 131:2)

- **Psa 62:5** 🔵 (✓) *target: silence*
  > Psa 62:5 For God alone , O my soul , wait in silence , for my hope is from him.
- **Psa 131:2** 🔵 (✓) *target: quieted*
...
- **Psa 107:29** (✓) *target: still*
  > Psa 107:29 He made the storm be still , and the waves of the sea were hushed .

### `H2010` — 1/1 classified · 1 anchor verse(s)

**Group `2589-001`** (1 verse — anchors: Est 2:18)

- **Est 2:18** 🔵 (✓) *target: taxes*
...
### `H2013` — 8/8 classified · 2 anchor verse(s)

**Group `421-001`** (8 verses — anchors: Hab 2:20, Zep 1:7)

- **Hab 2:20** 🔵 (✓) *target: silence*
  > Hab 2:20 But the Lord is in his holy temple ; let all the earth keep silence before him.”
- **Zep 1:7** 🔵 (✓) *target: silent*
  > Zep 1:7 Be silent before the Lord God ! For the day of the Lord is near ; the Lord has prepared a sacrifice and consecrated his guests .
- **Num 13:30** (✓) *target: quieted*
...
### `H2790B` — 30/43 classified · 10 anchor verse(s)

**Group `408-001`** (6 verses — anchors: 2Sa 13:20, Psa 32:3)

- **2Sa 13:20** 🔵 (✓) *target: peace*
...
**Group `408-003`** (2 verses — anchors: Pro 11:12)

- **Pro 11:12** 🔵 (✓) *target: silent*
  > Pro 11:12 Whoever belittles his neighbor lacks sense , but a man of understanding remains silent .
- **Pro 17:28** (✓) *target: silent*
  > Pro 17:28 Even a fool who keeps silent is considered wise ; when he closes his lips , he is deemed intelligent .

**Group `408-004`** (6 verses — anchors: Psa 28:1, Psa 39:12)

- **Psa 28:1** 🔵 (✓) *target: silent*
  > Of David . Psa 28:1 To you, O Lord , I call ; my rock , be not deaf to me, lest, if you be silent to me, I become like those who go down to the pit .
- **Psa 39:12** 🔵 (✓) *target: peace*
...
- **Psa 35:22** (✓) *target: silent*
  > Psa 35:22 You have seen , O Lord ; be not silent ! O Lord , be not far from me !
- **Psa 83:1** (✓) *target: peace*
  > A Song . A Psalm of Asaph . Psa 83:1 O God , do not keep silence ; do not hold your peace or be still , O God !
- **Psa 109:1** (✓) *target: silent*
  > To the choirmaster . A Psalm of David . Psa 109:1 Be not silent , O God of my praise !
- **Hab 1:13** (✓) *target: silent*
...
**Group `408-005`** (4 verses — anchors: Psa 50:21, Isa 42:14)

- **Psa 50:21** 🔵 (✓) *target: silent*
...
**Group `408-006`** (3 verses — anchors: Est 4:14)

- **Est 4:14** 🔵 (✓) *target: keep*
...
### `H2814` — 14/16 classified · 5 anchor verse(s)

**Group `409-001`** (4 verses — anchors: Psa 39:2)

- **Psa 39:2** 🔵 (✓) *target: peace*
  > Psa 39:2 I was mute and silent ; I held my peace to no avail , and my distress grew worse .
- **2Ki 2:3** (✓) *target: keep quiet*
...
- **Neh 8:11** (✓) *target: calmed*
  > Neh 8:11 So the Levites calmed all the people , saying , “Be quiet , for this day is holy ; do not be grieved .”

**Group `409-002`** (3 verses — anchors: 2Ki 7:9)

- **2Ki 7:9** 🔵 (✓) *target: silent*
...
- **Ecc 3:7** (✓) *target: keep silence*
  > Ecc 3:7 a time to tear , and a time to sew ; a time to keep silence , and a time to speak ;

**Group `409-003`** (4 verses — anchors: Isa 57:11, Isa 64:12)

- **Isa 57:11** 🔵 (✓) *target: peace*
...
- **Psa 28:1** (✓) *target: deaf*
  > Of David . Psa 28:1 To you, O Lord , I call ; my rock , be not deaf to me, lest, if you be silent to me, I become like those who go down to the pit .
- **Isa 62:6** (✓) *target: silent*
...
- **Psa 107:29** (—) *target: hushed*
  > Psa 107:29 He made the storm be still , and the waves of the sea were hushed .

### `H3071` — 0/0 classified · 0 anchor verse(s)

_No active verses._

### `H3072` — 0/0 classified · 0 anchor verse(s)

_No active verses._

### `H3073` — 0/0 classified · 0 anchor verse(s)

_No active verses._

### `H4494` — 3/6 classified · 2 anchor verse(s)

**Group `2586-001`** (3 verses — anchors: Deu 28:65, Lam 1:3)

- **Deu 28:65** 🔵 (✓) *target: resting place*
...
- **Isa 34:14** (—) *target: resting place*
...
### `H4496H` — 14/21 classified · 4 anchor verse(s)

**Group `2585-001`** (4 verses — anchors: Psa 116:7)

- **Psa 116:7** 🔵 (✓) *target: rest*
  > Psa 116:7 Return , O my soul , to your rest ; for the Lord has dealt bountifully with you .
- **2Sa 14:17** (✓) *target: rest*
...
- **Psa 95:11** (✓) *target: rest*
  > Psa 95:11 Therefore I swore in my wrath , “They shall not enter my rest .”
- **Isa 32:18** (✓) *target: resting places*
  > Isa 32:18 My people will abide in a peaceful habitation , in secure dwellings , and in quiet resting places .
- **Mic 2:10** (✓) *target: rest*
  > Mic 2:10 Arise and go , for this is no place to rest , because of uncleanness that destroys with a grievous destruction .

**Group `2585-003`** (3 verses — anchors: Psa 132:14)

- **Psa 132:14** 🔵 (✓) *target: resting place*
  > Psa 132:14 “ This is my resting place forever ; here I will dwell , for I have desired it .
- **1Ch 22:9** (✓) *target: rest*
  > 1Ch 22:9 Behold , a son shall be born to you who shall be a man of rest . I will give him rest from all his surrounding enemies . For his name shall be Solomon , and I will give peace and quiet to Israel in his days .
- **Isa 11:10** (✓) *target: resting place*
...
**Group `UNCLASSIFIED`** (7 verses)

- **Gen 49:15** (—) *target: resting place*
...
- **Num 10:33** (—) *target: resting place*
...
- **Jer 51:59** (—) *target: quartermaster*
...
### `H4771` — 1/1 classified · 1 anchor verse(s)

**Group `2593-001`** (1 verse — anchors: Jer 6:16)

- **Jer 6:16** 🔵 (✓) *target: rest*
...
### `H4774` — 1/1 classified · 1 anchor verse(s)

**Group `2594-001`** (1 verse — anchors: Isa 28:12)

- **Isa 28:12** 🔵 (✓) *target: repose*
  > Isa 28:12 to whom he has said , “ This is rest ; give rest to the weary ; and this is repose ”; yet they would not hear .

### `H5117` — 58/140 classified · 11 anchor verse(s)

**Group `419-001`** (4 verses — anchors: Isa 11:2)

- **Isa 11:2** 🔵 (✓) *target: rest*
...
**Group `419-002`** (26 verses — anchors: Exo 33:14, Isa 14:3)

- **Exo 33:14** 🔵 (✓) *target: rest*
  > Exo 33:14 And he said , “My presence will go with you, and I will give you rest .”
- **Isa 14:3** 🔵 (✓) *target: rest*
...
- **1Ch 22:9** (✓) *target: rest*
  > 1Ch 22:9 Behold , a son shall be born to you who shall be a man of rest . I will give him rest from all his surrounding enemies . For his name shall be Solomon , and I will give peace and quiet to Israel in his days .
- **1Ch 22:18** (✓) *target: given you peace*
  > 1Ch 22:18 “Is not the Lord your God with you? And has he not given you peace on every side ? For he has delivered the inhabitants of the land into my hand , and the land is subdued before the Lord and his people .
- **1Ch 23:25** (✓) *target: rest*
  > 1Ch 23:25 For David said , “The Lord , the God of Israel , has given rest to his people , and he dwells in Jerusalem forever .
- **2Ch 14:6** (✓) *target: peace*
...
- **2Ch 14:7** (✓) *target: given us peace*
...
- **2Ch 15:15** (✓) *target: gave them rest*
...
**Group `419-003`** (10 verses — anchors: Job 3:26, Hab 3:16)

- **Job 3:26** 🔵 (✓) *target: rest*
  > Job 3:26 I am not at ease , nor am I quiet ; I have no rest , but trouble comes .”
- **Hab 3:16** 🔵 (✓) *target: quietly wait*
...
**Group `419-005`** (9 verses — anchors: Exo 20:11, Eze 16:42)

- **Exo 20:11** 🔵 (✓) *target: rested*
...
- **Eze 44:30** (✓) *target: rest*
  > Eze 44:30 And the first of all the firstfruits of all kinds, and every offering of all kinds from all your offerings , shall belong to the priests . You shall also give to the priests the first of your dough , that a blessing may rest on your house .
- **Hos 4:17** (✓) *target: alone*
...
**Group `419-006`** (3 verses — anchors: Psa 119:121, Jer 14:9)

- **Psa 119:121** 🔵 (✓) *target: leave*
  > Ayin Psa 119:121 I have done what is just and right ; do not leave me to my oppressors .
- **Jer 14:9** 🔵 (✓) *target: leave*
...
- **Isa 28:2** (—) *target: casts down*
  > Isa 28:2 Behold , the Lord has one who is mighty and strong ; like a storm of hail , a destroying tempest , like a storm of mighty , overflowing waters , he casts down to the earth with his hand .
- **Isa 28:12** (—) *target: rest*
  > Isa 28:12 to whom he has said , “ This is rest ; give rest to the weary ; and this is repose ”; yet they would not hear .
- **Isa 30:32** (—) *target: lays*
...
- **Isa 65:15** (—) *target: leave*
  > Isa 65:15 You shall leave your name to my chosen for a curse , and the Lord God will put you to death , but his servants he will call by another name ,
- **Jer 27:11** (—) *target: leave*
...
- **Eze 41:9** (—) *target: free space*
  > Eze 41:9 The thickness of the outer wall of the side chambers was five cubits . The free space between the side chambers of the temple
- **Eze 41:11** (—) *target: free space*
...
### `H5118` — 2/2 classified · 2 anchor verse(s)

**Group `5118-001`** (1 verse — anchors: 2Ch 6:41)

- **2Ch 6:41** 🔵 (✓) *target: resting place*
...
**Group `5118-002`** (1 verse — anchors: Est 9:16)

- **Est 9:16** 🔵 (✓) *target: got relief*
...
### `H5207` — 43/43 classified · 4 anchor verse(s)

**Group `2584-001`** (37 verses — anchors: Lev 1:9)

- **Lev 1:9** 🔵 (✓) *target: pleasing*
...
**Group `2584-002`** (3 verses — anchors: Gen 8:21, Eze 20:41)

- **Gen 8:21** 🔵 (✓) *target: pleasing*
...
**Group `2584-003`** (3 verses — anchors: Eze 6:13)

- **Eze 6:13** 🔵 (✓) *target: pleasing*
...
### `H5251H` — 7/20 classified · 2 anchor verse(s)

**Group `2521-001`** (7 verses — anchors: Psa 60:4, Isa 11:10)

- **Psa 60:4** 🔵 (✓) *target: banner*
  > Psa 60:4 You have set up a banner for those who fear you, that they may flee to it from the bow . Selah
- **Isa 11:10** 🔵 (✓) *target: signal*
  > Isa 11:10 In that day the root of Jesse , who shall stand as a signal for the peoples —of him shall the nations inquire , and his resting place shall be glorious .
- **Num 21:8** (✓) *target: pole*
...
- **Isa 49:22** (—) *target: signal*
  > Isa 49:22 Thus says the Lord God : “ Behold , I will lift up my hand to the nations , and raise my signal to the peoples ; and they shall bring your sons in their arms , and your daughters shall be carried on their shoulders .
- **Isa 62:10** (—) *target: signal over*
...
- **Gen 49:26** (—) *target: everlasting*
  > Gen 49:26 The blessings of your father are mighty beyond the blessings of my parents , up to the bounties of the everlasting hills . May they be on the head of Joseph , and on the brow of him who was set apart from his brothers .
- **Exo 3:15** (—) *target: forever*
...
- **Exo 15:18** (—) *target: forever*
  > Exo 15:18 The Lord will reign forever and ever .”
- **Exo 19:9** (—) *target: forever*
...
- **Exo 31:17** (—) *target: forever*
  > Exo 31:17 It is a sign forever between me and the people of Israel that in six days the Lord made the heavens and the earth , and on the seventh day he rested and was refreshed .’”
- **Exo 32:13** (—) *target: forever*
...
- **2Sa 7:29** (—) *target: forever*
  > 2Sa 7:29 Now therefore may it please you to bless the house of your servant , so that it may continue forever before you . For you, O Lord God , have spoken , and with your blessing shall the house of your servant be blessed forever .”
- **2Sa 12:10** (—) *target: never*
...
- **1Ch 22:10** (—) *target: forever*
  > 1Ch 22:10 He shall build a house for my name . He shall be my son , and I will be his father , and I will establish his royal throne in Israel forever .’
- **1Ch 23:13** (—) *target: forever*
...
- **1Ch 23:25** (—) *target: forever*
  > 1Ch 23:25 For David said , “The Lord , the God of Israel , has given rest to his people , and he dwells in Jerusalem forever .
- **1Ch 28:4** (—) *target: forever*
...
- **Neh 9:5** (—) *target: everlasting*
  > Neh 9:5 Then the Levites , Jeshua , Kadmiel , Bani , Hashabneiah , Sherebiah , Hodiah , Shebaniah , and Pethahiah , said , “Stand up and bless the Lord your God from everlasting to everlasting . Blessed be your glorious name , which is exalted above all blessing and praise .
- **Neh 13:1** (—) *target: ever*
...
- **Psa 41:12** (—) *target: forever*
  > Psa 41:12 But you have upheld me because of my integrity , and set me in your presence forever .
- **Psa 41:13** (—) *target: everlasting*
  > Psa 41:13 Blessed be the Lord , the God of Israel , from everlasting to everlasting ! Amen and Amen . Book Two
- **Psa 44:8** (—) *target: forever*
  > Psa 44:8 In God we have boasted continually , and we will give thanks to your name forever . Selah
- **Psa 45:2** (—) *target: forever*
...
- **Ecc 3:14** (—) *target: endures forever*
...
- **Joe 3:20** (—) *target: forever*
  > Joe 3:20 But Judah shall be inhabited forever , and Jerusalem to all generations .
- **Obd 10** (—) *target: forever*
  > Obd 10 Because of the violence done to your brother Jacob , shame shall cover you, and you shall be cut off forever .
- **Jon 2:6** (—) *target: forever*
  > Jon 2:6 To the roots of the mountains I went down, to the land whose bars closed upon me forever . Yet you brought up my life from the pit , O Lord my God .
- **Mic 2:9** (—) *target: forever*
...
- **2Ch 33:3** (—) *target: host*
  > 2Ch 33:3 For he rebuilt the high places that his father Hezekiah had broken down , and he erected altars to the Baals , and made Asheroth , and worshiped all the host of heaven and served them .
- **2Ch 33:5** (—) *target: host*
  > 2Ch 33:5 And he built altars for all the host of heaven in the two courts of the house of the Lord .
- **2Ch 33:11** (—) *target: army*
...
### `H6635B` — 0/156 classified · 0 anchor verse(s)

**Group `UNCLASSIFIED`** (156 verses)

- **1Sa 1:3** (—) *target: hosts*
...
- **2Sa 7:26** (—) *target: hosts*
  > 2Sa 7:26 And your name will be magnified forever , saying , ‘The Lord of hosts is God over Israel ,’ and the house of your servant David will be established before you.
- **2Sa 7:27** (—) *target: hosts*
...
- **Isa 3:15** (—) *target: hosts*
  > Isa 3:15 What do you mean by crushing my people , by grinding the face of the poor ?” declares the Lord God of hosts .
- **Isa 5:7** (—) *target: hosts*
...
- **Isa 10:23** (—) *target: hosts*
  > Isa 10:23 For the Lord God of hosts will make a full end , as decreed , in the midst of all the earth .
- **Isa 10:24** (—) *target: hosts*
  > Isa 10:24 Therefore thus says the Lord God of hosts : “O my people , who dwell in Zion , be not afraid of the Assyrians when they strike with the rod and lift up their staff against you as the Egyptians did.
- **Isa 10:26** (—) *target: hosts*
...
- **Isa 21:10** (—) *target: hosts*
  > Isa 21:10 O my threshed and winnowed one , what I have heard from the Lord of hosts , the God of Israel , I announce to you .
- **Isa 22:5** (—) *target: hosts*
  > Isa 22:5 For the Lord God of hosts has a day of tumult and trampling and confusion in the valley of vision , a battering down of walls and a shouting to the mountains .
- **Isa 22:12** (—) *target: hosts*
  > Isa 22:12 In that day the Lord God of hosts called for weeping and mourning , for baldness and wearing sackcloth ;
- **Isa 22:14** (—) *target: hosts*
  > Isa 22:14 The Lord of hosts has revealed himself in my ears : “Surely this iniquity will not be atoned for you until you die ,” says the Lord God of hosts .
- **Isa 22:15** (—) *target: hosts*
  > Isa 22:15 Thus says the Lord God of hosts , “ Come , go to this steward , to Shebna , who is over the household , and say to him:
- **Isa 22:25** (—) *target: hosts*
...
- **Isa 37:16** (—) *target: hosts*
  > Isa 37:16 “O Lord of hosts , God of Israel , enthroned above the cherubim , you are the God , you alone , of all the kingdoms of the earth ; you have made the heavens and the earth .
- **Isa 37:32** (—) *target: hosts*
...
- **Amo 9:5** (—) *target: hosts*
  > Amo 9:5 The Lord God of hosts , he who touches the earth and it melts , and all who dwell in it mourn , and all of it rises like the Nile , and sinks again, like the Nile of Egypt ;
- **Mic 4:4** (—) *target: hosts*
...
- **Zep 2:9** (—) *target: hosts*
  > Zep 2:9 Therefore , as I live ,” declares the Lord of hosts , the God of Israel , “ Moab shall become like Sodom , and the Ammonites like Gomorrah , a land possessed by nettles and salt pits , and a waste forever . The remnant of my people shall plunder them, and the survivors of my nation shall possess them .”
- **Zep 2:10** (—) *target: hosts*
...
- **Zec 8:18** (—) *target: hosts*
  > Zec 8:18 And the word of the Lord of hosts came to me, saying ,

### `H6664H` — 0/2 classified · 0 anchor verse(s)

**Group `UNCLASSIFIED`** (2 verses)

- **Jer 23:6** (—) *target: righteousness*
...
- **Jer 33:16** (—) *target: righteousness*
...
### `H7067G` — 1/1 classified · 1 anchor verse(s)

**Group `439-001`** (1 verse — anchors: Exo 34:14)

- **Exo 34:14** 🔵 (✓) *target: Jealous*
  > Exo 34:14 ( for you shall worship no other god , for the Lord , whose name is Jealous , is a jealous God ),

### `H7280A` — 3/6 classified · 1 anchor verse(s)

**Group `2591-001`** (3 verses — anchors: Isa 51:15)

- **Isa 51:15** 🔵 (✓) *target: stirs up*
  > Isa 51:15 I am the Lord your God , who stirs up the sea so that its waves roar — the Lord of hosts is his name .
- **Job 26:12** (✓) *target: stilled*
  > Job 26:12 By his power he stilled the sea ; by his understanding he shattered Rahab .
- **Jer 31:35** (✓) *target: stirs up*
...
### `H7280B` — 3/6 classified · 2 anchor verse(s)

**Group `420-001`** (3 verses — anchors: Deu 28:65, Jer 31:2)

- **Deu 28:65** 🔵 (✓) *target: respite*
  > Deu 28:65 And among these nations you shall find no respite , and there shall be no resting place for the sole of your foot , but the Lord will give you there a trembling heart and failing eyes and a languishing soul .
- **Jer 31:2** 🔵 (✓) *target: rest*
  > Jer 31:2 Thus says the Lord : “The people who survived the sword found grace in the wilderness ; when Israel sought for rest ,
- **Jer 50:34** (✓) *target: rest*
...
- **Jer 47:6** (—) *target: rest*
  > Jer 47:6 Ah , sword of the Lord ! How long till you are quiet ? Put yourself into your scabbard ; rest and be still !

### `H7282` — 1/1 classified · 1 anchor verse(s)

**Group `2595-001`** (1 verse — anchors: Psa 35:20)

- **Psa 35:20** 🔵 (✓) *target: quiet*
  > Psa 35:20 For they do not speak peace , but against those who are quiet in the land they devise words of deceit .

### `H7600` — 9/10 classified · 3 anchor verse(s)

**Group `413-001`** (8 verses — anchors: Job 12:5, Amo 6:1)

- **Job 12:5** 🔵 (✓) *target: ease*
...
**Group `413-002`** (1 verse — anchors: Isa 32:18)

- **Isa 32:18** 🔵 (✓) *target: quiet*
  > Isa 32:18 My people will abide in a peaceful habitation , in secure dwellings , and in quiet resting places .

**Group `UNCLASSIFIED`** (1 verse)

- **Isa 33:20** (—) *target: untroubled*
...
### `H7706` — 0/48 classified · 0 anchor verse(s)

**Group `UNCLASSIFIED`** (48 verses)

- **Gen 17:1** (—) *target: Almighty*
...
- **Job 32:8** (—) *target: Almighty*
  > Job 32:8 But it is the spirit in man , the breath of the Almighty , that makes him understand.
- **Job 33:4** (—) *target: Almighty*
  > Job 33:4 The Spirit of God has made me, and the breath of the Almighty gives me life .
- **Job 34:10** (—) *target: Almighty*
...
- **Joe 1:15** (—) *target: Almighty*
  > Joe 1:15 Alas for the day ! For the day of the Lord is near , and as destruction from the Almighty it comes .

### `H7946` — 1/1 classified · 1 anchor verse(s)

**Group `2577-001`** (1 verse — anchors: Job 21:23)

- **Job 21:23** 🔵 (✓) *target: ease*
  > Job 21:23 One dies in his full vigor , being wholly at ease and secure ,

### `H7965G` — 148/148 classified · 13 anchor verse(s)

**Group `2508-001`** (19 verses — anchors: Judg 6:23, Psa 4:8, Psa 119:165, Isa 26:3, Lam 3:17)

- **Judg 6:23** 🔵 (✓) *target: Peace*
  > Judg 6:23 But the Lord said to him, “ Peace be to you. Do not fear ; you shall not die .”
  - notes: Divine word at theophany — Peace be to you. Do not fear. Shalom directly counteracts inner terror in divine encounter.
- **Psa 4:8** 🔵 (✓) *target: peace*
  > Psa 4:8 In peace I will both lie down and sleep ; for you alone , O Lord , make me dwell in safety .
  - notes: In peace I will lie down and sleep — shalom as inner condition of rest and security grounded in trust in God alone.
- **Psa 119:165** 🔵 (✓) *target: peace*
  > Psa 119:165 Great peace have those who love your law ; nothing can make them stumble .
  - notes: Great peace have those who love your law; nothing can make them stumble. Shalom as the inner condition of those oriented toward God's word.
- **Isa 26:3** 🔵 (✓) *target: perfect*
  > Isa 26:3 You keep him in perfect peace whose mind is stayed on you, because he trusts in you.
  - notes: Perfect peace (shalom shalom) for the one whose mind is stayed on God because he trusts — fullest statement of peace as inner condition produced by directed trust.
- **Lam 3:17** 🔵 (✓) *target: peace*
  > Lam 3:17 my soul is bereft of peace ; I have forgotten what happiness is;
  - notes: My soul is bereft of peace — most direct statement of shalom as inner-being condition of the soul (nephesh).
- **Gen 43:23** (✓) *target: Peace*
  ...
  - notes: Peace to you, do not be afraid — shalom blessing directly paired with call not to fear; addresses inner condition of the brothers.
- **1Sa 1:17** (✓) *target: peace*
  > 1Sa 1:17 Then Eli answered , “ Go in peace , and the God of Israel grant your petition that you have made to him .”
  - notes: Go in peace after prayer — Hannah came in anguish, departs in peace after divine encounter; inner state changed.
- **Psa 37:11** (✓) *target: peace*
  > Psa 37:11 But the meek shall inherit the land and delight themselves in abundant peace .
  - notes: The meek shall delight in abundant peace — shalom as the inner condition of flourishing for the meek.
- **Pro 3:2** (✓) *target: peace*
  > Pro 3:2 for length of days and years of life and peace they will add to you .
  - notes: Length of days and peace as fruit of following wisdom — shalom as inner condition produced by wise living.
- **Pro 3:17** (✓) *target: peace*
  > Pro 3:17 Her ways are ways of pleasantness , and all her paths are peace .
  - notes: All wisdom's paths are peace — shalom as the characteristic of the way of wisdom.
- **Song 8:10** (✓) *target: peace*
  > Song 8:10 I was a wall , and my breasts were like towers ; then I was in his eyes as one who finds peace .
  - notes: One who finds peace in the beloved's eyes — shalom as the inner condition of acceptance and wholeness in relationship.
- **Isa 48:18** (✓) *target: peace*
  ...
  - notes: Your peace would have been like a river — abundance of inner shalom as counterfactual fruit of obedience.
- **Isa 57:2** (✓) *target: peace*
  > Isa 57:2 he enters into peace ; they rest in their beds who walk in their uprightness .
  - notes: He enters into peace; those who walk uprightly rest in their beds — shalom as the final inner condition of the righteous.
- **Jer 8:15** (✓) *target: peace*
  > Jer 8:15 We looked for peace , but no good came; for a time of healing , but behold , terror .
  - notes: We looked for peace but no good came — the inner-being longing for shalom unfulfilled.
- **Jer 12:12** (✓) *target: peace*
  ...
  - notes: No flesh has peace — universal absence of shalom under divine judgment.
- **Jer 14:19** (✓) *target: peace*
  ...
  - notes: We looked for peace — parallel to Jer 8:15, longing for shalom.
- **Jer 30:5** (✓) *target: peace*
  > Jer 30:5 “ Thus says the Lord : We have heard a cry of panic , of terror , and no peace .
  - notes: Cry of panic, terror, and no peace — absence of shalom as inner condition in distress.
- **Eze 7:25** (✓) *target: peace*
  > Eze 7:25 When anguish comes , they will seek peace , but there shall be none .
  - notes: When anguish comes they will seek peace but there shall be none — inner-being longing for shalom in distress.
- **Dan 10:19** (✓) *target: peace*
  ...
  - notes: Fear not, peace be with you; be strong and of good courage — angelic shalom addressing Daniel's inner terror.

**Group `2508-002`** (24 verses — anchors: Num 6:26, Psa 85:8, Isa 54:10)

- **Num 6:26** 🔵 (✓) *target: peace*
  > Num 6:26 the Lord lift up his countenance upon you and give you peace .
  - notes: Aaronic blessing — the Lord give you peace. Foundational covenant-gift of shalom within the triple divine blessing.
- **Psa 85:8** 🔵 (✓) *target: peace*
  ...
  - notes: God will speak peace to his people, to his saints — divine speech of covenantal peace conditioned on not turning back to folly.
- **Isa 54:10** 🔵 (✓) *target: peace*
  ...
  - notes: My covenant of peace shall not be removed — eternal unbreakable covenant of shalom.
- **Gen 28:21** (✓) *target: peace*
  > Gen 28:21 so that I come again to my father’s house in peace , then the Lord shall be my God ,
  - notes: Jacob's vow — return in peace tied to covenantal commitment ('the Lord shall be my God'). Shalom as the condition of the one under divine protection in covenant.
- **Lev 26:6** (✓) *target: peace*
  ...
  - notes: Covenant blessing — I will give peace in the land, none shall make you afraid. Shalom as God's gift producing freedom from inner fear.
- **Num 25:12** (✓) *target: peace*
  > Num 25:12 Therefore say , ‘ Behold , I give to him my covenant of peace ,
  - notes: Covenant of peace given to Phinehas — covenantal relational peace by divine declaration.
- **1Sa 20:42** (✓) *target: peace*
  > 1Sa 20:42 Then Jonathan said to David , “ Go in peace , because we have sworn both of us in the name of the Lord , saying , ‘The Lord shall be between me and you, and between my offspring and your offspring , forever .’” And he rose and departed , and Jonathan went into the city .
  - notes: Go in peace grounded in covenant oath sworn in the Lord's name — shalom of the covenantal friendship.
- **1Ki 2:33** (✓) *target: peace*
  > 1Ki 2:33 So shall their blood come back on the head of Joab and on the head of his descendants forever . But for David and for his descendants and for his house and for his throne there shall be peace from the Lord forevermore .”
  - notes: Peace from the Lord forevermore for David's house — covenantal peace with divine origin and eternal character.
- **1Ki 22:28** (✓) *target: peace*
  > 1Ki 22:28 And Micaiah said , “ If you return in peace , the Lord has not spoken by me.” And he said , “ Hear , all you peoples !”
  - notes: Prophetic sign — return in peace would disprove Micaiah's word; shalom as a condition bearing on prophetic truth and divine authority.
- **1Ch 12:18** (✓) *target: Peace*
  ...
  - notes: Triple shalom pronounced over David grounded in 'your God helps you' — peace of the one under divine help and favour.
- **1Ch 22:9** (✓) *target: peace*
  > 1Ch 22:9 Behold , a son shall be born to you who shall be a man of rest . I will give him rest from all his surrounding enemies . For his name shall be Solomon , and I will give peace and quiet to Israel in his days .
  - notes: God's promise: I will give peace and quiet to Israel in Solomon's days. Shalom + shaqat as divine double gift.
- **2Ch 18:27** (✓) *target: peace*
  > 2Ch 18:27 And Micaiah said , “ If you return in peace , the Lord has not spoken by me.” And he said , “ Hear , all you peoples !”
  - notes: Prophetic sign — parallel to 1Ki 22:28. Return in peace as test of prophetic truth.
- **Job 25:2** (✓) *target: peace*
  > Job 25:2 “ Dominion and fear are with God; he makes peace in his high heaven .
  - notes: God makes peace in his high heaven — divine sovereignty expressed as peace-making in the heavenly realm.
- **Psa 29:11** (✓) *target: peace*
  > Psa 29:11 May the Lord give strength to his people ! May the Lord bless his people with peace !
  - notes: May the Lord bless his people with peace — divine blessing of shalom.
- **Psa 122:6** (✓) *target: peace*
  > Psa 122:6 Pray for the peace of Jerusalem ! “May they be secure who love you !
  - notes: Pray for the peace of Jerusalem — shalom of the covenant city as the object of prayer and inner orientation.
- **Isa 26:12** (✓) *target: peace*
  > Isa 26:12 O Lord , you will ordain peace for us, for you have indeed done for us all our works .
  - notes: You will ordain peace for us — God ordaining shalom as divine gift.
- **Isa 27:5** (✓) *target: peace*
  > Isa 27:5 Or let them lay hold of my protection , let them make peace with me, let them make peace with me .”
  - notes: Let them make peace with me — relational act of reconciliation/covenant peace with God.
- **Isa 54:13** (✓) *target: peace*
  > Isa 54:13 All your children shall be taught by the Lord , and great shall be the peace of your children .
  - notes: Great shall be the peace of your children — shalom of the covenant community taught by God.
- **Isa 57:19** (✓) *target: Peace*
  > Isa 57:19 creating the fruit of the lips . Peace , peace , to the far and to the near ,” says the Lord , “and I will heal him .
  - notes: Peace, peace, to the far and to the near — God's comprehensive proclamation of covenantal shalom.
- **Jer 16:5** (✓) *target: peace*
  ...
  - notes: I have taken away my peace from this people — withdrawal of divine covenantal peace as judgment.
- **Eze 34:25** (✓) *target: peace*
  ...
  - notes: Covenant of peace with my people — God's covenant of peace in the eschatological/new covenant.
- **Eze 37:26** (✓) *target: peace*
  ...
  - notes: Everlasting covenant of peace — shalom as the permanent covenant condition.
- **Hag 2:9** (✓) *target: peace*
  > Hag 2:9 The latter glory of this house shall be greater than the former , says the Lord of hosts . And in this place I will give peace , declares the Lord of hosts .’”
  - notes: In this place I will give peace — God's gift of shalom in the temple, covenantal/eschatological.
- **Mal 2:5** (✓) *target: peace*
  ...
  - notes: Covenant of life and peace given to Levi — covenantal shalom as God's specific gift in priestly covenant.

**Group `2508-003`** (25 verses — anchors: Psa 120:7, Mal 2:6)

- **Psa 120:7** 🔵 (✓) *target: peace*
  > Psa 120:7 I am for peace , but when I speak , they are for war !
  - notes: I am for peace (ani shalom) — shalom as personal identity and fundamental disposition; most direct statement of peace as inner orientation.
- **Mal 2:6** 🔵 (✓) *target: peace*
  ...
  - notes: He walked with me in peace and uprightness — shalom as the character of Levi's life before God; the peaceful disposition of the faithful priest.
- **Gen 37:4** (✓) *target: peacefully*
  ...
  - notes: Brothers could not speak peaceably to Joseph — shalom names the relational-inner orientation of peace that hatred makes impossible.
- **2Ki 9:22** (✓) *target: peace*
  ...
  - notes: What peace can there be while Jezebel's whorings and sorceries continue — peace explicitly conditioned on moral/spiritual fidelity; moral corruption makes peace impossible.
- **Est 10:3** (✓) *target: peace*
  ...
  - notes: Mordecai sought the welfare (shalom) of his people and spoke peace to them — shalom as inner disposition of care expressed in leadership.
- **Psa 28:3** (✓) *target: peace*
  ...
  - notes: Speak peace with neighbors while evil is in their hearts — shalom as the false relational disposition; heart-evil contrasted with tongue-peace.
- **Psa 34:14** (✓) *target: peace*
  > Psa 34:14 Turn away from evil and do good ; seek peace and pursue it .
  - notes: Seek peace and pursue it — active pursuit of shalom as moral imperative.
- **Psa 35:20** (✓) *target: peace*
  > Psa 35:20 For they do not speak peace , but against those who are quiet in the land they devise words of deceit .
  - notes: They do not speak peace but device deceit against the quiet — shalom as the disposition absent in the wicked.
- **Psa 37:37** (✓) *target: peace*
  > Psa 37:37 Mark the blameless and behold the upright , for there is a future for the man of peace .
  - notes: The man of peace (ish shalom) has a future — shalom as personal character description.
- **Psa 120:6** (✓) *target: peace*
  > Psa 120:6 Too long have I had my dwelling among those who hate peace .
  - notes: Too long among those who hate peace — shalom as an orientation that can be hated.
- **Pro 12:20** (✓) *target: peace*
  > Pro 12:20 Deceit is in the heart of those who devise evil , but those who plan peace have joy .
  - notes: Those who plan peace have joy — shalom planning as heart-disposition producing joy; contrasted with evil in the heart.
- **Isa 32:17** (✓) *target: peace*
  > Isa 32:17 And the effect of righteousness will be peace , and the result of righteousness , quietness and trust forever .
  - notes: The effect of righteousness will be peace — shalom as fruit of righteous character orientation.
- **Isa 48:22** (✓) *target: peace*
  > Isa 48:22 “There is no peace ,” says the Lord , “ for the wicked .”
  - notes: There is no peace for the wicked — shalom impossible for those in moral disorder.
- **Isa 57:21** (✓) *target: peace*
  > Isa 57:21 There is no peace ,” says my God , “ for the wicked .”
  - notes: No peace for the wicked — parallel to 48:22.
- **Isa 59:8** (✓) *target: peace*
  ...
  - notes: The way of peace they do not know — peace as a way of life unknown to those in moral disorder.
- **Jer 6:14** (✓) *target: Peace*
  > Jer 6:14 They have healed the wound of my people lightly , saying , ‘ Peace , peace ,’ when there is no peace .
  - notes: Crying Peace, peace when there is no peace — moral violation of false peace proclamation.
- **Jer 8:11** (✓) *target: Peace*
  > Jer 8:11 They have healed the wound of my people lightly , saying , ‘ Peace , peace ,’ when there is no peace .
  - notes: Parallel to Jer 6:14 — false peace proclamation.
- **Jer 9:8** (✓) *target: peace*
  ...
  - notes: Speaks peace with mouth but plans ambush in heart — parallel to Psa 28:3, heart contrasted with tongue.
- **Jer 14:13** (✓) *target: peace*
  > Jer 14:13 Then I said : “ Ah , Lord God , behold , the prophets say to them, ‘You shall not see the sword , nor shall you have famine , but I will give you assured peace in this place .’”
  - notes: False prophets promising assured peace — false peace promise.
- **Jer 28:9** (✓) *target: peace*
  ...
  - notes: The prophet who prophesies peace — the prophetic test of peace proclamation; truth demonstrated by fulfilment.
- **Eze 13:10** (✓) *target: Peace*
  ...
  - notes: Saying Peace when there is no peace — false prophets; moral corruption of the peace proclamation.
- **Eze 13:16** (✓) *target: peace*
  ...
  - notes: Saw visions of peace for her when there was no peace — false prophetic visions.
- **Mic 3:5** (✓) *target: Peace*
  ...
  - notes: Prophets cry Peace for payment — moral corruption of the peace proclamation for gain.
- **Zec 8:16** (✓) *target: peace*
  ...
  - notes: Render judgments that make for peace — peace as the telos of just governance, requiring intentional orientation.
- **Zec 8:19** (✓) *target: peace*
  ...
  - notes: Love truth and peace — shalom as the object of love, a disposition of the heart.

**Group `2508-004`** (15 verses — anchors: Isa 9:6, Isa 53:5, Mic 5:5)

- **Isa 9:6** 🔵 (✓) *target: Peace*
  > Isa 9:6 For to us a child is born , to us a son is given ; and the government shall be upon his shoulder , and his name shall be called Wonderful Counselor , Mighty God , Everlasting Father , Prince of Peace .
  - notes: Prince of Peace — shalom as the messianic king's title and identity.
- **Isa 53:5** 🔵 (✓) *target: peace*
  ...
  - notes: Upon him was the chastisement that brought us peace — vicarious purchase of shalom through the Servant's suffering.
- **Mic 5:5** 🔵 (✓) *target: peace*
  ...
  - notes: He shall be their peace — messianic ruler as shalom personified.
- **Psa 72:7** (✓) *target: peace*
  > Psa 72:7 In his days may the righteous flourish , and peace abound , till the moon be no more !
  - notes: Peace abound till the moon be no more — eschatological peace abounding in the messianic reign.
- **Psa 85:10** (✓) *target: peace*
  > Psa 85:10 Steadfast love and faithfulness meet ; righteousness and peace kiss each other.
  - notes: Righteousness and peace kiss each other — cosmic convergence of shalom and righteousness in the eschatological vision.
- **Isa 9:7** (✓) *target: peace*
  > Isa 9:7 Of the increase of his government and of peace there will be no end , on the throne of David and over his kingdom , to establish it and to uphold it with justice and with righteousness from this time forth and forevermore . The zeal of the Lord of hosts will do this .
  - notes: Of the increase of his government and peace there will be no end — endless shalom of the messianic reign.
- **Isa 32:18** (✓) *target: peaceful*
  > Isa 32:18 My people will abide in a peaceful habitation , in secure dwellings , and in quiet resting places .
  - notes: My people will abide in a peaceful habitation — eschatological condition of God's people at rest.
- **Isa 52:7** (✓) *target: peace*
  ...
  - notes: Herald bringing good news who publishes peace — shalom as content of the gospel announcement.
- **Isa 55:12** (✓) *target: peace*
  ...
  - notes: Go out in joy and be led forth in peace — restoration as condition of inner peace.
- **Isa 60:17** (✓) *target: peace*
  ...
  - notes: I will make your overseers peace — peace as the governing principle of the restored community.
- **Isa 66:12** (✓) *target: peace*
  ...
  - notes: I will extend peace like a river — overflowing eschatological peace.
- **Nah 1:15** (✓) *target: peace*
  ...
  - notes: Herald who publishes peace — parallel to Isa 52:7, messianic proclamation.
- **Zec 6:13** (✓) *target: peace*
  ...
  - notes: Counsel of peace between messianic priest-king — peace characterising messianic governance.
- **Zec 8:12** (✓) *target: peace*
  ...
  - notes: There shall be a sowing of peace — peace as the condition of the restored eschatological era.
- **Zec 9:10** (✓) *target: peace*
  ...
  - notes: The messianic king shall speak peace to the nations — universal messianic proclamation.

**Group `SET-ASIDE`** (65 verses)

- **Gen 15:15** (✗) [set_aside: no_inner_being] *target: peace*
  > Gen 15:15 As for you , you shall go to your fathers in peace ; you shall be buried in a good old age .
- **Gen 26:29** (✗) [set_aside: no_inner_being] *target: peace*
...
- **Gen 26:31** (✗) [set_aside: no_inner_being] *target: peace*
...
- **Gen 41:16** (✗) [set_aside: no_inner_being] *target: favorable*
  > Gen 41:16 Joseph answered Pharaoh , “It is not in me ; God will give Pharaoh a favorable answer .”
- **Gen 44:17** (✗) [set_aside: no_inner_being] *target: peace*
...
- **Exo 4:18** (✗) [set_aside: no_inner_being] *target: peace*
...
- **Exo 18:23** (✗) [set_aside: no_inner_being] *target: peace*
...
- **Deu 23:6** (✗) [set_aside: no_inner_being] *target: peace*
  > Deu 23:6 You shall not seek their peace or their prosperity all your days forever .
- **Jos 9:15** (✗) [set_aside: no_inner_being] *target: peace*
...
- **Judg 4:17** (✗) [set_aside: no_inner_being] *target: peace*
...
- **Judg 8:9** (✗) [set_aside: no_inner_being] *target: peace*
  > Judg 8:9 And he said to the men of Penuel , “ When I come again in peace , I will break down this tower .”
- **Judg 11:13** (✗) [set_aside: no_inner_being] *target: peaceably*
...
- **Judg 11:31** (✗) [set_aside: no_inner_being] *target: peace*
...
- **1Sa 7:14** (✗) [set_aside: no_inner_being] *target: peace*
...
- **1Sa 16:4** (✗) [set_aside: no_inner_being] *target: peaceably*
...
- **1Sa 16:5** (✗) [set_aside: no_inner_being] *target: Peaceably*
...
- **1Sa 25:35** (✗) [set_aside: no_inner_being] *target: peace*
...
- **1Sa 29:7** (✗) [set_aside: no_inner_being] *target: peaceably*
  > 1Sa 29:7 So go back now ; and go peaceably , that you may not displease the lords of the Philistines .”
- **2Sa 3:21** (✗) [set_aside: no_inner_being] *target: peace*
...
- **2Sa 3:22** (✗) [set_aside: no_inner_being] *target: peace*
...
- **2Sa 3:23** (✗) [set_aside: no_inner_being] *target: peace*
  > 2Sa 3:23 When Joab and all the army that was with him came , it was told Joab , “ Abner the son of Ner came to the king , and he has let him go , and he has gone in peace .”
- **2Sa 15:9** (✗) [set_aside: no_inner_being] *target: peace*
  > 2Sa 15:9 The king said to him, “ Go in peace .” So he arose and went to Hebron .
- **2Sa 15:27** (✗) [set_aside: no_inner_being] *target: peace*
...
- **2Sa 17:3** (✗) [set_aside: no_inner_being] *target: peace*
...
- **1Ki 2:5** (✗) [set_aside: no_inner_being] *target: peace*
  > 1Ki 2:5 “Moreover, you also know what Joab the son of Zeruiah did to me, how he dealt with the two commanders of the armies of Israel , Abner the son of Ner , and Amasa the son of Jether , whom he killed , avenging in time of peace for blood that had been shed in war , and putting the blood of war on the belt around his waist and on the sandals on his feet .
- **1Ki 2:6** (✗) [set_aside: no_inner_being] *target: peace*
  > 1Ki 2:6 Act therefore according to your wisdom , but do not let his gray head go down to Sheol in peace .
- **1Ki 2:13** (✗) [set_aside: no_inner_being] *target: peacefully*
...
- **1Ki 4:24** (✗) [set_aside: no_inner_being] *target: peace*
...
- **1Ki 5:12** (✗) [set_aside: no_inner_being] *target: peace*
...
- **1Ki 22:27** (✗) [set_aside: no_inner_being] *target: peace*
...
- **2Ki 5:19** (✗) [set_aside: no_inner_being] *target: peace*
  > 2Ki 5:19 He said to him, “ Go in peace .” But when Naaman had gone from him a short distance ,
- **2Ki 9:17** (✗) [set_aside: no_inner_being] *target: peace*
...
- **2Ki 9:18** (✗) [set_aside: no_inner_being] *target: peace*
...
- **2Ki 9:19** (✗) [set_aside: no_inner_being] *target: peace*
...
- **2Ki 9:31** (✗) [set_aside: no_inner_being] *target: peace*
  > 2Ki 9:31 And as Jehu entered the gate , she said , “Is it peace , you Zimri , murderer of your master ?”
- **2Ki 20:19** (✗) [set_aside: no_inner_being] *target: peace*
  > 2Ki 20:19 Then Hezekiah said to Isaiah , “The word of the Lord that you have spoken is good .” For he thought , “Why not , if there will be peace and security in my days ?”
- **2Ki 22:20** (✗) [set_aside: no_inner_being] *target: peace*
...
- **2Ch 15:5** (✗) [set_aside: no_inner_being] *target: peace*
...
- **2Ch 18:16** (✗) [set_aside: no_inner_being] *target: peace*
...
- **2Ch 18:26** (✗) [set_aside: no_inner_being] *target: peace*
...
- **2Ch 34:28** (✗) [set_aside: no_inner_being] *target: peace*
...
- **Jer 25:37** (✗) [set_aside: no_inner_being] *target: peaceful*
  > Jer 25:37 and the peaceful folds are devastated because of the fierce anger of the Lord .
- **Jer 34:5** (✗) [set_aside: no_inner_being] *target: peace*
...
- **Jer 43:12** (✗) [set_aside: no_inner_being] *target: peace*
...
- **Obd 7** (✗) [set_aside: no_inner_being] *target: peace*
...
### `H7965H` — 1/1 classified · 1 anchor verse(s)

**Group `406-001`** (1 verse — anchors: Judg 6:24)

- **Judg 6:24** 🔵 (✓) *target: Peace*
  ...
  - notes: Gideon built an altar and called it YHWH-Shalom (The Lord Is Peace) following the theophany of Judg 6:23. The divine name commemorates God as the source and substance of peace sealed in the altar after the inner-peace encounter (Peace be to you. Do not fear).

### `H7965I` — 46/46 classified · 3 anchor verse(s)

**Group `2509-001`** (13 verses — anchors: Psa 35:27, Jer 29:11)

- **Psa 35:27** 🔵 (✓) *target: welfare*
  ...
  - notes: Lord delights in the welfare of his servant — God's inner orientation toward his servant's comprehensive welfare; sha.lom as the object of divine delight.
- **Jer 29:11** 🔵 (✓) *target: welfare*
  > Jer 29:11 For I know the plans I have for you, declares the Lord , plans for welfare and not for evil , to give you a future and a hope .
  - notes: Plans for welfare and not for evil, to give you a future and a hope — divine purposive orientation toward the comprehensive welfare of his people.
- **Job 21:9** (✓) *target: safe*
  > Job 21:9 Their houses are safe from fear , and no rod of God is upon them .
  - notes: Houses safe from fear, no rod of God — the welfare-condition of the wicked observed; inner content: the absence of fear and divine discipline.
- **Psa 38:3** (✓) *target: health*
  > Psa 38:3 There is no soundness in my flesh because of your indignation ; there is no health in my bones because of my sin .
  - notes: No health in my bones because of sin — sha.lom-soundness absent as somatic consequence of sin; welfare/wholeness broken by inner disorder.
- **Psa 55:18** (✓) *target: safety*
  > Psa 55:18 He redeems my soul in safety from the battle that I wage , for many are arrayed against me .
  - notes: He redeems my soul in safety — sha.lom-safety as the condition of the soul (nephesh) under divine redemption.
- **Psa 72:3** (✓) *target: prosperity*
  > Psa 72:3 Let the mountains bear prosperity for the people , and the hills , in righteousness !
  - notes: Mountains bearing prosperity for the people — eschatological covenant welfare.
- **Psa 73:3** (✓) *target: prosperity*
  > Psa 73:3 For I was envious of the arrogant when I saw the prosperity of the wicked .
  - notes: Psalmist envious of the arrogant when he saw the prosperity of the wicked — inner-being engagement through envy provoked by observing sha.lom-prosperity.
- **Isa 38:17** (✓) *target: welfare*
  ...
  - notes: For my welfare I had great bitterness; in love you delivered my life — sha.lom achieved paradoxically through suffering and divine love.
- **Isa 45:7** (✓) *target: well-being*
  > Isa 45:7 I form light and create darkness , I make well-being and create calamity ; I am the Lord , who does all these things .
  - notes: I make well-being and create calamity — God as sovereign creator of sha.lom and its opposite; comprehensive welfare as divine creation.
- **Jer 29:7** (✓) *target: welfare*
  ...
  - notes: Seek the welfare of the city; in its welfare you will find your welfare — active orientation toward sha.lom; welfare is participatory and shared.
- **Jer 33:6** (✓) *target: prosperity*
  ...
  - notes: I will reveal to them abundance of prosperity and security — God revealing sha.lom-prosperity.
- **Jer 33:9** (✓) *target: prosperity*
  ...
  - notes: All the prosperity I provide for it — God providing sha.lom-prosperity for Jerusalem.
- **Jer 38:4** (✓) *target: welfare*
  ...
  - notes: This man is not seeking the welfare of this people, but their harm — inner orientation of seeking sha.lom contrasted with seeking harm.

**Group `2509-002`** (4 verses — anchors: Deu 29:19)

- **Deu 29:19** 🔵 (✓) *target: safe*
  ...
  - notes: Blesses himself in his heart saying 'I shall be safe' while walking in stubbornness of heart — sha.lom claimed by the self-deceived heart; the false inner assurance of welfare accompanying covenant violation.
- **Job 15:21** (✓) *target: prosperity*
  > Job 15:21 Dreadful sounds are in his ears ; in prosperity the destroyer will come upon him .
  - notes: In prosperity the destroyer will come — sha.lom-prosperity as the illusory condition of the wicked before destruction.
- **Jer 4:10** (✓) *target: well*
  > Jer 4:10 Then I said , “ Ah , Lord God , surely you have utterly deceived this people and Jerusalem , saying , ‘It shall be well with you,’ whereas the sword has reached their very life .”
  - notes: Prophets said 'It shall be well with you' while the sword reached their very life (nephesh) — false promise of welfare reaching the inner person.
- **Jer 23:17** (✓) *target: well*
  ...
  - notes: It shall be well with you to everyone who stubbornly follows his own heart — false welfare promise to the stubborn-hearted; parallel to Deu 29:19.

**Group `SET-ASIDE`** (29 verses)

- **Gen 29:6** (✗) [set_aside: no_inner_being] *target: well*
  > Gen 29:6 He said to them, “Is it well with him?” They said , “It is well ; and see , Rachel his daughter is coming with the sheep !”
- **Gen 37:14** (✗) [set_aside: no_inner_being] *target: well*
...
- **Gen 43:27** (✗) [set_aside: no_inner_being] *target: welfare*
...
- **Gen 43:28** (✗) [set_aside: no_inner_being] *target: well*
...
- **Exo 18:7** (✗) [set_aside: no_inner_being] *target: welfare*
...
- **Jos 10:21** (✗) [set_aside: no_inner_being] *target: safe*
...
- **Judg 18:15** (✗) [set_aside: no_inner_being] *target: welfare*
...
- **1Sa 17:18** (✗) [set_aside: no_inner_being] *target: well*
...
- **1Sa 20:21** (✗) [set_aside: no_inner_being] *target: safe*
...
- **2Sa 8:10** (✗) [set_aside: no_inner_being] *target: health*
...
- **2Sa 18:28** (✗) [set_aside: no_inner_being] *target: well*
...
- **2Sa 18:29** (✗) [set_aside: no_inner_being] *target: well*
...
- **2Sa 18:32** (✗) [set_aside: no_inner_being] *target: well*
...
- **2Sa 19:24** (✗) [set_aside: no_inner_being] *target: safety*
...
- **2Ki 4:23** (✗) [set_aside: no_inner_being] *target: well*
  > 2Ki 4:23 And he said , “ Why will you go to him today ? It is neither new moon nor Sabbath .” She said , “All is well .”
  - notes: Shunammite's concealment is inner-being, but sha.lom itself is the social formula here, not the inner-being carrier.
- **2Ki 4:26** (✗) [set_aside: no_inner_being] *target: well*
...
- **2Ki 5:21** (✗) [set_aside: no_inner_being] *target: well*
...
- **2Ki 5:22** (✗) [set_aside: no_inner_being] *target: well*
  ...
  - notes: Gehazi's deception is inner-being but sha.lom is the formula, not the carrier of his deceit.
- **2Ki 9:11** (✗) [set_aside: no_inner_being] *target: well*
...
- **1Ch 18:10** (✗) [set_aside: no_inner_being] *target: health*
...
### `H7965J` — 5/5 classified · 1 anchor verse(s)

**Group `2510-001`** (5 verses — anchors: 1Ch 12:17)

- **1Ch 12:17** 🔵 (✓) *target: friendship*
  ...
  - notes: If you have come to me in friendship (sha.lom) to help me, my heart will be joined to you — sha.lom as inner relational loyalty directly connected to heart-union.
- **Psa 41:9** (✓) *target: close*
  > Psa 41:9 Even my close friend in whom I trusted , who ate my bread , has lifted his heel against me.
  - notes: My close friend (ish sha.lom) in whom I trusted — sha.lom names the bond of friendship whose betrayal is devastating.
- **Psa 55:20** (✓) *target: friends*
  > Psa 55:20 My companion stretched out his hand against his friends ; he violated his covenant .
  - notes: Stretched out his hand against his friends (sha.lom); he violated his covenant — sha.lom friendship violated alongside covenant.
- **Jer 20:10** (✓) *target: close*
  ...
  - notes: All my close friends (anshei sha.lom), watching for my fall — men of sha.lom who are secretly hostile.
- **Jer 38:22** (✓) *target: trusted*
  ...
  - notes: Your trusted friends (anshei sha.lom) have deceived you — men of sha.lom who deceive.

### `H7965K` — 8/8 classified · 1 anchor verse(s)

**Group `2511-001`** (1 verse — anchors: 1Sa 25:6)

- **1Sa 25:6** 🔵 (✓) *target: Peace*
  > 1Sa 25:6 And thus you shall greet him: ‘ Peace be to you , and peace be to your house , and peace be to all that you have.
  - notes: Peace be to you, and peace be to your house, and peace be to all that you have — the triple sha.lom blessing as greeting content; sha.lom is the substantive blessing invoked, not merely a social formula.

**Group `SET-ASIDE`** (7 verses)

- **1Sa 10:4** (✗) [set_aside: no_inner_being] *target: greet*
  > 1Sa 10:4 And they will greet you and give you two loaves of bread , which you shall accept from their hand .
- **1Sa 17:22** (✗) [set_aside: no_inner_being] *target: greeted*
...
- **1Sa 25:5** (✗) [set_aside: no_inner_being] *target: greet*
...
- **1Sa 30:21** (✗) [set_aside: no_inner_being] *target: greeted*
...
- **Est 2:11** (✗) [set_aside: no_inner_being] *target: was*
...
### `H7965L` — 1/1 classified · 0 anchor verse(s)

**Group `SET-ASIDE`** (1 verse)

- **Jer 13:19** (✗) [set_aside: no_inner_being] *target: wholly*
  ...
  - notes: Sha.lom used adverbially meaning 'completely/wholly' applied to the external event of exile. Adverbial intensifier; inner-being content of exile carried by other terms, not by sha.lom in this adverbial role.

### `H8252` — 23/41 classified · 7 anchor verse(s)

**Group `418-001`** (5 verses — anchors: Isa 7:4, Isa 30:15)

- **Isa 7:4** 🔵 (✓) *target: quiet*
...
- **Isa 30:15** 🔵 (✓) *target: quietness*
  > Isa 30:15 For thus said the Lord God , the Holy One of Israel , “ In returning and rest you shall be saved ; in quietness and in trust shall be your strength .” But you were unwilling ,
- **Rut 3:18** (✓) *target: rest*
...
**Group `418-003`** (5 verses — anchors: Job 34:29, Eze 16:42)

- **Job 34:29** 🔵 (✓) *target: quiet*
  > Job 34:29 When he is quiet , who can condemn ? When he hides his face , who can behold him, whether it be a nation or a man ?—
- **Eze 16:42** 🔵 (✓) *target: calm*
  > Eze 16:42 So will I satisfy my wrath on you, and my jealousy shall depart from you. I will be calm and will no more be angry .
- **Psa 83:1** (✓) *target: still*
  > A Song . A Psalm of Asaph . Psa 83:1 O God , do not keep silence ; do not hold your peace or be still , O God !
- **Isa 18:4** (✓) *target: quietly*
...
- **Isa 62:1** (✓) *target: quiet*
  > Isa 62:1 For Zion’s sake I will not keep silent , and for Jerusalem’s sake I will not be quiet , until her righteousness goes forth as brightness , and her salvation as a burning torch .

**Group `418-004`** (9 verses — anchors: Jer 30:10)

- **Jer 30:10** 🔵 (✓) *target: quiet*
...
**Group `UNCLASSIFIED`** (18 verses)

- **Jos 11:23** (—) *target: rest*
...
- **Judg 3:11** (—) *target: rest*
  > Judg 3:11 So the land had rest for forty years . Then Othniel the son of Kenaz died .
- **Judg 3:30** (—) *target: rest*
  > Judg 3:30 So Moab was subdued that day under the hand of Israel . And the land had rest for eighty years .
- **Judg 5:31** (—) *target: rest*
...
- **Judg 8:28** (—) *target: rest*
  > Judg 8:28 So Midian was subdued before the people of Israel , and they raised their heads no more . And the land had rest for forty years in the days of Gideon .
- **Judg 18:7** (—) *target: quiet*
  > Judg 18:7 Then the five men departed and came to Laish and saw the people who were there , how they lived in security , after the manner of the Sidonians , quiet and unsuspecting , lacking nothing that is in the earth and possessing wealth , and how they were far from the Sidonians and had no dealings with anyone .
- **Judg 18:27** (—) *target: quiet*
...
- **2Ch 14:6** (—) *target: rest*
  > 2Ch 14:6 He built fortified cities in Judah , for the land had rest . He had no war in those years , for the Lord gave him peace .
- **2Ch 20:30** (—) *target: quiet*
  > 2Ch 20:30 So the realm of Jehoshaphat was quiet , for his God gave him rest all around .
- **2Ch 23:21** (—) *target: quiet*
...
### `H8253` — 1/1 classified · 1 anchor verse(s)

**Group `2583-001`** (1 verse — anchors: 1Ch 22:9)

- **1Ch 22:9** 🔵 (✓) *target: quiet*
  > 1Ch 22:9 Behold , a son shall be born to you who shall be a man of rest . I will give him rest from all his surrounding enemies . For his name shall be Solomon , and I will give peace and quiet to Israel in his days .

### `G0425` — 5/5 classified · 1 anchor verse(s)

**Group `429-001`** (5 verses — anchors: 2Cor 2:13)

- **2Cor 2:13** 🔵 (✓) *target: rest*
...
- **2Cor 8:13** (✓) *target: eased*
  > 2Cor 8:13 For I do not mean that others should be eased and you burdened , but that as a matter of fairness
- **2Th 1:7** (✓) *target: relief*
...
### `G1514` — 4/4 classified · 1 anchor verse(s)

**Group `422-001`** (4 verses — anchors: Rom 12:18)

- **Rom 12:18** 🔵 (✓) *target: live peaceably*
  > Rom 12:18 If possible , so far as it depends on you , live peaceably with all .
- **Mar 9:50** (✓) *target: peace*
...
- **1Th 5:13** (✓) *target: peace*
  > 1Th 5:13 and to esteem them very highly in love because of their work . Be at peace among yourselves .

### `G1515` — 84/84 classified · 5 anchor verse(s)

**Group `426-001`** (14 verses — anchors: Joh 14:27, Phili 4:7)

- **Joh 14:27** 🔵 (✓) *target: Peace*
...
- **Phili 4:7** 🔵 (✓) *target: peace*
  > Phili 4:7 And the peace of God , which surpasses all understanding , will guard your hearts and your minds in Christ Jesus .
- **Joh 16:33** (✓) *target: peace*
...
**Group `426-002`** (35 verses — anchors: Rom 1:7)

- **Rom 1:7** 🔵 (✓) *target: peace*
...
- **1Cor 14:33** (✓) *target: peace*
  > 1Cor 14:33 For God is not a God of confusion but of peace . As in all the churches of the saints ,
- **1Cor 16:11** (✓) *target: peace*
  > 1Cor 16:11 So let no one despise him. Help him on his way in peace , that he may return to me , for I am expecting him with the brothers .
- **2Cor 13:11** (✓) *target: peace*
  > 2Cor 13:11 Finally , brothers , rejoice . Aim for restoration , comfort one another, agree with one another , live in peace ; and the God of love and peace will be with you .
- **Eph 2:15** (✓) *target: peace*
  > Eph 2:15 by abolishing the law of commandments expressed in ordinances , that he might create in himself one new man in place of the two , so making peace ,
- **Eph 2:17** (✓) *target: peace*
  > Eph 2:17 And he came and preached peace to you who were far off and peace to those who were near .
- **Eph 4:3** (✓) *target: peace*
  > Eph 4:3 eager to maintain the unity of the Spirit in the bond of peace .
- **Phili 4:9** (✓) *target: peace*
  > Phili 4:9 What you have learned and received and heard and seen in me — practice these things , and the God of peace will be with you .
- **1Th 5:3** (✓) *target: peace*
...
### `G1516` — 2/2 classified · 1 anchor verse(s)

**Group `427-001`** (2 verses — anchors: Jam 3:17)

- **Jam 3:17** 🔵 (✓) *target: peaceable*
...
- **Heb 12:11** (✓) *target: peaceful*
  > Heb 12:11 For the moment all discipline seems painful rather than pleasant , but later it yields the peaceful fruit of righteousness to those who have been trained by it .

### `G1517` — 1/1 classified · 1 anchor verse(s)

**Group `430-001`** (1 verse — anchors: Col 1:20)

- **Col 1:20** 🔵 (✓) *target: making peace*
  > Col 1:20 and through him to reconcile to himself all things , whether on earth or in heaven , making peace by the blood of his cross .

### `G2263` — 1/1 classified · 1 anchor verse(s)

**Group `428-001`** (1 verse — anchors: 1Ti 2:2)

- **1Ti 2:2** 🔵 (✓) *target: peaceful*
  > 1Ti 2:2 for kings and all who are in high positions , that we may lead a peaceful and quiet life , godly and dignified in every way.

### `G2270` — 5/5 classified · 2 anchor verse(s)

**Group `424-001`** (5 verses — anchors: Act 11:18, 1Th 4:11)

- **Act 11:18** 🔵 (✓) *target: fell silent*
...
- **1Ti 2:12** (✓) *target: quiet*
  > 1Ti 2:12 I do not permit a woman to teach or to exercise authority over a man ; rather , she is to remain quiet .

### `G2272` — 2/2 classified · 1 anchor verse(s)

**Group `2559-001`** (2 verses — anchors: 1Pe 3:4)

- **1Pe 3:4** 🔵 (✓) *target: quiet*
...
- **1Ti 2:2** (✓) *target: quiet*
  > 1Ti 2:2 for kings and all who are in high positions , that we may lead a peaceful and quiet life , godly and dignified in every way.

### `G4519` — 0/2 classified · 0 anchor verse(s)

**Group `UNCLASSIFIED`** (2 verses)

- **Rom 9:29** (—) *target: hosts*
...
### `G4601` — 9/9 classified · 1 anchor verse(s)

**Group `425-001`** (9 verses — anchors: 1Cor 14:28)

- **1Cor 14:28** 🔵 (✓) *target: keep silent*
  > 1Cor 14:28 But if there is no one to interpret , let each of them keep silent in church and speak to himself and to God .
- **Luk 9:36** (✓) *target: silent*
...
### `G4602` — 2/2 classified · 1 anchor verse(s)

**Group `2560-001`** (2 verses — anchors: Rev 8:1)

- **Rev 8:1** 🔵 (✓) *target: silence*
  > Rev 8:1 When the Lamb opened the seventh seal , there was silence in heaven for about half an hour .
- **Act 21:40** (✓) *target: hush*
...
### `G4623` — 11/11 classified · 2 anchor verse(s)

**Group `423-001`** (11 verses — anchors: Mat 26:63, Mar 4:39)

- **Mat 26:63** 🔵 (✓) *target: silent*
...
|---|---|---|---:|---:|---:|
| `H0136` | Lord [God] | `not_done` | 187 | 0 | 0 |
| `H3071` | YHWH-Nissi | `not_done` | 0 | 0 | 0 |
| `H3072` | YHWH-Tsidkenu | `not_done` | 0 | 0 | 0 |
| `H3073` | YHWH-Shalom | `not_done` | 0 | 0 | 0 |
| `H5769G` | forever: enduring | `not_done` | 272 | 0 | 0 |
| `H5769H` | Everlasting [God] | `not_done` | 1 | 0 | 0 |
| `H5943` | Most High [God] | `not_done` | 10 | 0 | 0 |
| `H5946` | Most High [God] | `not_done` | 4 | 0 | 0 |
| `H6635A` | army | `not_done` | 136 | 0 | 0 |
| `H6635B` | Hosts | `not_done` | 156 | 0 | 0 |
| `H6664H` | righteousness | `not_done` | 2 | 0 | 0 |
| `H7706` | Almighty [God] | `not_done` | 48 | 0 | 0 |
| `G4519` | hosts | `not_done` | 2 | 0 | 0 |
...
### Registry-specific extensions for R117 peace

_None._ No active non-tiered extensions in `wa_obs_question_catalogue` are sourced from registry 117 (peace).
...
- **Generated at:** `2026-05-02T04:30:43Z`
- **Schema version:** `3.17.0`
- **OWNER term md_versions present:** `[1, 2]`
...
*End of readiness output v3 — wa-117-peace.*