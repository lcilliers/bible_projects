# wa-117-peace — Analysis Readiness Output (v2)

_Pilot v2 generation · 2026-05-01T09:47:36Z · schema 3.17.0_
...
- `phase1_term_count`: 125  (programme-wide aggregate including XREF and historical terms — current OWNER count is 56, XREF 6)
...
| B — VC completeness | All OWNER terms vc_completed | partial — 56 legacy-VC remain (handled per §K) |
...
**56 term(s)** in this registry carry classification rows from pre-v3 work.
...
### Registry-specific questions for 117 peace

_None._ No questions in `wa_obs_question_catalogue` are sourced from registry 117 (peace).
...
- **Generated at:** `2026-05-01T09:47:36Z`
- **Schema version:** `3.17.0`
- **OWNER term md_versions present:** `[1]`
