...
_v6 generation · 2026-05-01T20:05:15Z · schema 3.17.0 · catalogue v2-2026-04-29 (T0–T7)_
...
**Open flags:** 3 unresolved · **Existing session_b_findings:** 2
...
| B — VC completeness | All OWNER terms vc_completed | partial — 61 legacy-VC remain (handled per §K) |
...
| `H1180` | ba.a.li | Baal [used for God] | H | `extracted_thin` | **`not_done`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H1293` | be.ra.khah | blessing | H | `extracted` | **`not_done`** | 1 | 64 | 2/0 | 63/0 | 3 |
| `H1585` | ge.mar | to complete | H | `extracted` | **`not_done`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H1748` | du.mam | silence | H | `extracted` | **`not_done`** | 1 | 3 | 1/0 | 3/0 | 1 |
| `H1820` | da.mah | to cease | H | `extracted` | **`not_done`** | 1 | 13 | 1/0 | 7/0 | 1 |
| `H1826A` | da.mam | to silence: stationary | H | `extracted` | **`not_done`** | 1 | 9 | 1/0 | 9/0 | 2 |
| `H1826H` | da.mam | to silence: silent | H | `extracted` | **`not_done`** | 1 | 15 | 1/0 | 15/0 | 2 |
| `H1827` | de.ma.mah | silence | H | `extracted` | **`not_done`** | 1 | 3 | 1/0 | 3/0 | 1 |
| `H2010` | ha.na.chah | holiday | H | `extracted` | **`not_done`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H2013` | has | to silence | H | `extracted` | **`not_done`** | 1 | 8 | 1/0 | 8/0 | 2 |
| `H2790A` | cha.rash | to plow/plot | H | `extracted` | **`not_done`** | 1 | 22 | 2/0 | 11/0 | 2 |
| `H2790B` | cha.resh | be quiet | H | `extracted` | **`not_done`** | 1 | 43 | 6/0 | 30/0 | 10 |
| `H2814` | cha.shah | be silent | H | `extracted` | **`not_done`** | 1 | 16 | 4/0 | 14/0 | 5 |
...
| `H4494` | ma.no.ach | resting | H | `extracted` | **`not_done`** | 1 | 6 | 1/0 | 3/0 | 2 |
| `H4496H` | me.nu.chah | resting | H | `extracted` | **`not_done`** | 1 | 21 | 3/0 | 14/0 | 4 |
| `H4771` | mar.go.a | rest | H | `extracted` | **`not_done`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H4774` | mar.ge.ah | repose | H | `extracted` | **`not_done`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H5117` | nu.ach | to rest | H | `extracted` | **`not_done`** | 1 | 140 | 6/0 | 58/0 | 11 |
| `H5118` | nu.ach | rest | H | `extracted` | **`not_done`** | 1 | 2 | 2/0 | 2/0 | 2 |
| `H5183A` | na.chat | quietness | H | `extracted` | **`not_done`** | 1 | 6 | 1/0 | 5/0 | 2 |
| `H5207` | ni.cho.ach | soothing | H | `extracted` | **`not_done`** | 1 | 43 | 3/0 | 43/0 | 4 |
| `H5251H` | nes | ensign | H | `extracted` | **`not_done`** | 1 | 20 | 1/0 | 7/0 | 2 |
...
| `H7067G` | qan.na | Jealous [God] | H | `extracted` | **`not_done`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H7280A` | ra.ga | to disturb | H | `extracted` | **`not_done`** | 1 | 6 | 1/0 | 3/0 | 1 |
| `H7280B` | ra.ga | to rest | H | `extracted` | **`not_done`** | 1 | 6 | 1/0 | 3/0 | 2 |
| `H7282` | ra.ge.a | restful | H | `extracted` | **`not_done`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H7600` | sha.a.nan | secure | H | `extracted` | **`not_done`** | 1 | 10 | 2/0 | 9/0 | 3 |
| `H7706` | shad.day | Almighty [God] | H | `extracted_theological_anchor` | **`not_done`** | 1 | 48 | 0/0 | 0/0 | 0 |
| `H7946` | shal.a.nan | at ease | H | `extracted` | **`not_done`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `H7965G` | sha.lom | peace | H | `extracted` | **`vc_completed`** | 2 | 148 | 4/0 | 83/65 | 13 |
| `H7965H` | sha.lom | peace | H | `extracted_thin` | **`not_done`** | 1 | 1 | 0/0 | 0/0 | 0 |
| `H7965I` | sha.lom | peace: well-being | H | `extracted` | **`not_done`** | 1 | 46 | 0/0 | 0/0 | 0 |
| `H7965J` | sha.lom | peace: friendship | H | `extracted_thin` | **`not_done`** | 1 | 5 | 0/0 | 0/0 | 0 |
| `H7965K` | sha.lom | peace: greeting | H | `extracted_thin` | **`not_done`** | 1 | 8 | 0/0 | 0/0 | 0 |
| `H7965L` | sha.lom | peace: completely | H | `extracted_thin` | **`not_done`** | 1 | 1 | 0/0 | 0/0 | 0 |
| `H8252` | sha.qat | to quiet | H | `extracted` | **`not_done`** | 1 | 41 | 4/0 | 23/0 | 7 |
| `H8253` | she.qet | quietness | H | `extracted` | **`not_done`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `G0425` | anesis | rest | G | `extracted` | **`not_done`** | 1 | 5 | 1/0 | 5/0 | 1 |
| `G1514` | eirēneuō | be at peace | G | `extracted` | **`not_done`** | 1 | 4 | 1/0 | 4/0 | 1 |
| `G1515` | eirēnē | peace | G | `extracted` | **`not_done`** | 1 | 84 | 3/0 | 84/0 | 5 |
| `G1516` | eirēnikos | peaceful | G | `extracted` | **`not_done`** | 1 | 2 | 1/0 | 2/0 | 1 |
| `G1517` | eirēnopoieō | to make peace | G | `extracted_thin` | **`not_done`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `G2263` | ēremos | quiet | G | `extracted` | **`not_done`** | 1 | 1 | 1/0 | 1/0 | 1 |
| `G2270` | hēsuchazō | be quiet/give up | G | `extracted` | **`not_done`** | 1 | 5 | 1/0 | 5/0 | 2 |
| `G2271` | hēsuchia | quietness | G | `extracted` | **`not_done`** | 1 | 4 | 1/0 | 4/0 | 1 |
| `G2272` | hēsuchios | quiet | G | `extracted` | **`not_done`** | 1 | 2 | 1/0 | 2/0 | 1 |
| `G4519` | sabaōth | hosts | G | `extracted_theological_anchor` | **`not_done`** | 1 | 2 | 0/0 | 0/0 | 0 |
| `G4601` | sigaō | be silent | G | `extracted` | **`not_done`** | 1 | 9 | 1/0 | 9/0 | 1 |
| `G4602` | sigē | silence | G | `extracted` | **`not_done`** | 1 | 2 | 1/0 | 2/0 | 1 |
| `G4623` | siōpaō | be quiet | G | `extracted` | **`not_done`** | 1 | 11 | 1/0 | 11/0 | 2 |
| `G5392` | fimoō | to muzzle | G | `extracted` | **`not_done`** | 1 | 8 | 1/0 | 8/0 | 2 |
...
**Identity:** mti=406 · ti=617 · language=Hebrew · status=`extracted_thin` · md_v=1
...
**Identity:** mti=2509 · ti=2647 · language=Hebrew · status=`extracted` · md_v=1
...
**Identity:** mti=2510 · ti=2648 · language=Hebrew · status=`extracted_thin` · md_v=1
...
**Identity:** mti=2511 · ti=2649 · language=Hebrew · status=`extracted_thin` · md_v=1
...
**Identity:** mti=2512 · ti=2650 · language=Hebrew · status=`extracted_thin` · md_v=1
...
### H.1 Existing session_b_findings (2)
...
### `H7965H` — 0/1 classified · 0 anchor verse(s)
...
### `H7965J` — 0/5 classified · 0 anchor verse(s)
...
### `H7965L` — 0/1 classified · 0 anchor verse(s)

**Group `UNCLASSIFIED`** (1 verse)

- **Jer 13:19** (—) *target: wholly*
...
**61 term(s)** in this registry carry classification rows from pre-v3 work.
...
| `H1180` | Baal [used for God] | `not_done` | 1 | 1 | 1 |
| `H1293` | blessing | `not_done` | 64 | 2 | 63 |
| `H1585` | to complete | `not_done` | 1 | 1 | 1 |
| `H1748` | silence | `not_done` | 3 | 1 | 3 |
| `H1820` | to cease | `not_done` | 13 | 1 | 7 |
| `H1826A` | to silence: stationary | `not_done` | 9 | 1 | 9 |
| `H1826H` | to silence: silent | `not_done` | 15 | 1 | 15 |
| `H1827` | silence | `not_done` | 3 | 1 | 3 |
| `H2010` | holiday | `not_done` | 1 | 1 | 1 |
| `H2013` | to silence | `not_done` | 8 | 1 | 8 |
| `H2790A` | to plow/plot | `not_done` | 22 | 2 | 11 |
| `H2790B` | be quiet | `not_done` | 43 | 6 | 30 |
| `H2814` | be silent | `not_done` | 16 | 4 | 14 |
| `H3071` | YHWH-Nissi | `not_done` | 0 | 0 | 0 |
| `H3072` | YHWH-Tsidkenu | `not_done` | 0 | 0 | 0 |
| `H3073` | YHWH-Shalom | `not_done` | 0 | 0 | 0 |
| `H4494` | resting | `not_done` | 6 | 1 | 3 |
| `H4496H` | resting | `not_done` | 21 | 3 | 14 |
| `H4771` | rest | `not_done` | 1 | 1 | 1 |
| `H4774` | repose | `not_done` | 1 | 1 | 1 |
| `H5117` | to rest | `not_done` | 140 | 6 | 58 |
| `H5118` | rest | `not_done` | 2 | 2 | 2 |
| `H5183A` | quietness | `not_done` | 6 | 1 | 5 |
| `H5207` | soothing | `not_done` | 43 | 3 | 43 |
| `H5251H` | ensign | `not_done` | 20 | 1 | 7 |
...
| `H7067G` | Jealous [God] | `not_done` | 1 | 1 | 1 |
| `H7280A` | to disturb | `not_done` | 6 | 1 | 3 |
| `H7280B` | to rest | `not_done` | 6 | 1 | 3 |
| `H7282` | restful | `not_done` | 1 | 1 | 1 |
| `H7600` | secure | `not_done` | 10 | 2 | 9 |
| `H7706` | Almighty [God] | `not_done` | 48 | 0 | 0 |
| `H7946` | at ease | `not_done` | 1 | 1 | 1 |
| `H7965H` | peace | `not_done` | 1 | 0 | 0 |
| `H7965I` | peace: well-being | `not_done` | 46 | 0 | 0 |
| `H7965J` | peace: friendship | `not_done` | 5 | 0 | 0 |
| `H7965K` | peace: greeting | `not_done` | 8 | 0 | 0 |
| `H7965L` | peace: completely | `not_done` | 1 | 0 | 0 |
| `H8252` | to quiet | `not_done` | 41 | 4 | 23 |
| `H8253` | quietness | `not_done` | 1 | 1 | 1 |
| `G0425` | rest | `not_done` | 5 | 1 | 5 |
| `G1514` | be at peace | `not_done` | 4 | 1 | 4 |
| `G1515` | peace | `not_done` | 84 | 3 | 84 |
| `G1516` | peaceful | `not_done` | 2 | 1 | 2 |
| `G1517` | to make peace | `not_done` | 1 | 1 | 1 |
| `G2263` | quiet | `not_done` | 1 | 1 | 1 |
| `G2270` | be quiet/give up | `not_done` | 5 | 1 | 5 |
| `G2271` | quietness | `not_done` | 4 | 1 | 4 |
| `G2272` | quiet | `not_done` | 2 | 1 | 2 |
| `G4519` | hosts | `not_done` | 2 | 0 | 0 |
| `G4601` | be silent | `not_done` | 9 | 1 | 9 |
| `G4602` | silence | `not_done` | 2 | 1 | 2 |
| `G4623` | be quiet | `not_done` | 11 | 1 | 11 |
| `G5392` | to muzzle | `not_done` | 8 | 1 | 8 |
...
- **Generated at:** `2026-05-01T20:05:15Z`
- **Schema version:** `3.17.0`
- **OWNER term md_versions present:** `[1, 2]`
