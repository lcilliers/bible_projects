# M10b Phase 9 — Characteristic 1 (Wickedness as settled person-identity) — brief

**Cluster:** M10b — Wickedness, Evil and Abomination
**Characteristic:** 1 — Wickedness as settled person-identity
**Verses in scope:** ~190 across 1 sub-group(s)
...
| # | Document | Purpose |
|---|---|---|
| 1 | **This brief** — `Sessions/Session_Clusters/M10b/wa-cluster-M10b-phase9-char1-Wickedness-as-settled-person-identity-brief-v1-20260525.md` | Primary task instructions |
| 2 | **Structural input** — `Sessions/Session_Clusters/M10b/wa-cluster-M10b-phase9-char1-Wickedness-as-settled-person-identity-input-v1-20260525.md` | Characteristic definition + sub-groups + VCGs + verses + 189 prompts + carry-forward observations |
...
M10b has 6 inner-being characteristics. You are processing **Characteristic 1 (Wickedness as settled person-identity)**. Per researcher direction 2026-05-18 (carried forward to M10b under v2_8 §8.0):
...
## Characteristic 1 — Wickedness as settled person-identity: definition

> The wicked person as an inner-being type — the individual whose core moral character is defined by wickedness. Will corrupted, God actively excluded from the mind (practical atheism), inner orientation persistently bent toward harm and injustice. Conscience suppressed or displaced by an inner voice of transgression. Wickedness is not merely a series of acts but a stable identity and inner condition; divine judgment falls specifically on this person-type because their inner character warrants it.

---

## Your task

For each of the **189 catalogue prompts** (8 tiers, T0–T7), author a finding at characteristic scope for Characteristic 1 (Wickedness as settled person-identity). Use the verse evidence in the structural input.
...
Scope marker is `**[CHAR-1]**` (CC's loader maps this to characteristic_id=47 for this characteristic).
...
### INTEGRATION_NOTE — ra.sha forensic-verdict register — VCG-level cross-register signal

> M10b-A-VCG-01 (5V — Exo 23:7, Deu 25:1, 25:2, 1Ki 8:32, 2Ch 6:23) carries ra.sha as a legal-status label in forensic/judicial contexts ('the wicked = the legally condemnable') rather than naming inner moral character. Phase 9 T6 (Structural Relationships) findings should attend to this M10 (act-of-moral-failure) cross-register relationship. The VCG is structurally separated from the inner-moral-character VCGs within M10b-A.
...
Target filename: `Sessions/Session_Clusters/M10b/wa-cluster-M10b-phase9-char1-Wickedness-as-settled-person-identity-findings-v1-20260525.md`
...
```markdown
# M10b Phase 9 — Characteristic 1 (Wickedness as settled person-identity) — findings
...
2. Ping CC: "M10b Char 1 (Wickedness as settled person-identity) Phase 9 findings ready"
