# M10b Phase 9 — Characteristic 3 (Abomination — divine revulsion on moral character) — brief

**Cluster:** M10b — Wickedness, Evil and Abomination
**Characteristic:** 3 — Abomination — divine revulsion on moral character
**Verses in scope:** ~40 across 1 sub-group(s)
...
| # | Document | Purpose |
|---|---|---|
| 1 | **This brief** — `Sessions/Session_Clusters/M10b/wa-cluster-M10b-phase9-char3-Abomination-divine-revulsion-on-moral-character-brief-v1-20260525.md` | Primary task instructions |
| 2 | **Structural input** — `Sessions/Session_Clusters/M10b/wa-cluster-M10b-phase9-char3-Abomination-divine-revulsion-on-moral-character-input-v1-20260525.md` | Characteristic definition + sub-groups + VCGs + verses + 189 prompts + carry-forward observations |
...
M10b has 6 inner-being characteristics. You are processing **Characteristic 3 (Abomination — divine revulsion on moral character)**. Per researcher direction 2026-05-18 (carried forward to M10b under v2_8 §8.0):
...
## Characteristic 3 — Abomination — divine revulsion on moral character: definition
...
For each of the **189 catalogue prompts** (8 tiers, T0–T7), author a finding at characteristic scope for Characteristic 3 (Abomination — divine revulsion on moral character). Use the verse evidence in the structural input.
...
Scope marker is `**[CHAR-3]**` (CC's loader maps this to characteristic_id=49 for this characteristic).
...
No carry-forward observations are linked to this specific characteristic. If you surface unexpected analytical patterns during the 189-prompt pass, write them in the final summary so CC can record them as new cluster_observation rows.

---

## Output structure — built incrementally, tier-by-tier

Target filename: `Sessions/Session_Clusters/M10b/wa-cluster-M10b-phase9-char3-Abomination-divine-revulsion-on-moral-character-findings-v1-20260525.md`
...
```markdown
# M10b Phase 9 — Characteristic 3 (Abomination — divine revulsion on moral character) — findings
...
2. Ping CC: "M10b Char 3 (Abomination — divine revulsion on moral character) Phase 9 findings ready"
