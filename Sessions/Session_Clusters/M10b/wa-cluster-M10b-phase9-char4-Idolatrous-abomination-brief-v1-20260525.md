# M10b Phase 9 — Characteristic 4 (Idolatrous abomination) — brief

**Cluster:** M10b — Wickedness, Evil and Abomination
**Characteristic:** 4 — Idolatrous abomination
**Verses in scope:** ~99 across 1 sub-group(s)
...
| # | Document | Purpose |
|---|---|---|
| 1 | **This brief** — `Sessions/Session_Clusters/M10b/wa-cluster-M10b-phase9-char4-Idolatrous-abomination-brief-v1-20260525.md` | Primary task instructions |
| 2 | **Structural input** — `Sessions/Session_Clusters/M10b/wa-cluster-M10b-phase9-char4-Idolatrous-abomination-input-v1-20260525.md` | Characteristic definition + sub-groups + VCGs + verses + 189 prompts + carry-forward observations |
...
M10b has 6 inner-being characteristics. You are processing **Characteristic 4 (Idolatrous abomination)**. Per researcher direction 2026-05-18 (carried forward to M10b under v2_8 §8.0):
...
Scope marker is `**[CHAR-4]**` (CC's loader maps this to characteristic_id=50 for this characteristic).
...
Target filename: `Sessions/Session_Clusters/M10b/wa-cluster-M10b-phase9-char4-Idolatrous-abomination-findings-v1-20260525.md`
...
```markdown
# M10b Phase 9 — Characteristic 4 (Idolatrous abomination) — findings
...
2. Ping CC: "M10b Char 4 (Idolatrous abomination) Phase 9 findings ready"
