# M10b Phase 9 — Characteristic 2 (Evil as constitutional inner nature) — brief

**Cluster:** M10b — Wickedness, Evil and Abomination
**Characteristic:** 2 — Evil as constitutional inner nature
**Verses in scope:** ~90 across 1 sub-group(s)
...
| # | Document | Purpose |
|---|---|---|
| 1 | **This brief** — `Sessions/Session_Clusters/M10b/wa-cluster-M10b-phase9-char2-Evil-as-constitutional-inner-nature-brief-v1-20260525.md` | Primary task instructions |
| 2 | **Structural input** — `Sessions/Session_Clusters/M10b/wa-cluster-M10b-phase9-char2-Evil-as-constitutional-inner-nature-input-v1-20260525.md` | Characteristic definition + sub-groups + VCGs + verses + 189 prompts + carry-forward observations |
...
M10b has 6 inner-being characteristics. You are processing **Characteristic 2 (Evil as constitutional inner nature)**. Per researcher direction 2026-05-18 (carried forward to M10b under v2_8 §8.0):
...
Scope marker is `**[CHAR-2]**` (CC's loader maps this to characteristic_id=48 for this characteristic).
...
### INTEGRATION_NOTE — ponēros cosmic-evil-agent sub-corpus — VCG-level cross-register signal

> M10b-B-VCG-01 (13V — Mat 13:19, 13:38, Joh 17:15, Eph 6:16, 2Th 3:3, 1Jn 2:13, 2:14, 5:18, 5:19, Gal 1:4, Eph 5:16, 6:13, and Eph 6:12 ponēria) carries the 'evil one' / 'evil age' / cosmic-evil-agent register — supra-personal evil rather than the personal constitutional-evil register of the remaining ~77 VCG-2/3/4/5/6 verses. Phase 9 T6 findings should attend to this M27 (idolatry/cosmic-evil/concrete-evil) cross-register relationship. The VCG is structurally separated within M10b-B.
...
Target filename: `Sessions/Session_Clusters/M10b/wa-cluster-M10b-phase9-char2-Evil-as-constitutional-inner-nature-findings-v1-20260525.md`
...
```markdown
# M10b Phase 9 — Characteristic 2 (Evil as constitutional inner nature) — findings
...
2. Ping CC: "M10b Char 2 (Evil as constitutional inner nature) Phase 9 findings ready"
