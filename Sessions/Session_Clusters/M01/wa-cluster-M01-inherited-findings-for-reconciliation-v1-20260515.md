...
**Generated:** 2026-05-15T17:19:55Z  
...
|---|---:|
| `wa_session_b_findings` (status IN (open, pending, confirmed)) | **12** |
| `wa_session_research_flags` (resolved=0) | **16** |
...
### R211 being — 5 unresolved

#### srf.id=86 · flag_code=`VERSE_EVIDENCE_BREADTH_NOTE` · priority='MEDIUM'

- Label: 'PH2-211-001'
- Strong's ref: `G5308`
- Raised: '2026-03-27'  ·  Session target: 'D'

> G5308 hupselos: 198 occurrences but only 11 verses in export (5.6% ratio). Inner-being subset (proud/haughty) is a small fraction of total usage. Analysis based on 11 verses only.

**Disposition (AI):** ____________  ·  **Rationale:** ____________

---

#### srf.id=87 · flag_code=`VERSE_EVIDENCE_BREADTH_NOTE` · priority='MEDIUM'

- Label: 'PH2-211-002'
- Strong's ref: `G4680`
- Raised: '2026-03-27'  ·  Session target: 'D'

> G4680 sophos: 182 occurrences but only 19 verses in export (10.4% ratio). Analysis based on 19 verses only.

**Disposition (AI):** ____________  ·  **Rationale:** ____________

---

#### srf.id=88 · flag_code=`VERSE_EVIDENCE_BREADTH_NOTE` · priority='LOW'

- Label: 'PH2-211-003'
- Strong's ref: `G4679`
- Raised: '2026-03-27'  ·  Session target: 'D'

> G4679 sophizo: 14 occurrences but only 2 verses in export (14.3% ratio). Thin data.

**Disposition (AI):** ____________  ·  **Rationale:** ____________

---

#### srf.id=89 · flag_code=`VERSE_EVIDENCE_BREADTH_NOTE` · priority='LOW'

- Label: 'PH2-211-004'
- Strong's ref: `G1168`
- Raised: '2026-03-27'  ·  Session target: 'D'

> G1168 deiliao: 13 occurrences but only 1 verse in export (7.7% ratio). Thin data.

**Disposition (AI):** ____________  ·  **Rationale:** ____________

---

#### srf.id=90 · flag_code=`VERSE_EVIDENCE_BREADTH_NOTE` · priority='LOW'

- Label: 'PH2-211-005'
- Strong's ref: `G5424`
- Raised: '2026-03-27'  ·  Session target: 'D'

> G5424 phren: 12 occurrences but only 1 verse in export (8.3% ratio). Thin data.
