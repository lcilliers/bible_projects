# M10 Phase 9 — Characteristic 6 (Habitual defection) — structural input
...
| # | Document | Purpose |
|---|---|---|
| 1 | **Brief (read first)** — `Sessions/Session_Clusters/M10/wa-cluster-M10-phase9-char6-Habitual-defection-brief-v1-20260523.md` | Primary task instructions |
| 2 | **This document** — `Sessions/Session_Clusters/M10/wa-cluster-M10-phase9-char6-Habitual-defection-input-v1-20260523.md` | Characteristic definition + sub-groups + VCGs + verses + 189 prompts |
| 3 | Governing instruction — `Workflow/Instructions/wa-sessionb-cluster-instruction-v2_8-20260519.md` | §12 Phase 9 disciplines |

---

## §1 — Characteristic 6 (Habitual defection)

**Short name:** Habitual defection
**Characteristic_id:** 30
**Definition:**

> Sin as a recurring, established pattern of the will over time — the will's settled direction toward sin, distinct from the specific moment of refusal.

**Constituent sub-groups:** 1
**Total verses in scope:** ~14

---

## §2 — Sub-groups (capacity organisers — not the analytical unit)

### M10-O — Habitual defection

**core_description:** Char-R6 — Sin as a recurring, established pattern of the will over time; the will's settled direction toward sin

**Role under Habitual defection:** Single-sub-group representation (sub-group = characteristic 1:1).

**Verses in this sub-group:** 14

**VCGs within this sub-group:**

- `M10-O-VCG-01` (14 verses) — Habitual defection: the will's settled pattern toward sin
...
#### vc=19015 — Exo 9:34 (H2398 cha.ta) — VCG `M10-O-VCG-01`

> _… thunder had ceased , he_
...
> _yet again and hardened his …_

**Pass A meaning:** Pharaoh sinned again by hardening his heart once the plague ceased; the act of sinning is explicitly linked to the will's hardening, showing the inner disposition driving repeated transgression.

#### vc=18991 — 1Sa 2:25 (H2398 cha.ta) — VCG `M10-O-VCG-01`

> _… 1Sa 2:25 If someone_
...
> _against a man , God …_

**Pass A meaning:** Sinning against the Lord is presented as categorically more severe than sinning against a fellow human; when sin is directed at God himself, no human mediator can intercede, revealing the irreversible spiritual danger of such rebellion.

#### vc=18938 — 1Ki 8:46 (H2398 cha.ta) — VCG `M10-O-VCG-01`
...
> _against you— for there is …_

**Pass A meaning:** Solomon grounds the prayer in the universal truth that 'there is no one who does not sin,' establishing sin as an inevitable feature of human inner life whose consequence—captivity—requires a provision for repentance and forgiveness.

#### vc=18985 — 2Ki 17:7 (H2398 cha.ta) — VCG `M10-O-VCG-01`

> _… the people of Israel had_
...
> _against the Lord their God …_

**Pass A meaning:** Sinning here is directed against the Lord who redeemed Israel from Egypt; it involves the inner defection of fearing other gods, turning the will and allegiance away from a covenant relationship to false objects.

#### vc=19115 — Pro 11:31 (H2398 cha.ta) — VCG `M10-O-VCG-01`

> _… more the wicked and the_
> **Pro 11:31 If the righteous is repaid on earth , how much more the wicked and the sinner !**
> _! …_

**Pass A meaning:** The sinner here faces certain recompense on earth—if even the righteous are repaid, the sinner cannot escape; the verse implies that sinning carries inescapable consequence.

#### vc=19116 — Pro 13:22 (H2398 cha.ta) — VCG `M10-O-VCG-01`

> _… children’s children , but the_
...
> _wealth is laid up for …_

**Pass A meaning:** The sinner's accumulated wealth cannot be passed on to his own; his moral condition disqualifies him from legacy, and what he gathers is redirected to the righteous.

#### vc=19049 — Ecc 7:20 (H2398 cha.ta) — VCG `M10-O-VCG-01`

> _… who does good and never_
> **Ecc 7:20 Surely there is not a righteous man on earth who does good and never sins .**
> _. …_

**Pass A meaning:** Sinning is presented as a universal condition of all human beings — even the righteous man who does good cannot escape sinning, showing sin as an inescapable dimension of human inner nature.

#### vc=19069 — Ecc 7:26 (H2398 cha.ta) — VCG `M10-O-VCG-01`

> _… God escapes her, but the_
...
**Pass A meaning:** The sinner is one who does not please God and so lacks the inner disposition to escape the seductive trap — his failure is contrasted with the God-pleaser who does escape, locating sin in a relational inner stance.

#### vc=19104 — Ecc 9:2 (H2398 cha.ta) — VCG `M10-O-VCG-01`
...
> _, and he who swears …_

**Pass A meaning:** The sinner faces the same external fate as the righteous — death levels all distinctions — showing that sinning does not alter one's mortal destiny, though it defines one's moral character in contrast to the good.

#### vc=19071 — Ecc 9:18 (H2398 cha.ta) — VCG `M10-O-VCG-01`

> _… of war , but one_
> **Ecc 9:18 Wisdom is better than weapons of war , but one sinner destroys much good .**
> _destroys much good . …_

**Pass A meaning:** One sinner has the destructive capacity to undo the benefit of great wisdom — the sinner's inner character is shown as a powerful negative force that can overwhelm much accumulated good.

#### vc=19012 — Hos 8:11 (H2398 cha.ta) — VCG `M10-O-VCG-01`

> _… Ephraim has multiplied altars for_
> **Hos 8:11 Because Ephraim has multiplied altars for sinning , they have become to him altars for sinning .**
> _, they have become to …_

**Pass A meaning:** Sinning here is ritualized and self-reinforcing — altars multiplied for sinning become altars that produce more sinning — showing how institutionalized worship misdirected from God entrenches the sinful inner orientation rather than correcting it.

#### vc=19013 — Hos 10:9 (H2398 cha.ta) — VCG `M10-O-VCG-01`

> _… of Gibeah , you have_
...
**Pass A meaning:** Sinning here is a persistent historical pattern extending from Gibeah — they have sinned and continued — showing a wilful, unbroken inner disposition of transgression that has persisted across generations and will finally be overtaken by war.

#### vc=37527 — Heb 3:17 (G0264 hamartanō) — VCG `M10-O-VCG-01`

> _… it not with those who_
...
> _, whose bodies fell in …_

**Pass A meaning:** Those who sinned in the wilderness faced God's prolonged provocation and physical death as consequence — their sinning is the inner rebellion that drew divine wrath over forty years.

#### vc=37534 — 1Jo 3:6 (G0264 hamartanō) — VCG `M10-O-VCG-01`

> _… abides in him keeps on_
> **1Jo 3:6 No one who abides in him keeps on sinning ; no one who keeps on sinning has either seen him or known him .**
> _; no one who keeps …_

**Pass A meaning:** Continuing to sin reveals an inner state: the one who keeps sinning has never truly seen or known Christ, whereas abiding in him structurally prevents a pattern of sin from dominating the person.
