# M10 Phase 9 — Characteristic 4 (Conscience suppression) — brief

**Cluster:** M10 — Sin, Guilt and Transgression
**Characteristic:** 4 — Conscience suppression
...
| # | Document | Purpose |
|---|---|---|
| 1 | **This brief** — `Sessions/Session_Clusters/M10/wa-cluster-M10-phase9-char4-Conscience-suppression-brief-v1-20260523.md` | Primary task instructions |
| 2 | **Structural input** — `Sessions/Session_Clusters/M10/wa-cluster-M10-phase9-char4-Conscience-suppression-input-v1-20260523.md` | Characteristic definition + sub-groups + VCGs + verses + 189 prompts + carry-forward observations |
...
M10 has 22 inner-being characteristics. You are processing **Characteristic 4 (Conscience suppression)**. Per researcher direction 2026-05-18 (carried forward to M10 under v2_8 §8.0):
...
## Characteristic 4 — Conscience suppression: definition
...
For each of the **189 catalogue prompts** (8 tiers, T0–T7), author a finding at characteristic scope for Characteristic 4 (Conscience suppression). Use the verse evidence in the structural input.
...
Scope marker is `**[CHAR-4]**` (CC's loader maps this to characteristic_id=28 for this characteristic).
...
Target filename: `Sessions/Session_Clusters/M10/wa-cluster-M10-phase9-char4-Conscience-suppression-findings-v1-20260523.md`
...
```markdown
# M10 Phase 9 — Characteristic 4 (Conscience suppression) — findings
...
2. Ping CC: "M10 Char 4 (Conscience suppression) Phase 9 findings ready"
