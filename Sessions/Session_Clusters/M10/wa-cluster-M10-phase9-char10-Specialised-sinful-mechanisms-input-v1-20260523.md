# M10 Phase 9 — Characteristic 10 (Specialised sinful mechanisms) — structural input
...
| # | Document | Purpose |
|---|---|---|
| 1 | **Brief (read first)** — `Sessions/Session_Clusters/M10/wa-cluster-M10-phase9-char10-Specialised-sinful-mechanisms-brief-v1-20260523.md` | Primary task instructions |
| 2 | **This document** — `Sessions/Session_Clusters/M10/wa-cluster-M10-phase9-char10-Specialised-sinful-mechanisms-input-v1-20260523.md` | Characteristic definition + sub-groups + VCGs + verses + 189 prompts |
| 3 | Governing instruction — `Workflow/Instructions/wa-sessionb-cluster-instruction-v2_8-20260519.md` | §12 Phase 9 disciplines |

---

## §1 — Characteristic 10 (Specialised sinful mechanisms)

**Short name:** Specialised sinful mechanisms
...
**Total verses in scope:** ~5

---

## §2 — Sub-groups (capacity organisers — not the analytical unit)

### M10-S — Specialised sinful mechanisms

**core_description:** Char-R10 — Sin operating through specific inner mechanisms: desire exploited by enticement, identity falsified through hypocrisy, covenantal identity abandoned through apostasy

**Role under Specialised sinful mechanisms:** Single-sub-group representation (sub-group = characteristic 1:1).

**Verses in this sub-group:** 5

**VCGs within this sub-group:**

- `M10-S-VCG-01` (5 verses) — Specialised sinful mechanisms: desire exploited (M14), appearance falsified (M08), identity abandoned (M31)
...
#### vc=35717 — Act 21:21 (G0646 apostasia) — VCG `M10-S-VCG-01`
...
**Pass A meaning:** Apostasy here is the accusation that Paul teaches Jews to forsake Moses—to abandon circumcision and ancestral customs—framing it as an inner defection from covenantal identity.

#### vc=21197 — Gal 2:13 (G4942 sunupokrinomai) — VCG `M10-S-VCG-01`

> _… the rest of the Jews_
...
> _along with him , so …_

**Pass A meaning:** Joining in hypocrisy is a social act of moral contagion — the rest of the Jews were drawn into Peter's insincere behaviour, and even Barnabas was led astray, showing how collective hypocrisy corrupts community integrity.

#### vc=9078 — Jam 1:14 (G1185 deleazō) — VCG `M10-S-VCG-01`

> _… when he is lured and_
> **Jam 1:14 But each person is tempted when he is lured and enticed by his own desire .**
> _by his own desire . …_

**Pass A meaning:** Enticement operates through the person's own desire — the inner faculty of desire is the hook by which temptation draws and captures the person, making the origin of temptation internal rather than external.

#### vc=9079 — 2Pe 2:14 (G1185 deleazō) — VCG `M10-S-VCG-01`

> _… insatiable for sin . They_
...
> _unsteady souls . They have …_

**Pass A meaning:** Their enticing operates from within: eyes fixed on adultery, an insatiable appetite for sin, and hearts deliberately trained in greed — inner faculties wholly bent toward luring unstable souls.

#### vc=9080 — 2Pe 2:18 (G1185 deleazō) — VCG `M10-S-VCG-01`

> _… boasts of folly , they_
...
> _by sensual passions of the …_

**Pass A meaning:** They entice through loud, empty boasting that appeals to fleshly sensual passions, targeting those barely free from error — the enticement works by exploiting weakness in the will and desires.
