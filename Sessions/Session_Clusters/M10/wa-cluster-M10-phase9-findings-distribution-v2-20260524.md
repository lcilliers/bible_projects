...
**Generated:** 2026-05-24T18:02:37Z
...
## §0. Candidate primary-characteristic grouping (CC preliminary)

CC's preliminary proposal: cluster the 22 aspect-characteristics into **5 primary characteristics** for synthesis purposes. The 22 finer aspects remain correct for verse routing; they are *aspects* of these 5 primaries. Per-primary distillation precedes cross-primary cluster synthesis.

**Mapping (22 → 5):**

| Primary | Aspects | Total E | Total S | E % |
|---|---|---:|---:|---:|
| **Sin as act / will** (5) | 1 Wilful sinning, 2 Unintentional sinning, 5 Refusal to repent, 6 Habitual defection, 19 Transgression as deliberate boundary-crossing | 861 | 84 | 91.1% |
| **Sin as state / condition** (5) | 11 Sin as universal condition, 12 Sin as enslaving power, 13 Sin as divine record, 16 The sinner as moral character, 18 Iniquity as accumulated moral crime | 888 | 57 | 94.0% |
| **Sin's social transmission** (4) | 7 Contagious sin, 8 Political revolt, 15 Generational sin, 20 Faithlessness as covenant-breaking sin | 665 | 91 | 88.0% |
| **Specific sinful expressions** (4) | 9 Sinful speech, 10 Specialised sinful mechanisms, 21 Perversion as inner inversion, 22 Injustice as moral failure of right conduct | 710 | 46 | 93.9% |
| **Conscience response to sin** (4) | 3 Confession, 4 Conscience suppression, 14 Forgiveness sought and received, 17 Guilt as inner-being state | 696 | 60 | 92.1% |

**Per-primary definitions:**

### Sin as act / will (5 aspects)

> The volitional dimension of moral failure — the will in the moment of, or in the pattern of, sinning. Covers the act-quality of sin (deliberate vs unintentional), the will's persistence in sin (habitual vs occasional), and its refusal to turn back, plus transgression as the wilful crossing of a known boundary.

Aspects: CHAR-1 Wilful sinning, CHAR-2 Unintentional sinning, CHAR-5 Refusal to repent, CHAR-6 Habitual defection, CHAR-19 Transgression as deliberate boundary-crossing

### Sin as state / condition (5 aspects)

> The ontological dimension of sin — what the inner person IS under sin's weight, rather than what they did. Universal human condition, enslaving power, the divine record of accumulated wrongdoing, the sinner as moral category, iniquity as moral-spiritual debt before God.

Aspects: CHAR-11 Sin as universal condition, CHAR-12 Sin as enslaving power, CHAR-13 Sin as divine record, CHAR-16 The sinner as moral character, CHAR-18 Iniquity as accumulated moral crime

### Sin's social transmission (4 aspects)

> Sin's spread through social, relational, and covenantal bonds — leadership corrupting those under authority, political revolt as breaking submission, sin transmitted generationally, faithlessness as covenant-betrayal.

Aspects: CHAR-7 Contagious sin, CHAR-8 Political revolt, CHAR-15 Generational sin, CHAR-20 Faithlessness as covenant-breaking sin

### Specific sinful expressions (4 aspects)

> Sin expressed in distinct surface forms identified by the cluster — sinful speech (blasphemy/slander), specialised inner mechanisms (enticement, hypocrisy, apostasy), perversion as moral inversion, and injustice as moral failure toward persons.

Aspects: CHAR-9 Sinful speech, CHAR-10 Specialised sinful mechanisms, CHAR-21 Perversion as inner inversion, CHAR-22 Injustice as moral failure of right conduct

### Conscience response to sin (4 aspects)

> The inner-being responses to one's own sin — the conscience naming sin (confession), the conscience denying sin (suppression / self-deception), the felt experience of being guilty, and the movement toward divine forgiveness and its reception.

Aspects: CHAR-3 Confession, CHAR-4 Conscience suppression, CHAR-14 Forgiveness sought and received, CHAR-17 Guilt as inner-being state
