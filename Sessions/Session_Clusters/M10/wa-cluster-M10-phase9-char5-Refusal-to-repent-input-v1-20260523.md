# M10 Phase 9 — Characteristic 5 (Refusal to repent) — structural input
...
| # | Document | Purpose |
|---|---|---|
| 1 | **Brief (read first)** — `Sessions/Session_Clusters/M10/wa-cluster-M10-phase9-char5-Refusal-to-repent-brief-v1-20260523.md` | Primary task instructions |
| 2 | **This document** — `Sessions/Session_Clusters/M10/wa-cluster-M10-phase9-char5-Refusal-to-repent-input-v1-20260523.md` | Characteristic definition + sub-groups + VCGs + verses + 189 prompts |
| 3 | Governing instruction — `Workflow/Instructions/wa-sessionb-cluster-instruction-v2_8-20260519.md` | §12 Phase 9 disciplines |

---

## §1 — Characteristic 5 (Refusal to repent)

**Short name:** Refusal to repent
**Characteristic_id:** 29
**Definition:**

> The will that persistently refuses to turn from a sinful course when departure is available and known to be required — turning actively withheld.

**Constituent sub-groups:** 1
**Total verses in scope:** ~18

---

## §2 — Sub-groups (capacity organisers — not the analytical unit)

### M10-N — Refusal to repent

**core_description:** Char-R5 — The will that persistently refuses to turn from a sinful course when departure is available and known to be required; turning actively withheld

**Role under Refusal to repent:** Single-sub-group representation (sub-group = characteristic 1:1).

**Verses in this sub-group:** 18

**VCGs within this sub-group:**

- `M10-N-VCG-01` (18 verses) — Refusal to repent: departure withheld
...
#### vc=19251 — 1Ki 16:31 (H2403B chat.tat) — VCG `M10-N-VCG-01`

> _… him to walk in the_
...
> _of Jeroboam the son of …_

**Pass A meaning:** Ahab treated Jeroboam's sins as a light or trivial matter, revealing a dulled moral conscience that minimized established wickedness and then went on to compound it with Baal worship.

#### vc=19042 — 2Ki 3:3 (H2398 cha.ta) — VCG `M10-N-VCG-01`
...
**Pass A meaning:** Jehoram clung to Jeroboam's sin and did not depart from it, depicting sin as something to which the will clings with persistence, refusing the alternative of turning away.

#### vc=19002 — 2Ki 10:29 (H2398 cha.ta) — VCG `M10-N-VCG-01`

> _… not turn aside from the_
...
> _s of Jeroboam the son …_

**Pass A meaning:** Jehu did not turn aside from Jeroboam's sins despite his reforms, indicating that sinful practice—specifically golden calf worship—can persist in the will even when other evils are addressed.

#### vc=19003 — 2Ki 10:31 (H2398 cha.ta) — VCG `M10-N-VCG-01`

> _… did not turn from the_
...
> _s of Jeroboam , which …_

**Pass A meaning:** Jehu's failure to walk in God's law with all his heart is directly linked to not turning from Jeroboam's sins, locating the root of sin in incomplete inner commitment—a divided heart.

#### vc=19004 — 2Ki 13:2 (H2398 cha.ta) — VCG `M10-N-VCG-01`

> _… the Lord and followed the_
...
**Pass A meaning:** Jehoahaz followed Jeroboam's sins and did not depart from them, depicting sin as a religious-political path that the will adheres to without turning, passed from leader to leader.

#### vc=19005 — 2Ki 13:6 (H2398 cha.ta) — VCG `M10-N-VCG-01`

> _… did not depart from the_
...
> _s of the house of …_

**Pass A meaning:** Israel did not depart from Jeroboam's sins but walked in them, showing sin as a communal pattern of behavior persisted in by collective will, even alongside partial reform.

#### vc=19033 — 2Ki 13:11 (H2398 cha.ta) — VCG `M10-N-VCG-01`

> _… not depart from all the_
...
**Pass A meaning:** Jehoash did not depart from Jeroboam's sins but walked in them, again depicting sin as a deliberate path of conduct the will chooses to remain on rather than forsake.

#### vc=19034 — 2Ki 14:24 (H2398 cha.ta) — VCG `M10-N-VCG-01`
...
**Pass A meaning:** Jeroboam II did not depart from all of Jeroboam son of Nebat's sins, showing that sin can persist as an unbroken moral inheritance that a leader's will never moves to reject.

#### vc=19038 — 2Ki 15:9 (H2398 cha.ta) — VCG `M10-N-VCG-01`
...
**Pass A meaning:** Zechariah followed his fathers in doing evil and did not depart from Jeroboam's sins, showing sin as a generationally transmitted moral orientation that the will accepts by not turning from it.

#### vc=19035 — 2Ki 15:18 (H2398 cha.ta) — VCG `M10-N-VCG-01`

> _… his days from all the_
...
**Pass A meaning:** Menahem did not depart from Jeroboam's sins all his days, showing sin as a lifelong orientation of the will—an entire life's direction shaped by refusing to turn from inherited transgression.

#### vc=19036 — 2Ki 15:24 (H2398 cha.ta) — VCG `M10-N-VCG-01`

> _… not turn away from the_
...
**Pass A meaning:** Pekahiah did not turn away from Jeroboam's sins, presenting sin as a fixed moral direction that the will refuses to abandon—turning away being the expected and withheld response.

#### vc=19037 — 2Ki 15:28 (H2398 cha.ta) — VCG `M10-N-VCG-01`
...
**Pass A meaning:** To sin here describes a wilful clinging to an inherited corrupt course; Pekahiah did not depart from Jeroboam's sins, showing sin as a chosen continuation of a wrong path that also drew others into it.

#### vc=19058 — Neh 9:29 (H2398 cha.ta) — VCG `M10-N-VCG-01`

> _… obey your commandments , but_
...
> _against your rules , which …_

**Pass A meaning:** Sinning against God's rules is set alongside stubborn shoulder and stiff neck — a hardened will — showing sin here as a willful inner refusal to submit to God's word despite repeated warnings.

#### vc=19044 — Eze 18:24 (H2398 cha.ta) — VCG `M10-N-VCG-01`

> _… and the sin he has_
> **Eze 18:24 But when a righteous person turns away from his righteousness and does injustice and does the same abominations that the wicked person does , shall he live ? None of the righteous deeds that he has done shall be remembered ; for the treachery of which he is guilty and the sin he has committed , for them he shall die .**
> _, for them he shall …_

**Pass A meaning:** Sin committed by the formerly righteous person—having turned from righteousness—is the specific offense for which he dies; it is a conscious act of treachery that eclipses all prior righteous deeds.

#### vc=19106 — Eze 33:12 (H2398 cha.ta) — VCG `M10-N-VCG-01`

> _… by his righteousness when he_
...
**Pass A meaning:** Sinning in this verse is a decisive act that breaks the life-sustaining power of prior righteousness; once a righteous person sins, that act overrides his past good standing before God.

#### vc=37532 — Rom 6:15 (G0264 hamartanō) — VCG `M10-N-VCG-01`

> _… then ? Are we to_
> **Rom 6:15 What then ? Are we to sin because we are not under law but under grace ? By no means !**
> _because we are not under …_

**Pass A meaning:** The question of whether being under grace permits sinning is emphatically rejected; sinning is here a volitional act one might choose to indulge given reduced legal constraint, but grace is shown to be a stronger moral reality that forbids such license.

#### vc=37540 — 1Ti 5:20 (G0264 hamartanō) — VCG `M10-N-VCG-01`

> _… for those who persist in_
> **1Ti 5:20 As for those who persist in sin , rebuke them in the presence of all , so that the rest may stand in fear .**
> _, rebuke them in the …_

**Pass A meaning:** Persisting in sin indicates an ongoing inner orientation toward wrongdoing that requires public rebuke — the persistence suggests the will is entrenched, and public correction aims to produce fear in others.

#### vc=37526 — Heb 10:26 (G0264 hamartanō) — VCG `M10-N-VCG-01`

> _… For if we go on_
> **Heb 10:26 For if we go on sinning deliberately after receiving the knowledge of the truth , there no longer remains a sacrifice for sins ,**
> _deliberately after receiving the knowledge …_

**Pass A meaning:** Sinning deliberately after knowing the truth engages the will directly against received knowledge — this deliberate inner choice closes off the sacrificial remedy, making the will's complicity the aggravating factor.
