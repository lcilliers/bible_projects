# M10 Phase 9 — Characteristic 4 (Conscience suppression) — structural input
...
| # | Document | Purpose |
|---|---|---|
| 1 | **Brief (read first)** — `Sessions/Session_Clusters/M10/wa-cluster-M10-phase9-char4-Conscience-suppression-brief-v1-20260523.md` | Primary task instructions |
| 2 | **This document** — `Sessions/Session_Clusters/M10/wa-cluster-M10-phase9-char4-Conscience-suppression-input-v1-20260523.md` | Characteristic definition + sub-groups + VCGs + verses + 189 prompts |
| 3 | Governing instruction — `Workflow/Instructions/wa-sessionb-cluster-instruction-v2_8-20260519.md` | §12 Phase 9 disciplines |

---

## §1 — Characteristic 4 (Conscience suppression)

**Short name:** Conscience suppression
**Characteristic_id:** 28
**Definition:**

> The inner person who does not recognize, denies, or suppresses awareness of their own sinful state — conscience absent, self-blinded, or actively claiming innocence where guilt is real.
...
### M10-M — Conscience suppression

**core_description:** Char-R4 — The inner person who does not recognize, denies, or suppresses awareness of their own sinful state; conscience absent, self-blinded, or falsely claiming innocence

**Role under Conscience suppression:** Single-sub-group representation (sub-group = characteristic 1:1).

**Verses in this sub-group:** 8

**VCGs within this sub-group:**

- `M10-M-VCG-01` (8 verses) — Conscience suppression and self-blindness
...
#### vc=19078 — Judg 20:16 (H2398 cha.ta) — VCG `M10-M-VCG-01`

> _… at a hair and not_
> **Judg 20:16 Among all these were 700 chosen men who were left-handed ; every one could sling a stone at a hair and not miss .**
> _. …_

**Pass A meaning:** The term here is used in its literal physical sense of missing a target rather than in its moral sense; no inner-being content regarding sin is evidenced in this verse.

#### vc=19060 — Job 35:6 (H2398 cha.ta) — VCG `M10-M-VCG-01`

> _… Job 35:6 If you have_
...
> _, what do you accomplish …_

**Pass A meaning:** Elihu argues that sinning harms only the sinner, not God himself, detaching sin from any power to injure the divine and directing attention back to its effect on the human agent.

#### vc=19103 — Ecc 2:26 (H2398 cha.ta) — VCG `M10-M-VCG-01`
...
> _he has given the business …_

**Pass A meaning:** The sinner is defined by not pleasing God, and as a result receives only toil that ultimately benefits someone else — sinning is contrasted with God-pleasing as an inner orientation determining one's life outcome.

#### vc=19070 — Ecc 8:12 (H2398 cha.ta) — VCG `M10-M-VCG-01`
...
> _does evil a hundred times …_

**Pass A meaning:** The sinner repeatedly does evil yet may live long — but despite outward prosperity, the contrast with those who fear God reveals that sinning is fundamentally the absence of the fear of God within.

#### vc=18959 — Jer 2:35 (H2398 cha.ta) — VCG `M10-M-VCG-01`

> _… saying , ‘I have not_
...
**Pass A meaning:** Sinning is compounded by the inner denial of having sinned; the person claims innocence and assumes God's anger has passed, but God declares he will judge precisely for this self-deception about one's own sinful state.

#### vc=19020 — Jer 16:10 (H2398 cha.ta) — VCG `M10-M-VCG-01`

> _… the sin that we have_
...
> _against the Lord our God …_

**Pass A meaning:** Sinning against God is something the people fail to recognize despite facing severe judgment; their question—'what sin have we committed?'—reveals a conscience that has lost awareness of its own sinful inner state.

#### vc=37520 — 1Cor 15:34 (G0264 hamartanō) — VCG `M10-M-VCG-01`
...
> _. For some have no …_

**Pass A meaning:** Ongoing sinning is linked to a state of ignorance about God — continuing in sin reflects a failure of right knowledge and spiritual alertness, and Paul names it to provoke shame and awakening.

#### vc=37554 — Tit 3:11 (G0264 hamartanō) — VCG `M10-M-VCG-01`

> _… a person is warped and_
> **Tit 3:11 knowing that such a person is warped and sinful ; he is self-condemned .**
> _; he is self-condemned . …_

**Pass A meaning:** The divisive person is described as warped and sinful, self-condemned — sin here reflects an entrenched inner distortion of character that the person's own conscience implicitly witnesses against.
