# M10 Phase 9 — Characteristic 12 (Sin as enslaving power) — structural input
...
| # | Document | Purpose |
|---|---|---|
| 1 | **Brief (read first)** — `Sessions/Session_Clusters/M10/wa-cluster-M10-phase9-char12-Sin-as-enslaving-power-brief-v1-20260523.md` | Primary task instructions |
| 2 | **This document** — `Sessions/Session_Clusters/M10/wa-cluster-M10-phase9-char12-Sin-as-enslaving-power-input-v1-20260523.md` | Characteristic definition + sub-groups + VCGs + verses + 189 prompts |
| 3 | Governing instruction — `Workflow/Instructions/wa-sessionb-cluster-instruction-v2_8-20260519.md` | §12 Phase 9 disciplines |

---

## §1 — Characteristic 12 (Sin as enslaving power)

**Short name:** Sin as enslaving power
**Characteristic_id:** 36
**Definition:**

> Sin as an active force or power that masters the inner person, governing the will so it cannot freely choose otherwise. The will captive under sin's dominion.

**Constituent sub-groups:** 1
**Total verses in scope:** ~9

---

## §2 — Sub-groups (capacity organisers — not the analytical unit)

### M10-U — Sin as enslaving power

**core_description:** Char-R12 — Sin as an active force that masters the inner person, governing the will so that the person cannot freely choose otherwise

**Role under Sin as enslaving power:** Single-sub-group representation (sub-group = characteristic 1:1).

**Verses in this sub-group:** 9

**VCGs within this sub-group:**

- `M10-U-VCG-01` (9 verses) — Sin as enslaving power: the will under bondage
...
#### vc=19720 — Joh 8:34 (G0266 hamartia) — VCG `M10-U-VCG-01`

> _… you , everyone who practices_
> **Joh 8:34 Jesus answered them , “ Truly , truly , I say to you , everyone who practices sin is a slave to sin .**
> _is a slave to sin …_

**Pass A meaning:** Practicing sin makes one a slave to sin—Jesus describes sin as a dominating inner master that subjugates the will of the one who habitually commits it.

#### vc=19723 — Rom 6:1 (G0266 hamartia) — VCG `M10-U-VCG-01`

> _… Are we to continue in_
> **Rom 6:1 What shall we say then ? Are we to continue in sin that grace may abound ?**
> _that grace may abound ? …_

**Pass A meaning:** The rhetorical question asks whether one should continue in sin to magnify grace; sin is here treated as a behavioral domain in which a person can persist or not, suggesting it is an ongoing pattern of life under a power one can choose to remain in.

#### vc=19740 — Rom 6:2 (G0266 hamartia) — VCG `M10-U-VCG-01`

> _… can we who died to_
> **Rom 6:2 By no means ! How can we who died to sin still live in it ?**
> _still live in it ? …_

**Pass A meaning:** Believers are described as having died to sin, making continued living in it a contradiction; sin is a sphere of existence or a ruling domain one can be dead to, such that ongoing life in it is incompatible with the death-and-resurrection identity of the believer.

#### vc=19767 — Gal 3:22 (G0266 hamartia) — VCG `M10-U-VCG-01`

> _… the Scripture imprisoned everything under_
> **Gal 3:22 But the Scripture imprisoned everything under sin , so that the promise by faith in Jesus Christ might be given to those who believe .**
> _, so that the promise …_

**Pass A meaning:** Sin functions as a universal imprisoning power under which all of Scripture confines everything, so that the promise cannot be attained by human effort but only by faith in Christ.

#### vc=37525 — Eph 4:26 (G0264 hamartanō) — VCG `M10-U-VCG-01`

> _… Be angry and do not_
> **Eph 4:26 Be angry and do not sin ; do not let the sun go down on your anger ,**
> _; do not let the …_

**Pass A meaning:** Anger itself is not here condemned as sin, but the will must act quickly to prevent it from becoming sin — the verse locates the danger in allowing anger to persist unchecked.

#### vc=37535 — 1Jo 3:8 (G0264 hamartanō) — VCG `M10-U-VCG-01`

> _… Whoever makes a practice of_
...
**Pass A meaning:** A habitual practice of sinning discloses the person's allegiance at the deepest level — it aligns the self with the devil, whose sinning is originary, making sin a mark of belonging rather than a mere act.

#### vc=37536 — 1Jo 3:9 (G0264 hamartanō) — VCG `M10-U-VCG-01`

> _… God makes a practice of_
...
> _, for God’s seed abides …_

**Pass A meaning:** Divine birth transforms the inner constitution: God's seed abiding in the person makes sustained sinning structurally incompatible with who that person now is at their core.

#### vc=37537 — 1Jo 5:16 (G0264 hamartanō) — VCG `M10-U-VCG-01`

> _… sees his brother committing a_
...
> _not leading to death , …_

**Pass A meaning:** Sin is differentiated by its direction and consequence: some sin does not sever life, and intercession can restore the sinning brother; but sin that leads to death lies beyond the scope of that intercessory remedy.

#### vc=37538 — 1Jo 5:18 (G0264 hamartanō) — VCG `M10-U-VCG-01`

> _… God does not keep on_
...
**Pass A meaning:** The one born of God does not keep sinning because Christ himself protects that person, so that the evil one cannot gain a foothold — sin is prevented by an external guardian reinforcing the inner new birth.
