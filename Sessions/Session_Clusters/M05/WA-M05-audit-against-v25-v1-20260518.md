...
- relevant verse_context rows: 1428
- term count: 86
- set-aside vc rows: 115
...
|---|---|---:|---:|---|---|---|
| 1 | `missing_pass_a_meaning` | 1 | 1426 | systemic | very large | 100% of relevant verses |
| 2 | `missing_vcg` | 3 | 33 | bounded | medium | 2% of relevant verses |
| 3 | `placeholder_finding` | 4 | 705 | bounded | very large | 46% of cluster_finding rows |
| 4 | `completeness_gap` | 4 | 661 | bounded | very large | — |
| 5 | `ungrounded_finding` | 4 | 470 | bounded | large | 31% of cluster_finding rows |

### Per-action detail

#### Action 1 — `missing_pass_a_meaning` (1426 items, systemic)
...
#### Action 2 — `missing_vcg` (33 items, bounded)
...
#### Action 3 — `placeholder_finding` (705 items, bounded)
...
#### Action 4 — `completeness_gap` (661 items, bounded)
...
#### Action 5 — `ungrounded_finding` (470 items, bounded)
...
| `AUDIT-V25-PIPELINE-INCOMPLETE` | 1459 | 1 | blocking | §4 (Phase 1) + §5 (Phase 2) + §9 (Phase 6) + §10 (Phase 7) |
...
Total gap items: 1459

By category:
- missing_pass_a_meaning: 1426
- missing_vcg: 33
...
- G3874 paraklēsis (term_id=1290): {'missing_pass_a_meaning': 28}
