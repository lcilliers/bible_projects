# wa-cluster-M15-dir-005-C-mapping-v1-20260509

> Cluster-process directive — M15 Group-Verse Mapping Apply — Sub-group C
> Directive ID: DIR-20260509-005
> Produced by: Claude AI — Session B Phase 7 — M15
> Source document: WA-M15-C-group-verse-mapping-v1-20260508.md
...
Phase 6 Session B for cluster M15 produced a per-verse mapping document for sub-group M15-C (Knowledge as inner content and covenantal knowing). Document `WA-M15-C-group-verse-mapping-v1-20260508.md` was produced by reading every non-set-aside verse individually (581 verses). Researcher approved the M15-C mapping.

Phase 7 flags for this sub-group:

- Flag C-1 (RESEARCHER APPROVED): vr=178195 (Psa 139:6, da.at) — confirmed move from Group 1507 to Group 1506. Execute.
...
- **Groups in scope:** 1503-1515, 360, 2295, 2296 and others per mapping doc
- **Terms in scope:** H3045 ya.da, H1847 da.at, G1097 ginōskō, G0050 agnoeō, G1108 gnōsis, G1922 epignōsis, H1844 de.ah
...
1. All M15-C non-set-aside verses assigned to a group per the mapping document.
...
WHERE mt.cluster_code = 'M15'
  AND mt.cluster_subgroup_id = (SELECT id FROM cluster_subgroup WHERE subgroup_code = 'M15-C')
...
Save confirmation to: `WA-M15-C-group-mapping-applied-v1-20260509.md`
...
*wa-cluster-M15-dir-005-C-mapping-v1-20260509 | DIR-20260509-005 | Phase 7 | M15-C | 2026-05-09*
