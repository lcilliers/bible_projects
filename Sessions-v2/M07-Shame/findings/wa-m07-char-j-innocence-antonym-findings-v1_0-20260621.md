# M07 — Findings for Characteristic J: Innocence / cleanness (antonym pole) [FLAG]
**File:** wa-m07-char-j-innocence-antonym-findings-v1_0-20260621.md · 2026-06-21 · Phase: CATALOGUE-RESOLUTION (grounded in gathered evidence; Silent where evidence absent)
**Evidence source:** wa-m07-char-j-innocence-antonym-v1_0-20260621.md (8 occurrences). **Catalogue:** WA-tier-catalogue-current-state-v2-20260619.md (126 Q).
**Evidence snapshot:** lemmas=H5356A niq.qa.von×4; H5356B qe.ha.von×4 | faculty= | type=status×8 | valence=righteous×4; sinful×1; neutral×1 | experiencer=self×4; other×2 | location=heart×4 | divine=none | origin=none | testament=OT×8 | genres=psalm×4; narrative×2; prophecy×2
...
- **T0.1.2** — Borne by God or only the creature
  - **Borne only by the creature: experiencer is human throughout (self×4; other×2); God does not appear in this characteristic's evidence as bearer.**
...
- **T1.1.1** — Programme name / essential nature
  - **Within M07 this characteristic is carried by: niq.qa.von (H5356A, Hebrew); qe.ha.von (H5356B, Hebrew). Lemma meanings: innocency.**
- **T1.1.2** — Primary Hebrew/Greek terms at definitional level
  - **Hebrew/Greek split: Hebrew×8. Senses in use: innocence×8.**
...
- **T1.2.1** — Kind of inner-being phenomenon
  - **From morphology: status×8 (action=event/verb, status=condition, quality=attribute).**
- **T1.2.2** — Simple or compound
  - **Co-constituents present via compound tagging: heart (co)×4; bluntness (partner)×4; innocence (partner)×4; not (qualifier)×2; integrity (partner)×2; how (qualifier)×2; be able (partner)×2; face: anger (qualifier)×2; to be incensed (partner)×2.**
...
- **T1.4.1** — Mode(s) of operation incl. grammatical form
  - **Grammatical realisation: type status×8; stems n/a (Greek/none). Operates as status×8.**
- **T1.4.2** — Variation of mode by context/direction/level
  - **Varies: type spread status×8; experiencer spread self×4; other×2; relational spread none.**
...
- **T2.1.1** — Constitutional level(s) located
  - **Located at: heart×4 (e.g. Gen 20:5, Psa 73:13, Gen 20:5, Psa 73:13).**
- **T2.1.2** — Pattern of engaged/absent levels
  - **Seat tagged on 4/8; levels: heart×4. The large untagged remainder indicates this characteristic is recorded predominantly as relational/situational rather than seated.**
...
- **T3.11.1** — Engages relational capacity?
  - **Engaged — relational/other-directed: experiencer self×4; other×2, relational force n/a, object-type abstract×2.**
...
- **T3.8.1** — Engages moral evaluation?
  - **Engaged — moral framing tagged (valence): righteous×4; sinful×1; neutral×1.**
- **T3.8.2** — Effect on moral evaluation
  - **The state is morally weighted: righteous×4; sinful×1; neutral×1 — i.e. assessed against a standard of right/wrong.**
- **T3.8.3** — Pattern for moral evaluation
  - **valence tagged on 6/8: righteous×4; sinful×1; neutral×1.**
...
- **T4.3.1** — Person → person extension (giving)
  - **Yes (agent pole): one party inflicts shame/dishonour/contempt on another — experiencer 'other'/'other (addressed)' with transitive sense (Hos 8:5, Hos 8:5).**
...
- **T6.1.1** — Co-occurring adjacent characteristics (compound)
  - **Co-terms in-verse: heart×4; bluntness×4; innocence×4; not×2; integrity×2; how×2; be able×2; face: anger×2; to be incensed×2.**
...
- **T7.1.1** — Primary Hebrew/Greek terms and root meanings
  - **niq.qa.von (H5356A, Hebrew); qe.ha.von (H5356B, Hebrew). Meanings: innocency.**
- **T7.1.2** — Grammatical range
  - **type spread status×8; Hebrew stems n/a.**
- **T7.1.3** — Semantic range
  - **Senses attested in context: innocence×8.**
...
- **T7.1.5** — Term for opposite/absence
  - **Innocence/cleanness terms (niqqavon, qehavon) name the absence — but they sit in characteristic J; within THIS characteristic: present**
- **T7.1.6** — Person-type term
  - **Silent — this characteristic's evidence does not speak to it (deferred to interpret phase).**
- **T7.1.7** — Supplication/seeking term
  - **Silent — this characteristic's evidence does not speak to it (deferred to interpret phase).**
- **T7.1.8** — OT↔NT continuity/development
  - **Testament spread: OT×8. Single Testament in this characteristic's evidence.**
- **T7.1.9** — NT-coined term
  - **Silent — this characteristic's evidence does not speak to it (deferred to interpret phase).**
- **T7.1.10** — Full vocabulary arc / complete semantic range
  - **2 distinct lemmas across Hebrew×8; senses innocence×8.**
- **T7.2.1** — Function of the term in its verse
  - **Operates grammatically as status×8; governing predicate tagged where noun-state (how-field).**
- **T7.2.2** — Literary form(s)
  - **Forms carrying the evidence: psalm×4; narrative×2; prophecy×2.**
- **T7.2.3** — Logical structure of key arguments
  - **Silent — this characteristic's evidence does not speak to it (deferred to interpret phase).**
- **T7.2.4** — Contextual setting
  - **Inferable from genre/valence: psalm×4; narrative×2; prophecy×2; moral framing righteous×4; sinful×1; neutral×1. Judicial/covenantal where prophecy+sinful/commanded dominate.**
- **T7.2.5** — Primary anchor verse
  - **Candidate anchor: a high-load occurrence of niq.qa.von (H5356A) — e.g. Gen 20:5. Final anchor selection deferred to interpret phase.**
- **T7.2.6** — What the anchor shows uniquely
  - **Silent — this characteristic's evidence does not speak to it (deferred to interpret phase).**
- **T7.3.1** — Most useful human-science framework
  - **Moral psychology — innocence/purity as the contrast state to shame (niqqavon) [source: wa-m07-shame-scienceextract, Sec3].**
