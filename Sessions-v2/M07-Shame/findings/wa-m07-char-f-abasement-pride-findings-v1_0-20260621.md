# M07 — Findings for Characteristic F: Abasement — the bringing-low of pride (status reversal)
**File:** wa-m07-char-f-abasement-pride-findings-v1_0-20260621.md · 2026-06-21 · Phase: CATALOGUE-RESOLUTION (grounded in gathered evidence; Silent where evidence absent)
**Evidence source:** wa-m07-char-f-abasement-pride-v1_0-20260621.md (22 occurrences). **Catalogue:** WA-tier-catalogue-current-state-v2-20260619.md (126 Q).
**Evidence snapshot:** lemmas=H8213 sha.phel×22 | faculty= | type=action×21; quality×1 | valence=neutral×12; sinful×4; righteous×3; commanded×1 | experiencer=other×10; other (addressed)×5; self×2 | location=none | divine=agent×8; object×2 | origin=none | testament=OT×22 | genres=prophecy×13; wisdom×4; psalm×3; narrative×2

## T0 — Divine Image and Created Design
- **T0.1.1** — God-relation in the verse
  - **God appears in this characteristic's evidence in the role(s): agent×8; object×2 (e.g. 1Sa 2:7, Eze 17:24, Eze 21:26, Isa 10:33, Isa 26:5, Isa 2:11 (+4 more)). Elsewhere not related to God.**
- **T0.1.2** — Borne by God or only the creature
  - **Borne only by the creature: experiencer is human throughout (other×10; other (addressed)×5; self×2); where God appears he is agent×8; object×2 — i.e. agent/object/addressee — never the bearer of the state.**
...
- **T1.1.1** — Programme name / essential nature
  - **Within M07 this characteristic is carried by: sha.phel (H8213, Hebrew). Lemma meanings: to be or become low, sink, be humbled, be abased.**
- **T1.1.2** — Primary Hebrew/Greek terms at definitional level
  - **Hebrew/Greek split: Hebrew×22. Senses in use: low×6; brought low×6; humbled×2; brings low×1; down×1; lowly×1; abase×1; put lower×1; casts×1; bring down×1.**
- **T1.1.3** — Directional/relational/constitutional implication of the name
  - **Relational force tagged: from×1; than×1.**
- **T1.2.1** — Kind of inner-being phenomenon
  - **From morphology: action×21; quality×1 (action=event/verb, status=condition, quality=attribute).**
- **T1.2.2** — Simple or compound
  - **Co-constituents present via compound tagging: to exalt (partner)×7; to exult (partner)×2; high (partner)×2; height (partner)×2; haughtiness (partner)×2; proud (partner)×2; all (qualifier)×2; to enrich (partner)×1; terror (partner)×1; pride (partner)×1.**
...
- **T1.4.1** — Mode(s) of operation incl. grammatical form
  - **Grammatical realisation: type action×21; quality×1; stems Hiphil×15; Qal×6. Operates as action×21; quality×1.**
- **T1.4.2** — Variation of mode by context/direction/level
  - **Varies: type spread action×21; quality×1; experiencer spread other×10; other (addressed)×5; self×2; relational spread from×1; than×1.**
- **T1.4.3** — Communicative / speech-based mode
  - **Yes — commanded/addressed forms present: 2Sa 22:28, Isa 29:4, Jer 13:18, Job 40:11, Psa 18:27.**
- **T1.5.1** — Immediate inner-being response
  - **Tagged immediate_response present on: Isa 2:9, Isa 5:15, Pro 29:23 — values: forgive×1; brought low×1; obtain honor×1.**
- **T1.5.2** — Consistent or varied across verses
  - **Varied — forgive×1; brought low×1; obtain honor×1.**
...
- **T1.7.2** — Conditions where blocked/distorted (incl. another spirit)
  - **Adversarial/spiritual context tagged: Pro 29:23.**
...
- **T2.10.1** — Constitutional movement / onset from external source
  - **External onset suggested where experiencer is 'other (addressed)' and God/agent imposes (agent×8; object×2); movement sequence not tagged.**
...
- **T3.11.1** — Engages relational capacity?
  - **Engaged — relational/other-directed: experiencer other×10; other (addressed)×5; self×2, relational force from×1; than×1, object-type person×9; God×2; thing×1; abstract×1; spiritual-being×1.**
...
- **T3.8.1** — Engages moral evaluation?
  - **Engaged — moral framing tagged (valence): neutral×12; sinful×4; righteous×3; commanded×1.**
- **T3.8.2** — Effect on moral evaluation
  - **The state is morally weighted: neutral×12; sinful×4; righteous×3; commanded×1 — i.e. assessed against a standard of right/wrong.**
- **T3.8.3** — Pattern for moral evaluation
  - **valence tagged on 20/22: neutral×12; sinful×4; righteous×3; commanded×1.**
...
- **T4.1.1** — God → human operation
  - **Yes where God is agent (8 occ): God brings the state upon the person (e.g. 1Sa 2:7, Eze 17:24, Eze 21:26, Isa 10:33, Isa 26:5, Isa 2:12 (+2 more)).**
...
- **T4.2.1** — Human → God movement
  - **Yes — God as addressee/object in petition or confession (2 occ; e.g. Isa 2:11, Isa 2:17).**
- **T4.2.2** — Inner posture required
  - **Silent — this characteristic's evidence does not speak to it (deferred to interpret phase).**
- **T4.2.3** — What the human→God direction shows
  - **Silent — this characteristic's evidence does not speak to it (deferred to interpret phase).**
- **T4.3.1** — Person → person extension (giving)
  - **Yes (agent pole): one party inflicts shame/dishonour/contempt on another — experiencer 'other'/'other (addressed)' with transitive sense (2Sa 22:28, Isa 10:33, Isa 25:11, Isa 26:5, Isa 29:4, Isa 2:11 (+9 more)).**
- **T4.3.2** — Inner conditions in the giver
  - **Silent — this characteristic's evidence does not speak to it (deferred to interpret phase).**
- **T4.3.3** — What the giver must have received/become
  - **Silent — this characteristic's evidence does not speak to it (deferred to interpret phase).**
- **T4.4.1** — Person ← person uptake (receiving)
  - **The recipient bears the inflicted shame/disgrace (borne condition) — object-type person present (9 occ).**
...
- **T4.6.1** — Operates re other spiritual beings?
  - **Spiritual-being object-type tagged: Pro 29:23.**
...
- **T6.1.1** — Co-occurring adjacent characteristics (compound)
  - **Co-terms in-verse: to exalt×7; to exult×2; high×2; height×2; haughtiness×2; proud×2; all×2; to enrich×1; terror×1; pride×1; wicked×1; iniquity: crime×1.**
...
- **T7.1.1** — Primary Hebrew/Greek terms and root meanings
  - **sha.phel (H8213, Hebrew). Meanings: to be or become low, sink, be humbled, be abased.**
- **T7.1.2** — Grammatical range
  - **type spread action×21; quality×1; Hebrew stems Hiphil×15; Qal×6.**
- **T7.1.3** — Semantic range
  - **Senses attested in context: low×6; brought low×6; humbled×2; brings low×1; down×1; lowly×1; abase×1; put lower×1; casts×1; bring down×1; putting down×1.**
- **T7.1.4** — Terms distinguishing aspects (disposition vs act, etc.)
  - **Action vs status/quality split present: action×21; quality×1 — i.e. event-terms vs condition-terms co-exist.**
...
- **T7.1.8** — OT↔NT continuity/development
  - **Testament spread: OT×22. Single Testament in this characteristic's evidence.**
- **T7.1.9** — NT-coined term
  - **Silent — this characteristic's evidence does not speak to it (deferred to interpret phase).**
- **T7.1.10** — Full vocabulary arc / complete semantic range
  - **1 distinct lemmas across Hebrew×22; senses low×6; brought low×6; humbled×2; brings low×1; down×1; lowly×1; abase×1; put lower×1; casts×1; bring down×1.**
- **T7.2.1** — Function of the term in its verse
  - **Operates grammatically as action×21; quality×1; governing predicate tagged where noun-state (how-field).**
- **T7.2.2** — Literary form(s)
  - **Forms carrying the evidence: prophecy×13; wisdom×4; psalm×3; narrative×2.**
- **T7.2.3** — Logical structure of key arguments
  - **Silent — this characteristic's evidence does not speak to it (deferred to interpret phase).**
- **T7.2.4** — Contextual setting
  - **Inferable from genre/valence: prophecy×13; wisdom×4; psalm×3; narrative×2; moral framing neutral×12; sinful×4; righteous×3; commanded×1. Judicial/covenantal where prophecy+sinful/commanded dominate.**
- **T7.2.5** — Primary anchor verse
  - **Candidate anchor: a high-load occurrence of sha.phel (H8213) — e.g. 1Sa 2:7. Final anchor selection deferred to interpret phase.**
- **T7.2.6** — What the anchor shows uniquely
  - **Silent — this characteristic's evidence does not speak to it (deferred to interpret phase).**
- **T7.3.1** — Most useful human-science framework
  - **Social psychology — status degradation / abasement (paradeigmatizō, sha.phel: agentive social lowering) [source: wa-m07-shame-scienceextract, Sec2].**
