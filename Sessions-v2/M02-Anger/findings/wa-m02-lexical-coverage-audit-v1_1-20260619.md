# M02 · Lexical-Coverage & Completeness Self-Audit — All Characteristics (C1–C7)

- **File:** wa-m02-lexical-coverage-audit-v1_1-20260619.md · **Date:** 2026-06-19 · **Author:** le Roux Cilliers
...
## Occurrence-level completeness re-run (added v1_1, 2026-06-19)

Beyond field coverage, a full **occurrence-level** re-read of all four ve_lexical extracts was run to confirm nothing is unaccounted for.

**Exhaustive assignment — confirmed, no orphans:**

| Characteristic | Occurrences |
|---|---:|
| C1 Human anger | 228 |
| C2 Divine wrath | 145 |
| C3 Provoking to anger | 85 |
| C4 Jealousy/zeal | 77 |
| C5 Indignation | 49 |
| C6 Strife/quarrel | 83 |
| C7 Bitterness | 4 |
| **Assigned subtotal** | **671** |
| tsur (excluded — besiege/bind, 0/32 anger) | 32 |
| Orphans (unassigned focus occ) | **0** |
| **Focus-cluster total** | **703** |

Reconciliation: 671 + 32 + 0 = 703 = focus-cluster total. **Every focus occurrence is accounted for.**

**Sense-strand spot-check.** Notable minor senses were verified as reflected in the documents: C1 "grief" (Psa 6:7; 31:9; Pro 17:25 — the kaˈaˈs anger↔grief bridge), "fret" (Psa 37:1,8; Pro 24:19 — anger-restraint), "venom/poison" (Deu 32:33; Job 6:4; Psa 58:4; 140:3 — cheˈmah); C2 "venom" (Deu 32:24). All present in the respective docs.

**Result: C1–C7 require no substantive content updates from this completeness pass.** The only fix arising from the audit (cause_clause capture) was applied in v1_0→ the Evidence Bases already carry it. Cluster-level patterns are written up separately in `wa-m02-cluster-findings-v1_0-20260619.md`.

**Change control (v1_1):** Added the occurrence-level completeness re-run (exhaustive-assignment table, orphan check, sense-strand spot-check) and the no-updates-needed conclusion. Field-coverage matrix from v1_0 unchanged.
