...
_Pilot v2 generation · 2026-04-26T17:57:26Z · schema 3.16.1_
...
- **Generation timestamp:** `2026-04-26T17:57:26Z`
...
**Registry-specific questions:** 0 · **Universal questions:** 206

> **NOTE:** zero registry-specific questions are indexed for this word in `wa_obs_question_catalogue`. The instruction's Pass A (registry-specific) is empty under current data; Pass B (universal) is fully applicable. This is not an error — programme-wide, all 206 catalogue questions are currently `scope='universal'`.

### Universal questions (Pass B) — first 30 of 206

| obs_id | code | section | question |
|---:|---|---|---|
| 1 | `Q001` | Section 1 — Word Characteristic Summary | What is the structural disposition of the word — where does it originate? |
| 2 | `Q002` | Section 1 — Word Characteristic Summary | What determines whether the word is extended or withheld? |
| 3 | `Q003` | Section 1 — Word Characteristic Summary | What are the distinct modes of operation of the word in the inner being? |
| 4 | `Q004` | Section 1 — Word Characteristic Summary | What does the word produce in the inner being of the recipient? |
| 5 | `Q005` | Section 1 — Word Characteristic Summary | What does the word produce in the relational position of the recipient toward another? |
| 6 | `Q006` | Section 1 — Word Characteristic Summary | What does the word reveal about the disposition of God toward the human being? |
| 7 | `Q007` | Section 1 — Word Characteristic Summary | What does the word reveal about the basis on which God's disposition toward a person is established? |
| 8 | `Q008` | Section 1 — Word Characteristic Summary | Where, somatically or relationally, does the word locate the reality of its operation in the giver and in the recipient? |
| 9 | `Q009` | Section 1 — Word Characteristic Summary | Does the word describe a one-time act or an ongoing condition — and how are these distinguished? |
| 10 | `Q010` | Section 1 — Word Characteristic Summary | What spatial or directional language is used to describe the ongoing condition the word produces? |
| 11 | `Q011` | Section 1 — Word Characteristic Summary | Does the word produce enabling capacity in the inner being — and if so, what kind? |
| 12 | `Q012` | Section 1 — Word Characteristic Summary | What character quality does the word produce in the inner being? |
| 13 | `Q013` | Section 1 — Word Characteristic Summary | How does the word express itself in relation to others? |
| 14 | `Q014` | Section 1 — Word Characteristic Summary | What inner condition or orientation is identified as the ground of genuine expression of the word? |
| 15 | `Q015` | Section 1 — Word Characteristic Summary | Is there a discernible sequence or movement in the way the word operates through the inner person? |
| 16 | `Q016` | Section 1 — Word Characteristic Summary | What direction of movement does the word follow within and through the inner person? |
| 17 | `Q017` | Section 1 — Word Characteristic Summary | What does the word identify as its originating source? |
| 18 | `Q018` | Section 1 — Word Characteristic Summary | What does the word reveal about the origin of the human capacity to seek it? |
| 19 | `Q019` | Section 1 — Word Characteristic Summary | Does the word share an etymological root with another inner-being characteristic — and if so, what is that characteristi |
| 20 | `Q020` | Section 1 — Word Characteristic Summary | What does the word produce as a natural inner response in the one who receives it? |
| 21 | `Q021` | Section 2 — Word Impact Description | What inner-being logic or orientation functions as the structural opposite of the word? |
| 22 | `Q022` | Section 2 — Word Impact Description | What effect does the logic of merit have on the inner being's capacity to receive the word? |
| 23 | `Q023` | Section 2 — Word Impact Description | What effect does the logic of merit have on the inner being's capacity to extend the word to others? |
| 24 | `Q024` | Section 2 — Word Impact Description | What is the inner-being condition of the person who has received the word but failed to recognise it? |
| 25 | `Q025` | Section 2 — Word Impact Description | What inner-being experience cultivates the capacity to extend the word to others? |
| 26 | `Q026` | Section 2 — Word Impact Description | What inner-being posture does the act of earnest appeal express? |
| 27 | `Q027` | Section 2 — Word Impact Description | What somatic forms does the inner act of seeking the word take? |
| 28 | `Q028` | Section 2 — Word Impact Description | What inner-being orientation closes off the reception of the word? |
| 29 | `Q029` | Section 2 — Word Impact Description | What relational orientation toward others diminishes the operation of the word? |
| 30 | `Q030` | Section 2 — Word Impact Description | What is the relationship between the word and conditions of weakness in the inner being? |

_… and 176 more universal questions (full set in `wa_obs_question_catalogue`)._

---

## M. Readiness Verification

- **Generated at:** `2026-04-26T17:57:26Z`
- **Schema version:** `3.16.1`
- **OWNER term md_versions present:** `[2]`
