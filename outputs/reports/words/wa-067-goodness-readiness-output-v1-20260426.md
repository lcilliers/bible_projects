# wa-067-goodness — Analysis Readiness Output

_Pilot generation · v1 · 2026-04-26T14:48:08Z · schema 3.16.1_

_Strategy: vc-corrective-strategy-v2 §4 · pilot per execution-roadmap step 2_
...
- **carry_forward:** `1`
- **phase1_status:** `Complete` (phase1_term_count=45, phase1_verse_count=2216)

---

## 2. Term inventory — OWNER terms (3 total: 3 v3-confirmed, 0 legacy-VC)

| strongs | translit | gloss | lang | status | vc_status | md_v | verses | groups (a/d) | vc_rows (rel/sa) |
|---|---|---|---|---|---|---:|---:|---:|---|
| `H2896A` | tov | pleasant | H | `extracted_thin` | **`vc_completed`** | 2 | 306 | 9/0 | 230/75 |
| `G0019` | agathōsunē | goodness | G | `extracted` | **`vc_completed`** | 2 | 4 | 1/0 | 4/0 |
| `G5544` | chrēstotēs | kindness | G | `extracted` | **`vc_completed`** | 2 | 7 | 2/0 | 7/0 |

---

## 3. Legacy-VC terms — UNVERIFIED UNDER v3 CONTRACTS

**No legacy-VC terms in this registry.** All OWNER terms are at `vc_status='vc_completed'` — classifications were performed under v3_x contracts.

---

## 4. v3-confirmed terms (3)

Trusted within v3 grouping doctrine. Materiality protocol does not apply.

#### `H2896A` — tov "pleasant"

- **mti_term_id:** `884` · **language:** Hebrew · **status:** `extracted_thin`
- **vc_status:** `vc_completed` · **md_version:** `2`
- **Verses:** 306 active, 0 deleted
- **Active groups:** 9 · dissolved: 0
- **verse_context rows:** 306 active (230 relevant · 75 set-aside)

**Active groups:**

- `884-001` — 22 relevant · 2 anchor verse(s)
...
- `884-002` — 39 relevant · 1 anchor verse(s)
...
- `884-003` — 36 relevant · 1 anchor verse(s)
...
- `884-004` — 42 relevant · 2 anchor verse(s)
...
- `884-005` — 17 relevant · 1 anchor verse(s)
...
- `884-006` — 22 relevant · 1 anchor verse(s)
...
- `884-007` — 7 relevant · 1 anchor verse(s)
...
- `884-008` — 40 relevant · 1 anchor verse(s)
...
- `884-009` — 5 relevant · 1 anchor verse(s)
...
- **vc_status:** `vc_completed` · **md_version:** `2`
- **Verses:** 4 active, 0 deleted
- **Active groups:** 1 · dissolved: 0
- **verse_context rows:** 4 active (4 relevant · 0 set-aside)

**Active groups:**

- `885-001` — 4 relevant · 1 anchor verse(s)
...
- **vc_status:** `vc_completed` · **md_version:** `2`
- **Verses:** 7 active, 0 deleted
- **Active groups:** 2 · dissolved: 0
- **verse_context rows:** 7 active (7 relevant · 0 set-aside)

**Active groups:**

- `886-001` — 3 relevant · 1 anchor verse(s)
...
- `886-002` — 4 relevant · 1 anchor verse(s)
...
## 6. Open flags carried forward (1)
...
## 7. Verbatim verse text — all OWNER terms

Each verse listed with its current verse_context state (group_code, relevance, set-aside reason, anchor designation). This is the analyst's primary text source — DB consultation is not needed for verse text.

### `H2896A` — tov "pleasant" (306 classified / 306 verses)

**Group `884-001`** (22 verses)
...
### `G0019` — agathōsunē "goodness" (4 classified / 4 verses)

**Group `885-001`** (4 verses)
...
### `G5544` — chrēstotēs "kindness" (7 classified / 7 verses)

**Group `886-001`** (3 verses)
...
- **Generated at:** `2026-04-26T14:48:08Z`
...
- Researcher fields preserved (inference_note / word_synopsis): none — researcher narrative absent

**Notes / concerns:**
- session_b_status is 'Verse Context Reset' — this registry is in the reset cohort and should not be processed under v2 lighter-touch path.

---

*End of readiness output — wa-067-goodness.*