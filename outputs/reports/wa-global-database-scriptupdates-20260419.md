...
| `data/schema/create_tables.sql` | Regenerated from post-migration DB | Canonical DDL reflects target state; prior preserved as `.pre_DBR_bak` |
...
| `data/file_manifest.json` | Rebuilt (2678 files, 1938 active, 740 archived) | Phase F.2 manifest refresh |
...
- `data/imports/WA/Patches/**/*.json` — historical patches; immutable per DBR-12.
