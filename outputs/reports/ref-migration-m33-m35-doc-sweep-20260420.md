...
- `data/exports/reference/wa-reference-snapshot-20260420.json` — full L1 + L2 index + schema
- `data/exports/reference/wa-reference-snapshot-20260420.md` — human-readable view
