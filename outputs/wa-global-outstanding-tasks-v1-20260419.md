...
## Task OT-DBR-007 — `data/schema/create_tables.sql` consumer validation
...
**Source:** Action Q Path 1 investigation — `outputs/investigations/action-q-path1-investigation-20260420.md`
