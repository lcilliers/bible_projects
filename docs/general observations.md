...
it seems that filing in zotero attachments is not working as expected. I added two new command line options to list and download attachments, but I haven't implemented the functionality yet. I need to write the code to handle these options and interact with the Zotero API to retrieve the necessary information.
