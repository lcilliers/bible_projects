# WA Global Rules Extract — 2026-04-27

_Schema 3.17.0 · extractor v1.0_
...
The obslog and its companion session log are written to `Sessions/Session_B/09_Analysis_output_logs/` — the home for word-analysis outputs. This folder is the canonical destination for any analytical artefact produced during a Session B analytical pass, including obslogs, session logs, and pre-Architecture-v2 word-analysis `.md` files. The `Sessions/Patches/` folder is reserved for JSON patches only and must not receive obslog or analysis-output files.
...
---
*Generated 2026-04-27T09:34:32Z.*