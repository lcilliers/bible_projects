...
**After:** "CANONICAL SOURCE: DB `wa_vocab_set.DIMENSION_LABEL` (M32 2026-04-20)" — doc-to-DB pointer. Added: "AI sessions should consume this via the reference snapshot (`Workflow/reference/wa-reference-snapshot-{YYYYMMDD}.json`)". Mirrored table remains inline for reference but is marked as derived (DB wins on divergence).
...
- `Workflow/reference/wa-reference-snapshot-20260420.json` — full snapshot
- `Workflow/reference/wa-reference-snapshot-20260420.md` — human-readable MD view
...
Per `research/investigations/reference-as-database-framework-execution-20260420.md` §2:
