...
Version 1_1 | 20260418 | Status: Active — GR-REF-002 sweep applied**

| **Document** | **Value** |
|---|---|
| Filename | wa-sessionb-analysis-output-v1_1-20260418.md |
| Supersedes | wa-sessionb-analysis-output-v1-20260416.md (new document in v1; v1_1 applies GR-REF-002 sweep). Prior: wa-global-sessionb-instruction-v5_0-20260415.md (Stage 2 and Stage 3) |
| Companion documents | wa-global-general-rules [current] │ wa-reference [current] │ wa-claudecode-instruction [current] │ wa-patch-instruction [current] │ wa-directive-instruction [current] │ wa-sessionc-instruction [current] |
...
| Prerequisite | wa-sessionb-analysis-readiness [current] Stage 1 complete; Stage 1 Completion Record produced |
