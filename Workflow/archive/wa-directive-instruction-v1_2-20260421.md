# wa-directive-instruction-v1_2-20260421

> Framework B Soul Word Analysis Programme — Directive Preparation and Execution
> Version: v1_2 | Date: 20260421
> Supersedes: wa-directive-instruction-v1_1-20260418.md (v1_0 consolidated addenda; v1_1 applied GR-REF-002 sweep; v1_2 adds §10 Schema enablement directives with programme-wide prose worked pattern)
...
- **Schema enablement** — preparing the DB for a class of patches that the current schema cannot accept (see §10)
...
- A **PROSE patch** with `registry_id = NULL` to populate the programme-stage sections
...
*wa-directive-instruction-v1_2-20260421 | Supersedes wa-directive-instruction-v1_1-20260418 | Prior (v1_1): GR-REF-002 sweep | Prior (v1_0): consolidated global rules addenda ADD-PATCHDIR-002, -003, -005, -006, -008, -009 | Resolved addendum ADD-PATCHDIR-002 (directive peer specification) | v1_2 adds §10 Schema enablement directives (worked pattern: programme-wide prose)*
