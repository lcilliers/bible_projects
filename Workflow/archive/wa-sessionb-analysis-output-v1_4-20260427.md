...
Version 1_4 | 20260427 | Status: Active — Session-start inputs aligned with readiness v1_9 + catalogue count current**

| **Document** | **Value** |
|---|---|
| Filename | wa-sessionb-analysis-output-v1_4-20260427.md |
| Supersedes | wa-sessionb-analysis-output-v1_3-20260427.md (refresh of "What to Attach at Session Start" for Architecture v2; catalogue count corrected; validation report added as input) |
...
*wa-sessionb-analysis-output-v1_4-20260427.md*
*Framework B — Soul Word Analysis Programme*
*Supersedes wa-sessionb-analysis-output-v1_3-20260427.md (session-start inputs aligned with readiness v1_9; catalogue count corrected; What-to-Attach refreshed for v2)*
