# wa-sessionb-cluster-instruction-v2_1-20260516

> Framework B Soul Word Analysis Programme — Session B Cluster Analysis
> Version: v2_1 | Date: 20260516
...
> Supersedes: wa-sessionb-cluster-instruction-v2_0-20260515 (archived to `Workflow/archive/`)
...
Note: status column is free-text TEXT, no enum; `routed_cluster` is a new value introduced in v2_1.
