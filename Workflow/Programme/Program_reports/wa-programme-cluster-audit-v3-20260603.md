...
**Generated:** 2026-06-03 — **v3** (read-only re-run AFTER M10b/M10c remediation + citation-extractor sweep across all 19). Engine: `scripts/audit_cluster_v1_20260601.py`. Spec: `Workflow/methodology/wa-cluster-audit-aspect-spec-v1-20260601.md`.

> Supersedes v2. Cumulative since v1: FLAG rescue (126→539), cluster_link (D2 cleared), orphan set-aside (30+72), M10c + M10b A7 dispositions, citation extractor re-run on all started clusters (B6/B7). Remaining FAILs = fresh COMMENT_EVALUATION (A6/A7) + B1a/B1b backfill + M11/M38 re-analysis. See the apply-logs in research/investigations/.
...
| B6 | Phase D: citation traceability | B | STRUCT | PASS | 824 | 824 finding_citation rows |
...
| A6 | gating flags resolved (registry→cluster, non-excl) | A | GATE | FAIL | 73 | SD_POINTER: 48<br>SB_FINDING: 24<br>PH2_DATA_ERROR: 1 |
| A7 | no stray Session-B findings | A | GATE | FAIL | 70 | 70 pending/open SB findings (term→sub-group) |
| A8 | actionable observations confirmed | A | GATE | PASS | 0 |  |
...
| B5 | every active VCG has an anchor verse | B | GATE | PASS | 0 | 0 active VCGs without an anchor |
| B6 | Phase D: citation traceability | B | STRUCT | PASS | 5761 | 5761 finding_citation rows |
...
| D1 | new terms to place (cluster_code set, no sub-group) | D | INCR | PASS | 0 | 0 terms to place into a sub-group + analyse |
| D2 | unallocated pointers routed here | D | INCR | PASS | 183 | 0 findings + 183 flags to adopt into findings |
...
| A5 | BOUNDARY_DECISION_PENDING resolved | A | GATE | PASS | 0 |  |
| A6 | gating flags resolved (registry→cluster, non-excl) | A | GATE | FAIL | 7 | SD_POINTER: 6<br>PH2_CROSS_REGISTRY_REQUIRED: 1 |
| A7 | no stray Session-B findings | A | GATE | FAIL | 6 | 6 pending/open SB findings (term→sub-group) |
| A8 | actionable observations confirmed | A | GATE | PASS | 0 |  |
...
| B6 | Phase D: citation traceability | B | STRUCT | PASS | 1234 | 1234 finding_citation rows |
...
| B5 | every active VCG has an anchor verse | B | GATE | PASS | 0 | 0 active VCGs without an anchor |
| B6 | Phase D: citation traceability | B | STRUCT | PASS | 2899 | 2899 finding_citation rows |
| B7 | every anchor verse covered in findings | B | GATE | FAIL | 4 | 4 anchor verses not cited in any finding |
| C1 | old-format VCGs dissolved | C | STRUCT | PASS | 0 | 0 active old-format VCGs tied to cluster terms (dissolve at Phase C) |
...
| A4 | BOUNDARY sub-group empty | A | GATE | PASS | 0 | no BOUNDARY sub-group |
| A5 | BOUNDARY_DECISION_PENDING resolved | A | GATE | PASS | 0 |  |
| A6 | gating flags resolved (registry→cluster, non-excl) | A | GATE | FAIL | 7 | SD_POINTER: 6<br>PH2_DATA_ERROR: 1 |
| A7 | no stray Session-B findings | A | GATE | FAIL | 9 | 9 pending/open SB findings (term→sub-group) |
| A8 | actionable observations confirmed | A | GATE | PASS | 0 |  |
| A9 | no orphan findings | A | INFO | PASS | 0 | 0 dangling findings |
| A10 | no open Session-D observations (Session D moot) | A | GATE | PASS | 0 |  |
...
| B5 | every active VCG has an anchor verse | B | GATE | PASS | 0 | 0 active VCGs without an anchor |
| B6 | Phase D: citation traceability | B | STRUCT | PASS | 4114 | 4114 finding_citation rows |
...
| A7 | no stray Session-B findings | A | GATE | FAIL | 183 | 183 pending/open SB findings (term→sub-group) |
| A8 | actionable observations confirmed | A | GATE | PASS | 0 |  |
| A9 | no orphan findings | A | INFO | PASS | 0 | 0 dangling findings |
| A10 | no open Session-D observations (Session D moot) | A | GATE | PASS | 0 |  |
...
| A4 | BOUNDARY sub-group empty | A | GATE | PASS | 0 | no BOUNDARY sub-group |
| A5 | BOUNDARY_DECISION_PENDING resolved | A | GATE | PASS | 0 |  |
| A6 | gating flags resolved (registry→cluster, non-excl) | A | GATE | FAIL | 24 | SD_POINTER: 22<br>PH2_DATA_ERROR: 1<br>PH2_CROSS_REGISTRY_REQUIRED: 1 |
...
| B5 | every active VCG has an anchor verse | B | GATE | PASS | 0 | 0 active VCGs without an anchor |
| B6 | Phase D: citation traceability | B | STRUCT | PASS | 15095 | 15095 finding_citation rows |
...
- **Cluster status (DB):** `Analysis Completed`
- **Outstanding:** **1 GATE-blocking** (B7); 1 advisory-review (A2)
...
| B5 | every active VCG has an anchor verse | B | GATE | PASS | 0 | 0 active VCGs without an anchor |
| B6 | Phase D: citation traceability | B | STRUCT | PASS | 5123 | 5123 finding_citation rows |
...
| A5 | BOUNDARY_DECISION_PENDING resolved | A | GATE | PASS | 0 |  |
| A6 | gating flags resolved (registry→cluster, non-excl) | A | GATE | FAIL | 30 | SD_POINTER: 23<br>PH2_DATA_ERROR: 5<br>SB_FINDING: 2 |
| A7 | no stray Session-B findings | A | GATE | FAIL | 30 | 30 pending/open SB findings (term→sub-group) |
| A8 | actionable observations confirmed | A | GATE | PASS | 0 |  |
| A9 | no orphan findings | A | INFO | PASS | 0 | 0 dangling findings |
| A10 | no open Session-D observations (Session D moot) | A | GATE | PASS | 0 |  |
...
| B5 | every active VCG has an anchor verse | B | GATE | FAIL | 3 | 3 active VCGs without an anchor |
| B6 | Phase D: citation traceability | B | STRUCT | PASS | 1463 | 1463 finding_citation rows |
| B7 | every anchor verse covered in findings | B | GATE | FAIL | 4 | 4 anchor verses not cited in any finding |
...
| D1 | new terms to place (cluster_code set, no sub-group) | D | INCR | PASS | 0 | 0 terms to place into a sub-group + analyse |
| D2 | unallocated pointers routed here | D | INCR | PASS | 6 | 0 findings + 6 flags to adopt into findings |
...
| A4 | BOUNDARY sub-group empty | A | GATE | PASS | 0 | no BOUNDARY sub-group |
| A5 | BOUNDARY_DECISION_PENDING resolved | A | GATE | PASS | 0 |  |
| A6 | gating flags resolved (registry→cluster, non-excl) | A | GATE | FAIL | 36 | SD_POINTER: 33<br>SB_FINDING: 1<br>PH2_DATA_ERROR: 1<br>PH2_CROSS_REGISTRY_REQUIRED: 1 |
| A7 | no stray Session-B findings | A | GATE | FAIL | 48 | 48 pending/open SB findings (term→sub-group) |
| A8 | actionable observations confirmed | A | GATE | PASS | 0 |  |
| A9 | no orphan findings | A | INFO | PASS | 0 | 0 dangling findings |
| A10 | no open Session-D observations (Session D moot) | A | GATE | PASS | 0 |  |
...
| B6 | Phase D: citation traceability | B | STRUCT | PASS | 1019 | 1019 finding_citation rows |
...
| A4 | BOUNDARY sub-group empty | A | GATE | PASS | 0 | no BOUNDARY sub-group |
| A5 | BOUNDARY_DECISION_PENDING resolved | A | GATE | PASS | 0 |  |
| A6 | gating flags resolved (registry→cluster, non-excl) | A | GATE | FAIL | 142 | SD_POINTER: 87<br>SB_FINDING: 54<br>PH2_DATA_ERROR: 1 |
| A7 | no stray Session-B findings | A | GATE | FAIL | 214 | 214 pending/open SB findings (term→sub-group) |
| A8 | actionable observations confirmed | A | GATE | PASS | 0 |  |
...
| B5 | every active VCG has an anchor verse | B | GATE | PASS | 0 | 0 active VCGs without an anchor |
| B6 | Phase D: citation traceability | B | STRUCT | PASS | 715 | 715 finding_citation rows |
...
| D1 | new terms to place (cluster_code set, no sub-group) | D | INCR | PASS | 1 | 1 terms to place into a sub-group + analyse |
| D2 | unallocated pointers routed here | D | INCR | PASS | 21 | 0 findings + 21 flags to adopt into findings |
...
| A4 | BOUNDARY sub-group empty | A | GATE | PASS | 0 | no BOUNDARY sub-group |
| A5 | BOUNDARY_DECISION_PENDING resolved | A | GATE | PASS | 0 |  |
| A6 | gating flags resolved (registry→cluster, non-excl) | A | GATE | FAIL | 27 | SD_POINTER: 26<br>PH2_DATA_ERROR: 1 |
...
| B6 | Phase D: citation traceability | B | STRUCT | PASS | 889 | 889 finding_citation rows |
...
| B6 | Phase D: citation traceability | B | STRUCT | PASS | 846 | 846 finding_citation rows |
...
| A4 | BOUNDARY sub-group empty | A | GATE | PASS | 0 | no BOUNDARY sub-group |
| A5 | BOUNDARY_DECISION_PENDING resolved | A | GATE | PASS | 0 |  |
| A6 | gating flags resolved (registry→cluster, non-excl) | A | GATE | FAIL | 37 | SD_POINTER: 30<br>PH2_DATA_ERROR: 3<br>PH2_THEOLOGICAL_DEPTH_REQUIRED: 1<br>PH2_EXEGETICAL_STUDY_REQUIRED: 1<br>PH2_ESCHATOLOGICAL_STUDY_REQUIRED: 1<br>PH2_CROSS_REGISTRY_REQUIRED: 1 |
...
| B5 | every active VCG has an anchor verse | B | GATE | PASS | 0 | 0 active VCGs without an anchor |
| B6 | Phase D: citation traceability | B | STRUCT | PASS | 514 | 514 finding_citation rows |
| B7 | every anchor verse covered in findings | B | GATE | PASS | 0 | 0 anchor verses not cited in any finding |
...
| A4 | BOUNDARY sub-group empty | A | GATE | PASS | 0 | no BOUNDARY sub-group |
| A5 | BOUNDARY_DECISION_PENDING resolved | A | GATE | PASS | 0 |  |
| A6 | gating flags resolved (registry→cluster, non-excl) | A | GATE | FAIL | 162 | SD_POINTER: 105<br>SB_FINDING: 53<br>PH2_DATA_ERROR: 4 |
| A7 | no stray Session-B findings | A | GATE | FAIL | 327 | 327 pending/open SB findings (term→sub-group) |
| A8 | actionable observations confirmed | A | GATE | PASS | 0 |  |
...
| B5 | every active VCG has an anchor verse | B | GATE | FAIL | 1 | 1 active VCGs without an anchor |
| B6 | Phase D: citation traceability | B | STRUCT | PASS | 702 | 702 finding_citation rows |
...
| D1 | new terms to place (cluster_code set, no sub-group) | D | INCR | PASS | 2 | 2 terms to place into a sub-group + analyse |
| D2 | unallocated pointers routed here | D | INCR | PASS | 31 | 0 findings + 31 flags to adopt into findings |
...
| A4 | BOUNDARY sub-group empty | A | GATE | PASS | 0 | no BOUNDARY sub-group |
| A5 | BOUNDARY_DECISION_PENDING resolved | A | GATE | PASS | 0 |  |
| A6 | gating flags resolved (registry→cluster, non-excl) | A | GATE | FAIL | 60 | SD_POINTER: 42<br>SB_FINDING: 18 |
| A7 | no stray Session-B findings | A | GATE | PASS | 0 | 0 pending/open SB findings (term→sub-group) |
| A8 | actionable observations confirmed | A | GATE | PASS | 0 |  |
| A9 | no orphan findings | A | INFO | PASS | 0 | 0 dangling findings |
...
| D2 | unallocated pointers routed here | D | INCR | PASS | 4 | 0 findings + 4 flags to adopt into findings |
...
|---|---|---|---|--:|--:|--:|--:|--:|
| M03 | Grief | Analysis Completed | FAIL | 5 | 0 | 1 | 0 | 2 |
| M04 | Joy | Analysis Completed | FAIL | 5 | 0 | 1 | 0 | 183 |
| M06 | Hate | Analysis Completed | FAIL | 7 | 2 | 1 | 0 | 1 |
| M07 | Shame | Analysis Completed | FAIL | 5 | 0 | 1 | 0 | 1 |
| M08 | Pride | Analysis Completed | FAIL | 4 | 0 | 1 | 0 | 0 |
| M09 | Humility | Analysis Completed | FAIL | 4 | 0 | 1 | 0 | 0 |
| M10 | Sin | Analysis Completed | FAIL | 5 | 0 | 0 | 0 | 2 |
| M10b | Wickedness | Analysis Completed | FAIL | 1 | 0 | 1 | 0 | 0 |
| M10c | Defilement | Analysis Completed | PASS | 0 | 0 | 1 | 0 | 0 |
| M15 | Wisdom | Analysis Completed | FAIL | 7 | 1 | 0 | 0 | 6 |
| M26 | Righteousness | Analysis Completed | FAIL | 7 | 2 | 1 | 1 | 3 |
| M39 | Blessing | Analysis Completed | FAIL | 6 | 2 | 1 | 1 | 21 |
| M46 | Abundance | Analysis Completed | FAIL | 6 | 2 | 1 | 0 | 10 |
| M01 | Fear | Analysis Completed (Terms Added) | FAIL | 4 | 2 | 2 | 2 | 1 |
| M02 | Anger | Analysis Completed (Terms Added) | FAIL | 5 | 2 | 1 | 1 | 0 |
| M20 | Doubt | Analysis Completed (Terms Added) | FAIL | 4 | 2 | 2 | 3 | 2 |
| M05 | Love | Ready for re-analysis | FAIL | 7 | 2 | 2 | 2 | 31 |
| M11 | Repentance | Structurally Ready | FAIL | 5 | 2 | 0 | 15 | 6 |
| M38 | Salvation | Structurally Ready | FAIL | 5 | 2 | 0 | 13 | 4 |

**PASS 1 · FAIL 18** of 19 started clusters.
...
| M03 | ADOPT | D2 unallocated pointers routed here (2) |
| M04 | CLEAR | A6 gating flags resolved (registry→cluster, non-excl) (73) |
| M04 | CLEAR | A7 no stray Session-B findings (70) |
...
| M04 | ADOPT | D2 unallocated pointers routed here (183) |
| M06 | CLEAR | A4 BOUNDARY sub-group empty (60) |
| M06 | CLEAR | A6 gating flags resolved (registry→cluster, non-excl) (7) |
| M06 | CLEAR | A7 no stray Session-B findings (6) |
...
| M08 | CLEAR | A6 gating flags resolved (registry→cluster, non-excl) (7) |
| M08 | CLEAR | A7 no stray Session-B findings (9) |
...
| M09 | CLEAR | A7 no stray Session-B findings (183) |
...
| M10 | CLEAR | A6 gating flags resolved (registry→cluster, non-excl) (24) |
| M10 | CLEAR | A7 no stray Session-B findings (41) |
...
| M15 | CLEAR | A6 gating flags resolved (registry→cluster, non-excl) (30) |
| M15 | CLEAR | A7 no stray Session-B findings (30) |
...
| M15 | ADOPT | D2 unallocated pointers routed here (6) |
| M26 | CLEAR | A6 gating flags resolved (registry→cluster, non-excl) (36) |
| M26 | CLEAR | A7 no stray Session-B findings (48) |
...
| M39 | CLEAR | A6 gating flags resolved (registry→cluster, non-excl) (142) |
| M39 | CLEAR | A7 no stray Session-B findings (214) |
...
| M39 | ADOPT | D2 unallocated pointers routed here (21) |
| M46 | CLEAR | A6 gating flags resolved (registry→cluster, non-excl) (27) |
| M46 | CLEAR | A7 no stray Session-B findings (35) |
...
| M20 | CLEAR | A6 gating flags resolved (registry→cluster, non-excl) (37) |
...
| M05 | CLEAR | A6 gating flags resolved (registry→cluster, non-excl) (162) |
| M05 | CLEAR | A7 no stray Session-B findings (327) |
...
| M05 | ADOPT | D2 unallocated pointers routed here (31) |
| M11 | RE-SUBMIT | A1 findings present (0) |
| M11 | RE-SUBMIT | A3 every characteristic has findings (5) |
| M11 | CLEAR | A6 gating flags resolved (registry→cluster, non-excl) (60) |
...
| M11 | ADOPT | D2 unallocated pointers routed here (6) |
| M38 | RE-SUBMIT | A1 findings present (0) |
| M38 | RE-SUBMIT | A3 every characteristic has findings (7) |
| M38 | CLEAR | A6 gating flags resolved (registry→cluster, non-excl) (24) |
...
| M38 | ADOPT | D2 unallocated pointers routed here (4) |
