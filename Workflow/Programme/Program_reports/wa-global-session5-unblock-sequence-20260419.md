...
| File | Contents |
|---|---|
| `Sessions/Session_B/04_dimension_review_process input/wa-dim-C01-extract-2026-04-19.json` | All 275 cluster groups with current dimension + confidence |
| `Sessions/Session_B/04_dimension_review_process input/wa-dim-C01-rootfamily-2026-04-19.json` | 61 root families (5 cross-registry) + 274 groups |
| `Sessions/Session_B/04_dimension_review_process input/wa-dim-C01-existing-pointers-2026-04-19.json` | 29 Session B findings + 37 Session D pointers for cross-reference |
