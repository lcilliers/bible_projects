# wa-sessionb-cluster-instruction-v2_4-20260517

> Framework B Soul Word Analysis Programme — Session B Cluster Analysis
> Version: v2_4 | Date: 20260517
...
> Supersedes: wa-sessionb-cluster-instruction-v2_3-20260517 (archived to `Workflow/archive/`)
...
### 8.6 Distribution hard gate (added 2026-05-17 amendment)
...
**Retrospective note (2026-05-17):** applied to closed clusters: M01 passes (35%), M03 passes (33%), M02 fails at 47% (closed before the gate was added; not re-opened), M04 fails at 81% (gate added during M04 Phase 7; rework decision pending researcher).
