...
| Design reference | research/investigations/wa-global-readiness-sweep-design-v1-20260419.md (APPROVED 2026-04-19) |
| Produced | 2026-04-19 |
...
- Sweep design doc (`research/investigations/wa-global-readiness-sweep-design-v1-20260419.md`) — confirmed APPROVED
...
| Per-registry remediation patch | `Sessions/Patches/wa-{nnn}-{word}-readinesssweep-v{n}-{YYYYMMDD}.json` |
| Per-registry sub-process directive(s) | `Sessions/Patches/wa-{nnn}-{word}-readinesssweep-dir-{seq}-{desc}-v{n}-{YYYYMMDD}.md` |
