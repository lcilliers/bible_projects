"""Build VCB-028 batch extract JSON.

Registries 187 (strength) + 196 (power) + 198 (might) + 200 (energy) — C20 remainder.
...
BATCH_ID = "VCB-028"
TODAY = "2026-04-06"
REGISTRY_FILTER = [187, 196, 198, 200]
...
outpath = os.path.join(
    ...
    f"wa-vcb-028-extract-{TODAY}.json",
)
