"""Append wa_verse_records WHERE term_id='H7965H' to inspect_peace_registry.md."""
import sqlite3
...
rows = con.execute(
    "SELECT * FROM wa_verse_records WHERE term_id = 'H7965H' ORDER BY id"
).fetchall()
con.close()
...
with open(OUT, "a", encoding="utf-8") as f:
    f.write(f"\n---\n\n## wa_verse_records — term_id='H7965H' (sha.lom)\n\n")
