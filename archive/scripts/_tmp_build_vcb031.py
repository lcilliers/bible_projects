"""Build VCB-031 batch extract — Registry 213 (listen)."""
...
outpath = os.path.join(os.path.dirname(__file__), "..", "data", "exports", "verse_context", f"wa-vcb-031-extract-{TODAY}.json")
