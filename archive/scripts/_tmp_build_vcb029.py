"""Build VCB-029 batch extract JSON.

Final mop-up batch — all 9 remaining In Progress registries.
201 (image), 202 (transformation), 203 (treachery), 206 (vulnerability),
207 (blindness), 208 (sloth), 209 (likeness), 211 (being), 212 (pray).
61 terms, ~504 verses.
"""
import sqlite3
import os
...
BATCH_ID = "VCB-029"
TODAY = "2026-04-06"
REGISTRY_FILTER = [201, 202, 203, 206, 207, 208, 209, 211, 212]
...
outpath = os.path.join(
    ...
    f"wa-vcb-029-extract-{TODAY}.json",
)
