"""Build VCB-025 batch extract JSON.

Registry 210 (deadness) — 12 OWNER terms, ~690 verses.
Single-registry batch, no prior classified terms.
"""
import sqlite3
import os
import json
...
outpath = os.path.join(
    ...
    f"wa-vcb-025-extract-{TODAY}.json",
)
