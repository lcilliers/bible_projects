...
Version 1.4 | 20260416 | Status: Active**

| **Document** | **Value** |
|---|---|
| Filename | wa-sessionb-analysis-readiness-v1_4-20260416.md |
| Supersedes | wa-sessionb-analysis-readiness-v1_3-20260416.md |
| Companion documents | wa-global-general-rules-v2_5-20260416.json │ wa-dimensionreview-instruction-v[current].md │ wa-versecontext-instruction-v[current].md │ wa-sessionb-cc-instructions-v[current].md │ wa-patch-specification-v[current].md |
...
Claude AI must confirm the global rules file has been loaded before beginning any work. State aloud: *"Global rules wa-global-general-rules-v2_5-20260416.json loaded."*
...
*wa-sessionb-analysis-readiness-v1_4-20260416.md*
*Framework B — Soul Word Analysis Programme*
