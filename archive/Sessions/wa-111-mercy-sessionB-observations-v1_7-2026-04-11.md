...
## Registry 111 — mercy
## Version: v1.7 (Stage 3 complete — Session C v2 produced; Session B complete)
## Date: 2026-04-11
...
## D1 RESULTS AND R2 SPOT-CHECK

**D1 application confirmed by Claude Code:**
- D1-001: 13/13 GOD_AS_SUBJECT flags inserted (mti_term_flags, flag_id=1). Verified.
- D1-002: FRAMEWORK_SIGNAL not in phase2_flag_types. Substituted THEOLOGICAL_ANCHOR (flag_id=13). 5 records inserted for G1656, G2433, G2434, G2435, H3727.
- D1-003: G2433 meaning_numbered updated. wa_meaning_sense now has 2 senses (middle/passive). meaning_numbered field populated with structured summary including classical note.

**Note on export serialisation:** The mti_term_flags are exported in the R2 extract as `mti.flags: [{flag_code: 'GOD_AS_SUBJECT'}]` rather than `{flag_id: 1}`. The spot-check logic was corrected accordingly. All 13 flags confirmed present.

**Note on FRAMEWORK_SIGNAL substitution:** THEOLOGICAL_ANCHOR (flag_id=13) was used in place of FRAMEWORK_SIGNAL. This is recorded here and will be reflected accurately in the D2 directive and the Session B analytical brief. The flag serves the same analytical purpose — signalling that the divine-human relationship shapes the spirit-soul-body classification.

**R2 spot-check results:**

| Check | Item | Result |
|---|---|---|
| 1 | GOD_AS_SUBJECT flag_code on 13 terms | ALL OK |
| 2 | THEOLOGICAL_ANCHOR flag on 5 terms | ALL OK |
| 3 | G2433 meaning_numbered — 2 senses set | OK |
| 4 | File size delta (+3,449 bytes from R1) | Consistent |
| 5 | active_term_count = 65 | OK |
| 6 | owner_term_count = 31 | OK |
| 7 | anchor_verse_count = 123 | OK |
| 8 | dim_review_status = Complete | OK |

**Result: ALL CHECKS PASS. R2 confirmed clean. Pass 4 may begin.**


---

## STAGE 2 — PASS 4: SOMATIC EVIDENCE AND SPIRIT-SOUL-BODY CLASSIFICATION
...
**Summary by term (verse count / somatic hits / %):**

| Term | Verses | Somatic | % | Primary somatic vocabulary |
|---|---|---|---|---|
| G0415 aneleēmōn | 1 | 1 | 100 | heartless (kardia) — Rom 1:31 |
| G1653 eleeō | 28 | 1 | 3 | heart (2Cor 4:1) |
| G1656 eleos | 26 | 3 | 11 | inner (Mat 9:13), spirit (Tit 3:5), blood (Rom 3:25 via hilastērios) |
| G2433 hilaskomai | 2 | 1 | 50 | eyes, breast, beat (Luk 18:13) |
| G2435 hilastērios | 2 | 1 | 50 | blood (Rom 3:25) |
| G3628 oiktirmos | 5 | 3 | 60 | body/bodies (Rom 12:1), heart (Col 3:12), spirit (Phili 2:1) |
| G3629 oiktirmōn | 2 | 1 | 50 | steadfast (Jam 5:11 — metaphorical) |
| H2603A cha.nan | 72 | 25 | 34 | face, eye/eyes, soul, fasting, weeping |
| H3722A kip.per | 93 | 23 | 24 | blood, hand, face, soul/flesh (Lev 17:11) |
| H3722B ka.phar | 93 | 23 | 24 | same as H3722A (shared verse corpus) |
| H3724A ko.pher | 13 | 1 | 7 | eye, hand (1Sa 12:3) |
| H3725 kip.pu.rim | 8 | 1 | 12 | blood (Exo 30:10) |
| H3727 kap.po.ret | 22 | 5 | 22 | blood (Lev 16:14), face (Exo 25:20/37:9 — cherubim faces) |
| H5750 od | 170 | 44 | 25 | face, heart, flesh, eye, hand, bow — wide range (high-frequency particle) |
| H6279 a.tar | 19 | 4 | 21 | face (Job 33:26), fasting (Ezr 8:23), hand (1Ch 5:20) |
| H8467 te.chin.nah | 24 | 8 | 33 | heart, hand/hands/stretched, eye/eyes |

**Zero somatic hits:** G0448, G0462 (1 weak), G1655, G2434, G2436, H2604, H3819, H7359, G3743

---

### 4b — Somatic Pattern Summary

**Body parts most associated with the mercy vocabulary:**

1. **Blood** — kip.per (H3722A/B), kap.po.ret (H3727), kip.pu.rim (H3725), hilastērios (G2435), ko.pher (H3724A). Blood is the *instrument* of atonement-mercy: life offered for life, covering guilt before God. Blood is the most consistent somatic element across the entire atonement sub-vocabulary.

2. **Face** — cha.nan (H2603A) in 5+ verses including Num 6:25 ("make his face shine... be gracious to you"), Gen 32:20 (Jacob appeasing Esau's face), Deu 28:50 (hard-faced mercilessness), Psa 67:1 (God's face shining). Also kap.po.ret's cherubim facing each other (Exo 25:20). The face is the primary spatial metaphor for mercy: the turned face (cha.nan) and the covered face (kip.per from Gen 32:20). Mercy is about face-direction — turned toward or turned away.

3. **Hand/hands** — kip.per (laying hand on offering head, Lev 1:4; anointing hand, Lev 14:18), te.chin.nah (stretched-out hands of supplication, 1Ki 8:38/54), ko.pher (hand receiving bribe, 1Sa 12:3). Hands are the *instrument* of both the offering act (kip.per) and the supplication posture (te.chin.nah). Hands bridge the physical and the relational.

4. **Soul/nephesh** — kip.per in Lev 17:11 ("blood makes atonement for the soul") and cha.nan in Psa 31:9 ("my soul and my body"), Gen 42:21. The soul is the *recipient* of atonement — the inner person whose standing before God is the target of the covering act.

5. **Eyes** — cha.nan (multiple: lifting eyes, gracious eyes), te.chin.nah ("let your eyes be open to the plea," 1Ki 8:52), ko.pher (bribe blinds eyes, 1Sa 12:3). Eyes figure in both mercy-granting (God's eyes open to supplication) and mercy-withholding (bribe blinds the judging eye).

6. **Heart** — cha.nan (Psa 31:9 — soul and body; 1Ki 8:47 — turning heart in captivity; 1Ki 9:3 — God has heard prayer, eyes and heart on the house), te.chin.nah (1Ki 8:38 — knowing the affliction of the heart), H5750/od (Gen 8:21 — God said in his heart). The heart appears as the site of the inner condition that requires mercy and the site of the inner transformation that mercy effects.

7. **Breast-beating / prostration** — G2433 hilaskomai (Luk 18:13 — the tax collector beats his breast, will not lift eyes to heaven). This is the most concentrated somatic mercy-seeking posture in the NT: three simultaneous body gestures (distance, downcast eyes, chest-beating) encoding total inner humility before God.

8. **Fasting/weeping** — cha.nan (2Sa 12:22 — David fasts and weeps seeking mercy; Isa 30:19 — weep no more, God will be gracious), a.tar (Ezr 8:23 — fasted and implored). Bodily self-denial and grief expression accompany mercy-seeking as somatic signs of the inner appeal posture.

**Somatic concentration pattern:**

The mercy vocabulary divides somatically into three registers:
- **Instrument register** (blood, hand, fire): the atonement sub-vocabulary (kip.per, kap.po.ret, hilastērios). The body and its products are the *instrument* through which atonement is effected. The somatic element is external to the inner person but acts on behalf of the inner person's moral condition.
- **Expression register** (face, eyes, breast-beating, fasting, weeping, stretched hands): the supplication and grace-seeking vocabulary (cha.nan, te.chin.nah, hilaskomai, a.tar). The body *expresses* the inner condition of need and dependence. The somatic element originates in the inner person and manifests outward.
- **Recipient register** (soul/nephesh, heart, inner person): primarily in the atonement and grace vocabulary. The inner person (soul, heart) is the *target* of mercy's action — the one for whom the covering is provided and in whom the transformation occurs.

**Dominant somatic pattern:** Mercy operates through the body at every level — as instrument, expression, and recipient. This is not incidental. The mercy vocabulary consistently presents the body as integral to the mercy transaction, not peripheral to it.

**SOMATIC_INNER_LINK assessment — terms warranting flag (flag_id = 3):**

Strong somatic link (body is central to the term's functional meaning):
- H3722A kip.per: blood/hand/soul — body is the instrument and recipient of atonement
- H3727 kap.po.ret: blood/face — blood on the mercy seat; cherubim faces
- H2603A cha.nan: face/eyes/soul/fasting/weeping — grace seeks and receives through face and body
- H8467 te.chin.nah: hand/heart/eyes — the supplication posture is inseparable from its somatic expression

**BODY_INNER_EXPRESSION assessment — terms warranting flag (flag_id = 4):**

Body expresses inner state:
- G2433 hilaskomai: eyes/breast/beating — the body enacts the inner appeal posture (Luk 18:13)
- G3628 oiktirmos: heart/body (Rom 12:1 — "present your bodies" as the mercy-response to God's oiktirmos; Col 3:12 — compassionate hearts as the garment of the new person)
- H2603A cha.nan: weeping/fasting as bodily expression of mercy-seeking

Directive for CC (DIR-002, D2 delivery):
- SOMATIC_INNER_LINK (flag_id=3): H3722A, H3727, H2603A, H8467
- BODY_INNER_EXPRESSION (flag_id=4): G2433, G3628, H2603A (both flags), H8467 (both flags)
...
- Mercy at its source is divine — originating in the divine inner character (eleos, oiktirmos, ra.cha.min). Human mercy participates in and reflects divine mercy.
- The core propitiation terms (hilaskomai, hilasmos, hilastērios, hileōs) name the mechanism by which the Spirit-level barrier (moral standing before God) is addressed.
- Tit 3:5 places mercy alongside the "renewing of the Holy Spirit" — mercy operates in the Spirit register in Paul's soteriology.
- The "spirit" hits in G3628 (oiktirmos) and G1656 (eleos) both occur in pneumatological contexts.
- Received mercy is ontological in 1Pe 2:10: having received mercy constitutes identity — this is spirit-level change, not merely emotional or relational.

*Soul-level indicators:*
- The mercy vocabulary is the most emotionally and relationally charged in the programme. eleos, oiktirmos, ra.cha.min all name felt compassion — the inner affective movement toward the one in need. This is the soul's register.
- The supplication vocabulary (cha.nan, te.chin.nah, a.tar) names the inner act of appealing from felt need — deeply relational, personal, and emotional.
- The mercy-seeing / mercy-refusing dynamic (Mat 18:33, Jam 2:13) operates at the level of the will and affections — the soul deciding toward or away from mercy.

*Body-level indicators:*
- The atonement sub-vocabulary operates through bodily instruments (blood, laying of hands, sprinkling).
- The supplication posture (Luk 18:13, 1Ki 8:38) is inseparably somatic.
- The face vocabulary throughout cha.nan makes mercy a relational-spatial concept that involves physical orientation.

**Assessment:**

Mercy as a characteristic of the human person operates primarily at the **spirit-soul interface**:
- At the spirit level, it is received — mercy is a gift from the divine source, not self-generated. The propitiation complex describes what must happen at the spirit level (moral standing before God) for mercy to be fully operative.
- At the soul level, it is expressed — mercy is felt as compassion toward the other, directed in supplication toward God, and enacted in concrete acts of favour toward those in need.
- At the body level, it is mediated — mercy uses the body as instrument (atonement blood), expression (supplication posture), and recipient (soul/nephesh addressed by the atoning blood).

**Provisional classification: Spirit-soul interface**

- Mercy is received at spirit level (from God, through the propitiation mechanism) and expressed at soul level (compassion, favour, relational grace toward others).
- The body mediates both directions: the atoning blood provides the spirit-level covering; the supplication posture expresses the soul-level appeal.
- This classification is provisional. The strong somatic dimension means the body is not incidental, and the classification may need to be revised to Trichotomy-spanning after Pass 5 (language accuracy) and Pass 6 (correlation audit) provide further data.

**Confidence level: Medium**
- The spirit-soul interface classification is well-supported by the divine origination of mercy and the soul-level emotional-relational expression.
- The trichotomy-spanning alternative is plausible given the depth of somatic involvement, particularly in the atonement sub-vocabulary.
- The question for further examination: does the atonement mechanism operate at the body level independently, or is it instrumental to a spirit-level transaction? If instrumental, spirit-soul interface holds. If the body is itself transformed by atonement, trichotomy-spanning may be more accurate.

**Directives for D2 (Pass 4 → D2):**
- DIR-002-A: SOMATIC_INNER_LINK (flag_id=3): term_inv_ids for H3722A (3304), H3727 (1042), H2603A (1045), H8467 (1050) — confirm H8467 term_inv_id
- DIR-002-B: BODY_INNER_EXPRESSION (flag_id=4): term_inv_ids for G2433 (3311), G3628 (1057), H2603A (1045), H8467 (1050)
- DIR-002-C: sb_classification = 'Spirit-soul interface' on word_registry (no = 111)
- DIR-002-D: sb_classification_reasoning = 'Mercy is received at spirit level (divine gift, propitiation mechanism) and expressed at soul level (compassion, favour, relational grace). Body mediates both directions through atonement blood (instrument) and supplication posture (expression). Confidence: medium — trichotomy-spanning alternative noted for Pass 6 review.'

**Session C check:** Section 1 states mercy "comes from" an ambiguous source ("self-generated, received, developed"). The spirit-soul interface classification suggests a more precise answer: mercy at its source is received at the spirit level (from God); it is expressed at the soul level and mediated through the body. Section 1 should be updated in v2 to reflect this.

**Cross-registry (2.0a) — somatic observations:**
- The blood-atonement somatic pattern (kip.per + kap.po.ret + hilastērios) connects to flesh (Reg 185) through the blood-as-life vocabulary of Lev 17:11. The flesh and blood vocabulary of the atonement complex directly overlaps with the Flesh registry's core material.
- The face vocabulary in cha.nan (turned face = grace) connects to the divine-presence and glory vocabulary. Face-direction as the spatial metaphor for relational mercy has cross-registry implications.
- The supplication posture (Luk 18:13: distance + downcast eyes + breast-beating) as a composite somatic mercy-seeking pattern — this same posture likely appears in the repentance and humility registries.

SD POINTER: The blood-atonement somatic vocabulary (H3722A kip.per + H3727 kap.po.ret + G2435 hilastērios) represents the most concentrated overlap between mercy and the flesh/body registries. Session D should examine whether the mercy-through-blood mechanism reflects a structural relationship between mercy, body, and the atonement of the flesh-condition.

---

PASS 4 COMPLETE
Date: 2026-04-11
Somatic scan complete. Spirit-soul interface classification assigned (medium confidence). DIR-002 (SOMATIC flags + sb_classification) captured for D2 delivery after Pass 6.
Observations log version increments to v1.4 at Pass 4 boundary.


---

## STAGE 2 — PASS 5: LANGUAGE ACCURACY AUDIT (Section 4)

**Date:** 2026-04-11

### 5a — Accuracy audit

**Occurrence counts — all verified:**
- G1656 eleos 240: OK
- G1653 eleeō 131: OK
- G1655 eleēmōn 20: OK
- G3628 oiktirmos 36: OK
- G2433 hilaskomai 15: OK
- H3722A kip.per 102: OK
- H2603A cha.nan 81: OK

**Term counts and sharing claims — all verified:**
- 67 total terms (48 Hebrew, 19 Greek): OK
- 31 owner / 34 XREF: OK
- Sharing ratio 0.71 (actual 0.708 — rounds to 0.71): OK
- Compassion 38 shared / pray 14 / love 13 / grace 10: all OK

**H3722B ka.phar anomaly noted and resolved:**
- STEP occurrence count = 1 (genuine — only Gen 6:14 uses H3722B)
- Extract verse count = 93 — these are the shared verse corpus from the kap.har root family, classified in VC under the same groups as H3722A
- This is correct programme design: H3722B shares the root-family verse corpus
- Session C Section 4 correctly describes H3722B as contributing etymological depth without independent inner-being analysis
- No correction required

**G8849 polueleos — confirmed not in Section 4:** OK. The deletion (confirmed in Stage 1) means G8849 is correctly absent from Section 4. No reference to it exists. No correction needed.

### 5b — Completeness audit

**Missing from Section 4:**

1. **LXX bridge for eleos:** Section 4 correctly states that eleos translates chesed and rachamim in the Septuagint (which is why it carries covenantal weight in the NT). However, the specific LXX bridge is not explicitly stated — only implied. For v2, add: "*eleos* is the primary Greek translation of *chesed* and *rachamim* in the Septuagint — this is why the NT mercy vocabulary carries the full weight of OT covenantal love. The Greek term inherits the Hebrew theological depth."

2. **oiktirmos/oiktirmōn root relationship not stated:** Section 4 treats oiktirmos and oiktirmōn as separate terms but does not explicitly name them as noun and adjective of the same root (oiktirō = to pity). For v2, add the root connection explicitly.

3. **H2603A cha.nan related words — "for nothing" (chinnam):** The related words list includes "for nothing" (*chinnam* — H2600 in XREF), which derives from the cha.nan root and means "without cause, gratis, freely." This is the word Job 2:3 uses — "destroy him without reason." The root connection between "grace freely given" (*cha.nan*) and "without cause/gratis" (*chinnam*) is a semantic observation not in Section 4. Confirmed from Pass 3 SD pointer. For v2, add this.

4. **H3727 kap.po.ret — divine speech function not fully developed:** Section 4 describes the mercy seat spatially (dimensions, golden cover, location of blood-sprinkling) but the divine speech function (Exo 25:22 — "from above the mercy seat I will speak") is underplayed. For v2, deepen.

5. **G3743 hosiōs and G0462 anosios — classical opposition not noted:** LSJ confirms these as direct semantic opposites in classical Greek, paired with *dikaios/adikos* as the two axes of moral order (divine law + human law). Section 4 does not mention this classical pairing. Minor addition for v2.
...
TERM: G1656 eleos
TYPE: addition
ANNOTATION: eleos is the primary LXX translation of both chesed (steadfast love) and rachamim 
(womb-compassion). This Septuagint bridging function is why NT eleos carries the full weight of 
OT covenantal mercy — it inherits both the covenant-loyalty dimension of chesed and the visceral 
compassion dimension of rachamim.
SESSION C FLAG: add to Section 4 opening paragraph on eleos

TERM: G3628 oiktirmos / G3629 oiktirmōn
TYPE: addition
ANNOTATION: oiktirmos (noun) and oiktirmōn (adjective) derive from oiktirō (to pity, show 
compassion — LSJ from 5th c. BC). The noun-adjective pair names the same quality as abstract 
character and as personal trait. The verb root oiktirō appears in Rom 9:15 ("I will have 
compassion on whom I have compassion") alongside eleeō — the two roots appearing together in 
the divine sovereignty statement confirms their close semantic relationship.
SESSION C FLAG: add to Section 4 oiktirmos description

TERM: H2603A cha.nan
TYPE: addition
ANNOTATION: The related word "for nothing" (chinnam, H2600) derives from the same cha.nan root 
and means "without cause, gratis, freely." This etymological connection between grace-freely-
given (cha.nan) and suffering-without-cause (chinnam in Job 2:3 — "destroy him without reason") 
is theologically suggestive. The gratuitousness is shared — mercy is given freely; Job's 
affliction comes freely. Session D pointer raised.
SESSION C FLAG: add to Section 4 cha.nan description

TERM: H3727 kap.po.ret
TYPE: deepening
ANNOTATION: The mercy seat is not only the place of atonement but the place of divine speech 
(Exo 25:22 — "from above the mercy seat I will speak"). Mercy and revelation share a location. 
God communicates from the mercy seat — making mercy the architectural ground of divine-human 
communication in the tabernacle. This is a significant theological observation underplayed in 
the current description.
SESSION C FLAG: deepen Section 4 kap.po.ret description
```

**Session C check — Pass 5:** Section 4 is largely accurate, well-constructed, and within the 700–1100 word range (actual ~1100 words). Four additions/deepenings identified above. No corrections required — no inaccurate statements found. The synthesis observation is analytically sound and supported by the data.

**Cross-registry (2.0a) — Pass 5 additions:**
- The LXX bridge for eleos (translating both chesed and rachamim) formally connects Reg 111 to Reg 103 (love, chesed family) and Reg 23 (compassion, rachamim family) through the Greek term. This is a multi-registry linguistic bridge not yet captured as a formal connection. Session D pointer: the LXX translation of chesed and rachamim by a single Greek term (eleos) — does this linguistic unification in the LXX encode a theological claim that mercy, covenant love, and womb-compassion are one reality at the deepest level?

---

PASS 5 COMPLETE
Date: 2026-04-11
Section 4 confirmed accurate. Four additions/deepenings identified for v2 update. No corrections required.
Observations log version increments to v1.5 at Pass 5 boundary.


---

## STAGE 2 — PASS 6: CORRELATION AUDIT AND CONNECTION VERIFICATION

**Date:** 2026-04-11

### Correlation signals read

**Data gaps noted (consistent with Stage 1 findings):**
- verse_cooccurrence (90 pairs): registry_no null on all records — usable only for aggregate count (90 co-occurring registries confirmed); specific registry identities not available from this export
- shared_anchor_verses (28 pairs): same null issue — registry identities not available

These gaps do not prevent Pass 6 from completing — the xref_sharing and dimension_overlap signals provide the primary connection data. The verse_cooccurrence and shared_anchor signals are noted as confirmatory signals that exist but cannot be read at registry level.

---

### Connection verification — all signals audited

**For each connection: signal evidence, SD pointer status (raised / not yet / gap-fill)**

---

**Reg 23 Compassion (C17)** — HIGHEST PRIORITY
- xref_sharing: 38 shared terms — strongest signal in registry
- dimension_overlap: 4 dimensions shared (Dependence/Creatureliness, Divine-Human Correspondence, Moral Character, Relational Disposition) — complete dimensional overlap
- root_families: ATAR root shared (H6279 + H6282A/B — prayer root)
- ELE root gap noted (CI-001): Reg 23 does not carry ELE root records; correlation signal suppressed until resolved
- SD pointer: raised (Pass 1 — are mercy and compassion structurally synonymous at the divine level?; Pass 2 — mercy-compassion parallel in Rom 9:15; Pass 5 — LXX bridge connecting eleos to both chesed and rachamim)
- **Status: COVERED — multiple pointers**

**Reg 212 Pray (C15)**
- xref_sharing: 14 shared terms (cha.nan, te.chin.nah, a.tar families)
- Dimensional overlap: not in top-17 — different dimension profile (prayer is primarily Spiritual/God-ward and Dependence/Creatureliness)
- SD pointer: raised (Pass 3 — prayer as mercy-seeking; 2Ch 33:13 prayer producing divine inner movement; H6279 a.tar intercession structure)
- **Status: COVERED**

**Reg 103 Love (C17)**
- xref_sharing: 13 shared terms (chesed family — H2617A, H7356B etc.)
- dimension_overlap: 3 dimensions (Divine-Human Correspondence, Moral Character, Relational Disposition)
- SD pointer: raised (Pass 1, Pass 2, Pass 3 — love → mercy causal chain; 1Jo 4:10; Eph 2:4; Psa 51:1 three-registry convergence)
- **Status: COVERED — high priority pointer raised**

**Reg 68 Grace (C17)**
- xref_sharing: 10 shared terms (cha.nan family)
- dimension_overlap: 3 dimensions (Dependence/Creatureliness, Moral Character, Relational Disposition)
- CHANAN/CHEN root code collision noted (CI-002): root signal suppressed
- SD pointer: The mercy-grace connection is documented through cha.nan vocabulary sharing (Psa 51:1). Section 5 of Session C covers this connection.
- **Gap-fill SD pointer raised:** Does the cha.nan root family connect mercy and grace as expressions of the same underlying Hebrew theological concept, or are they distinct? The CHANAN/CHEN root code collision between Reg 111 and Reg 68 means this cannot be verified from root signals — it must be examined from the verse evidence. Session D.
- **Status: COVERED — root gap noted**

**Reg 73 Guilt (C13)** — cross-cluster
- xref_sharing: 9 shared terms (cha.nan-related grace vocabulary)
- dimension_overlap: not in top-17 — different cluster (C13 vs C17)
- Connection nature: Guilt is the condition that mercy addresses; the cha.nan/te.chin.nah vocabulary mediates between them
- SD pointer: not explicitly raised in Passes 1–5.
- **Gap-fill SD pointer:** Reg 73 guilt shares 9 terms with mercy — primarily the supplication vocabulary. Does the guilt vocabulary encode the inner condition (awareness of guilt) that generates the mercy appeal? Is guilt the anthropological precondition of mercy-seeking? Session D to examine the guilt-mercy relationship, especially the inner-awareness dimension of guilt (Psa 31:9, Dan 9:20 — knowing the affliction of one's heart).
- **Status: GAP-FILL ADDED**

**Reg 99 Kindness (C17)**
- xref_sharing: 7 shared terms (chesed family)
- dimension_overlap: 4 dimensions — same profile as compassion
- Session C Section 5 covers this. SD pointer implicit in the chesed vocabulary sharing.
- **Gap-fill SD pointer:** The chesed family is shared across mercy, love, kindness, loyalty, and faithfulness. Does chesed belong to all equally, or does it have a primary registration? Session D to examine chesed's registry allocation.
- **Status: COVERED in Session C Section 5; SD pointer added**

**Reg 104 Loyalty (C18)** — cross-cluster
- xref_sharing: 6 shared terms (H2617A chesed terms)
- dimension_overlap: not in top-17
- Connection: chesed root carries both mercy and loyalty; the covenantal dimension of mercy
- SD pointer: implicit in the chesed cross-registry observation. Session C Section 5 covers.
- **Status: COVERED**

**Reg 59 Faith (C15)** — cross-cluster
- xref_sharing: 6 shared terms (H2617A chesed family)
- dimension_overlap: not in top-17 (different cluster)
- Connection: chesed/faithfulness vocabulary shared; Rom 3:25 (faith as access to hilastērios)
- SD pointer: raised in Pass 3 (faith as mercy-seat access, Rom 3:25)
- **Status: COVERED**

**Reg 46 Devotion (C08)** — cross-cluster
- xref_sharing: 6 shared terms (H2617A chesed family)
- Connection: chasid (devout/godly person) derives from chesed — devotion shaped by covenantal mercy
- SD pointer: not explicitly raised.
- **Gap-fill SD pointer:** H2623 chasid (the devout/godly person) is shaped by and named for chesed (covenantal loyalty/mercy). Does devotion represent the human character formed by received mercy? Is the chasid person structurally the one who has internalised mercy? Session D.
- **Status: GAP-FILL ADDED**

**Reg 146 Shame (C06)** — cross-cluster
- xref_sharing: 4 shared terms (H2617A chesed family — shame and chesed travel together in several psalms)
- dimension_overlap: not in top-17
- SD pointer: raised in Pass 3 (Eze 16:63 — mercy-induced shame as distinct from shame-of-exposure)
- **Status: COVERED**

**Reg 179 Yearning (C04), Reg 43 Desire (C04), Reg 42 Delight (C03)**
- xref_sharing: 3 shared terms each (H2551, H2550, H4263 — chamad/machmad family)
- These connect mercy to the inner yearning/desire vocabulary through the chamad root
- SD pointer: not raised explicitly. The connection is through the pity-vocabulary (H2550/chamad = to have pity, compassion for)
- **Gap-fill SD pointer:** H2550 (chamad — to show compassion/pity) and H2551 (chemlah — compassion/pity) connect mercy to the desire/yearning vocabulary family. Does compassion share a root with desire in Hebrew? Is the pity felt for another person structurally related to the longing/desire vocabulary? Session D.
- **Status: GAP-FILL ADDED**

**Reg 76 Holiness (C16)** — cross-cluster
- xref_sharing: 2 shared terms (G3741 hosios, G3742 hosiotes — holiness vocabulary within the mercy registry)
- dimension_overlap: not in top-17
- SD pointer: raised in Pass 3 (holiness and mercy as co-requisites of covenantal character; 1Th 2:10; Luk 1:74-75)
- **Status: COVERED**

**Reg 188 Weeping (C05), Reg 89 Iniquity (C11)**
- xref_sharing: 1 shared term each (H4480A min- — a preposition/particle)
- These are weak signals; the shared term is a high-frequency particle
- **Status: No SD pointer required — signal too weak for analytical connection**

**Reg 159 Testimony (C16)**
- xref_sharing: 1 shared term (H5750 od — the testimony/witness root family)
- H5750 od carries root code OD; the "witness" related words include testimony vocabulary
- **Status: Noted — too weak for substantive SD pointer**

**Reg 60 Faithfulness (C10)** — cross-cluster
- xref_sharing: 1 shared term (H2617A chesed)
- Session C Section 5 covers.
- **Status: COVERED**

**Reg 49 Discernment (C02), Reg 44 Despair (C06)**
- xref_sharing: 1 shared term each (H3819 Lo-Ruhamah)
- Lo-Ruhamah connects mercy to discernment (the perception of mercy's absence?) and despair (the inner experience of mercy withdrawn?)
- **Gap-fill SD pointer:** H3819 Lo-Ruhamah appears in Reg 49 (discernment) and Reg 44 (despair). What is the connection? Does the name "No Mercy" encode a discernment of one's relational standing before God, or does the experience of withheld mercy produce despair? The Lo-Ruhamah-despair connection is a structural observation about the inner experience of divine mercy's withdrawal. Session D.
- **Status: GAP-FILL ADDED**

**Dimension overlap — additional connections not in xref_sharing:**

**Reg 187 Strength, Reg 197 Authority, Reg 198 Might, Reg 199 Dominion (all C20)**
- dimension_overlap: 4 dimensions shared with mercy
- No xref_sharing signal — these connect through shared dimensions only
- The connection is dimensional: mercy and power both operate in Relational Disposition, Moral Character, Dependence/Creatureliness, Divine-Human Correspondence
- **SD pointer:** The strongest unexpected signal in Pass 6. Power/strength/dominion registries share all four of mercy's dimensions. Does this encode a structural relationship between mercy and power — mercy as the moral use of power toward the vulnerable? Session D: examine whether the power vocabulary and mercy vocabulary reflect the same divine inner character from two angles (power as the capacity, mercy as its direction toward the needy). Connection to Psa 78:38 (God restrains his wrath — mercy as the restraint of power).
- **Status: NEW SD POINTER — raised here**

**Reg 34 Covenant (C17)**
- dimension_overlap: 3 dimensions
- Session C Section 5 covers (theological connection: chesed as covenantal attribute)
- **Status: COVERED**

**Reg 62 Fellowship (C17)**
- dimension_overlap: 3 dimensions (Divine-Human Correspondence, Moral Character, Relational Disposition)
- The Divine-Human Correspondence dimension shared — mercy and fellowship both describe the restored divine-human relationship
- **Gap-fill SD pointer:** Fellowship shares Divine-Human Correspondence with mercy. Is mercy the ground on which fellowship becomes possible? Can fellowship exist without mercy as its foundation? Session D.
- **Status: GAP-FILL ADDED**

**Reg 64 Forgiveness (C17)**
- dimension_overlap: 3 dimensions (Dependence/Creatureliness, Moral Character, Relational Disposition)
- DIM-111-SD001 research flag explicitly names this connection (mercy-seat / Lo-Ruhamah polarity parallels forgiveness polarity in Reg 64)
- SD pointer: formally raised as DIM-111-SD001
- **Status: COVERED — highest priority for Session D**

**Reg 117 Peace (C17)**
- dimension_overlap: 3 dimensions
- Connection: mercy produces the conditions for peace (shalom); Isa 54:10 names both mercy and covenant of peace
- SD pointer: not explicitly raised in Passes 1–5
- **Gap-fill SD pointer:** Reg 117 peace shares 3 dimensions with mercy. Is peace the state that mercy produces in the restored relationship? Session D to examine whether peace and mercy form a sequential pair (mercy received → peace restored) in the prophetic tradition.
- **Status: GAP-FILL ADDED**

**Reg 206 Vulnerability (C22), Reg 210 Deadness (C21)** — cross-cluster
- dimension_overlap: 3 dimensions each
- Vulnerability shares the Dependence/Creatureliness dimension with mercy — vulnerability is the inner condition that generates the mercy appeal
- Deadness shares dimensions — the deadness that mercy addresses?
- **Gap-fill SD pointer:** Vulnerability (Reg 206) shares the Dependence/Creatureliness dimension with mercy — this is the dimension that describes the human condition that requires mercy. Is vulnerability the structural precondition of mercy-reception? Session D.
- **Status: GAP-FILL ADDED**
...
**Session C Section 5 connections vs. correlation-confirmed signals:**

| Section 5 Connection | Signal evidence | Confirmed? |
|---|---|---|
| Compassion (Reg 23) | xref=38, dim=4, root=ATAR | Formal — confirmed |
| Grace (Reg 68) | xref=10, dim=3 | Formal — confirmed (root gap noted) |
| Love (Reg 103) | xref=13, dim=3 | Formal — confirmed |
| Forgiveness (Reg 64) | dim=3, DIM-111-SD001 | Formal + theological — confirmed |
| Prayer (Reg 212) | xref=14 | Formal — confirmed |
| Kindness (Reg 99) | xref=7, dim=4 | Formal — confirmed |
| Loyalty (Reg 104) | xref=6 | Formal — confirmed |
| Covenant (Reg 34) | dim=3 | Theological — confirmed |
| Holiness (Reg 76) | xref=2 | Formal — confirmed |
| Iniquity (Reg 89) | xref=1 | Formal (weak) — confirmed |
| Weeping (Reg 188) | xref=1 | Formal (weak) — confirmed |
| Shame (Reg 146) | xref=4 | Formal — confirmed |
| Flesh (Reg 185) | No xref/dim signal | Inferential — not confirmed by signal data |

**One correction required for Section 5 (SB-7/SB-8):**
- Flesh (Reg 185): stated as theological connection in Section 5 but has no xref_sharing or dimension_overlap signal. Must be labelled explicitly as inferential in v2 update. The somatic evidence from Pass 4 (blood-atonement vocabulary, nephesh-as-atonement-recipient, splagchna) supports the connection analytically but this is not a formal signal confirmation.

**New connections to add to Section 5 (from Pass 6 gap-fills):**

| Connection | Signal | Nature |
|---|---|---|
| Guilt (Reg 73) | xref=9 | Formal — guilt as precondition of mercy-seeking |
| Faith (Reg 59) | xref=6 | Formal — faith as mercy-seat access (Rom 3:25) |
| Strength/Power family (Reg 187/196/197/198/199) | dim=4 each | Formal (dim) — mercy as direction of power |
| Peace (Reg 117) | dim=3 | Formal (dim) — peace as mercy's relational outcome |
| Fellowship (Reg 62) | dim=3 | Formal (dim) — mercy as ground of fellowship |
| Vulnerability (Reg 206) | dim=3 | Formal (dim) — vulnerability as precondition of mercy |
| Devotion (Reg 46) | xref=6 | Formal — chasid as mercy-formed character |
| Yearning/Desire (Reg 179/43) | xref=3 | Formal (weak) — chamad/compassion overlap |

---

### SD pointer completeness check

**Pointers raised in Passes 1–5 — all grounded in specific data:** Confirmed. 20+ pointers verified.

**New pointers raised in Pass 6 (gap-fills):**
- Guilt as anthropological precondition of mercy-seeking (Reg 73)
- Chesed registry allocation — does chesed have a primary home? (Regs 99/103/104/60)
- Devotion formed by received mercy — chasid as mercy-internalised (Reg 46)
- Pity/desire vocabulary overlap — chamad (Regs 179/43/42)
- Strength/power/mercy structural relationship — mercy as moral direction of power (Regs 187–199)
- Peace as mercy's relational outcome (Reg 117)
- Fellowship grounded in mercy (Reg 62)
- Lo-Ruhamah/despair connection (Regs 49/44)
- Vulnerability as precondition of mercy (Reg 206)

**All correlation signals accounted for. No signal without at least one SD pointer.**

---

PASS 6 COMPLETE — D2 DELIVERY POINT REACHED
Date: 2026-04-11
All six correlation signals read. All connections verified. Session C Section 5 audited — one correction (Flesh connection must be labelled inferential), eight new connections to add.
SD pointer inventory complete — 30+ pointers captured across all passes.
Observations log version increments to v1.6 at Pass 6 boundary (D2 delivery point).
...
All five sections validated against Session B findings. No inaccurate statements found in v1 — all changes are additions or deepenings, not corrections, except the one reclassification in Section 5 (Flesh connection → inferential).

**Changes applied:**
- Section 1: Spirit-soul interface framing added; source description made precise
- Section 2: Self-knowledge as supplication prerequisite added; mercy→comfort causal chain added
- Section 3: 16 annotations updated; new content: Lev 16:14 (sevenfold sprinkling), Exo 25:22 (divine speech from mercy seat), Luk 18:13 (three-somatic-gesture analysis), Psa 51:1 (three-registry convergence), Psa 78:38 (mercy-atonement causal sequence), Eze 16:63 (mercy-induced shame distinct from condemnation-shame), Heb 2:17 (mercy-faithfulness pairing)
- Section 4: LXX bridge for eleos; oiktirmos/oiktirmōn root relationship; hilaskomai two-sense structure + classical reversal; kap.po.ret speech function; chinnam/cha.nan root connection
- Section 5: 8 new connections; 1 connection corrected (Flesh → inferential); signal evidence column added; root gap notes added
- Section 6: Complete update with Session B record

**Stage 3 complete. No field-level patch required from Stage 3. R4 not needed.**

STAGE 3 COMPLETE
Date: 2026-04-11
v2 word study produced. No field-level corrections required — no R4 needed.
Observations log version increments to v1.7 at Stage 3 boundary.
...
**Extract:** wa-111-mercy-complete-2026-04-11.json (R3 — post D2)
**File size:** 4,527,517 bytes (+25,997 bytes from R2 — consistent with 15 SD pointer flag descriptions + somatic flags + classification)

| Check | Item | Result |
|---|---|---|
| 1 | SOMATIC_INNER_LINK on H3722A | OK |
| 1 | SOMATIC_INNER_LINK on H3727 | OK |
| 1 | SOMATIC_INNER_LINK on H2603A | OK |
| 1 | SOMATIC_INNER_LINK on H8467 | OK |
| 2 | BODY_INNER_EXPRESSION on G2433 | OK |
| 2 | BODY_INNER_EXPRESSION on G3628 | OK |
| 2 | BODY_INNER_EXPRESSION on H2603A | OK |
| 2 | BODY_INNER_EXPRESSION on H8467 | OK |
| 3 | sb_classification = 'Spirit-soul interface' | OK |
| 3 | sb_classification_reasoning (784 chars) | OK |
| 4 | Total research flags = 16 | OK |
| 4 | DIM-111-SD001 + PH2-111-001 through PH2-111-015 | OK |
| 5 | active_term_count = 65 | OK |
| 5 | owner_term_count = 31 | OK |
| 5 | anchor_verse_count = 123 | OK |

**Note on SD_POINTER descriptions:** CC reports that descriptions were truncated from the directive's full text to avoid shell quoting issues. Core structural questions and Session D references preserved. Full original text archived in wa-111-mercy-sessionB-cc-directive-d2-v1-2026-04-11.md. No re-insertion required unless Session D identifies gaps in the pointer descriptions.

**Note on H2603A flag profile:** H2603A now carries four phase2 flags: CAUSATIVE_OF_INNER_STATE, RELATIONAL_DIRECTION (pre-existing from Stage 1/D1), SOMATIC_INNER_LINK, BODY_INNER_EXPRESSION. This is the richest flag profile in the registry and accurately reflects the structural complexity of cha.nan — it causes inner states, is relational in direction, has somatic grounding, and expresses inner states through the body.

**Result: ALL CHECKS PASS. R3 confirmed clean. Session B fully complete.**

SESSION B COMPLETE — Registry 111 (mercy)
Date: 2026-04-11
All three stages complete. All directives applied. R3 confirmed. v2 word study produced.
Observations log final version: v1.7.
