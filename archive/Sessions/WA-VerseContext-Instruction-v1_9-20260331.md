...
*WA-VerseContext-Instruction-v1.9-20260331 | Supersedes v1.8-20260331 | v1.9: Section 6.4 — unified file naming convention added for all Claude AI outputs; all VCB-batch files must follow wa-vcb-{batch_id}-{scope}-{version}-{date}.{ext}*
