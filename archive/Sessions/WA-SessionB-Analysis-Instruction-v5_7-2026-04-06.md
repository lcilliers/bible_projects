# WA-SessionB-Analysis-Instruction-v5_7-2026-04-06

**Framework B — Soul Word Analysis Programme**

**Session B Analysis Instruction**

Version 5.7 | April 2026 | Status: Active governing instruction

| **Document** | **Value** |
|---|---|
| Filename | WA-SessionB-Analysis-Instruction-v5.7-2026-04-06.md |
| Supersedes | WA-SessionB-Analysis-Instruction-v5.6-20260330.md |
| Change note | v5.7 — Section 5.6 added: Context description reliability — the `context_description` is a working label, not a complete characterisation. Empirical grounding from Level 1 Tier C audit (2026-04-06): review of the 10 highest-risk groups across the programme established that descriptions can compress 50–117 verses into a phrase that does not carry all the nuance present in the verse set, reach slightly beyond what the anchor verse explicitly states, or conflate two distinguishable uses of the same term. This does not invalidate the classification work but means the description alone is insufficient for analytical conclusions. Session B must read the anchor verse text before characterising what a group shows. Section 7 Step 5 reinforced: anchor verse reading is mandatory, not optional, regardless of how clear the context_description appears. |
| Companion documents | WA-SessionB-DataPrep-Instruction-v5.6 │ WA-SessionB-Extraction-Instruction-v5.6 │ WA-VerseContext-Instruction-v2.4 │ WA-Reference-v5.5 │ WA-Registry-Management-Guide-v5.7 |
...
### 5.6 Context description reliability — a programme-level finding

The `context_description` field in the pool dataset is a working label. It was formed during Verse Context classification as a summary of each contextual meaning group. It is the starting point for Session B analysis, not the conclusion.

**What the description can and cannot be trusted for:**

| Use | Reliability |
|---|---|
| Identifying what semantic range the group covers | Adequate — the description names the territory |
| Characterising the precise inner-being engagement | Insufficient alone — must be verified against the anchor verse |
| Supporting analytical conclusions in the narrative | Not sufficient — the anchor verse text is required |
| Session D synthesis input | Not sufficient — synthesis conclusions must trace to anchor verse evidence |

**Why this matters — empirical grounding:**

A Level 1 data quality audit (2026-04-06) reviewed the 10 highest-risk groups across the programme by verse volume and description length. The review established three recurring patterns:

1. **Compression:** Descriptions covering 50–117 verses can accurately name the dominant pattern while not representing internal variation within the verse set. A group described as "covenantal/relational knowing between God and Israel" may contain verses where the knowing is more transactional, more lament-driven, or more eschatological than the description suggests.

2. **Reach:** Some descriptions name the inner-being dimension accurately as an implication of what the anchor verse shows, rather than as what the verse explicitly states. "Falsehood as the inner orientation of the wicked" is an accurate characterisation, but the anchor verse (Pro 12:22 — "lying lips are an abomination to the Lord") names the external expression. The inner orientation is implied, not stated. Session B must not treat the description's claim as having the same evidential weight as a verse that names the inner dimension directly.

3. **Conflation:** Some descriptions hold together two distinguishable uses of the same term under one label. "Ya.tav as moral goodness and doing good: inner moral orientation" covers both the inner moral capacity (Jer 13:23 — can you do good who are accustomed to do evil?) and covenantal wellbeing (Deu 6:18 — do what is right and good that it may go well with you). These are related but not identical.

None of these patterns invalidate the classification work or require re-running Verse Context. They mean that the description is a reliable orientation, not a reliable characterisation.

**The operational rule:**

> Before making any analytical claim about a group in the Session B narrative, read the anchor verse text. If the anchor verse does not directly support the claim, the claim must be qualified or withdrawn. The description can suggest — the anchor verse must demonstrate.

This applies equally to Session D synthesis. Cross-registry patterns identified in Session D must trace back to anchor verse evidence, not to descriptions alone.

**Special status groups — 4986-001 (debauchery, salvation vocabulary):**

Group 4986-001 in registry 128 (debauchery, C12) contains 57 verses of salvation vocabulary (sōzō/sōtēria), anchored at Eph 2:8 ("by grace you have been saved through faith"). This group is structurally unexpected in its registry. Its presence reflects the verse evidence — salvation vocabulary appears in debauchery contexts and the classification was made on that basis. Session B analyst for debauchery should assess what the connection is: is salvation named as the remedy for debauchery specifically, or does the term appear in these contexts for a different reason? This is a Session B finding (DIM-128-001) and a Session D synthesis candidate.
...
| 5. Anchor verse reading | Read all anchor verses provided for all OWNER terms. Note contextual meaning groups and their descriptions. Follow the reading protocol in Section 5. **The `context_description` orients; the anchor verse text demonstrates. Do not characterise a group's inner-being engagement from the description alone — read the anchor verse first. Where the anchor verse does not directly support the description's claim, note the gap rather than treating the description as verified.** Note intra-pool cross-word observations as potential Session B findings. |
