# WA-VerseContext-Instruction-v1_6-20260330

**Framework B — Soul Word Analysis Programme**
**Verse Context Instruction — Integrated Claude AI and Claude Code**
**Version 1.6 | March 2026 | Status: Active governing instruction**

| **Document** | **Value** |
|---|---|
| Filename | WA-VerseContext-Instruction-v1.6-20260330.md |
| Supersedes | WA-VerseContext-Instruction-v1.5-20260330.md |
| Change note | v1.6 — Internal version strings corrected throughout: document title, version field, all produced_by and governing_instruction references in patch templates and batch JSON structure, and Annexure A startup template updated from v1.2 to match filename version. Companion document references updated to current versions (v1.1, v5.5, v5.6). No substantive content changes. v1.5 — Section 11.5: REPAIR patch requirement added; Claude Code expectations for audit_word re-run routine and Verse Context batch preparation routine on re-run added. Section 13.3: double-check verification rule added. v1.4 — Section 5.2: SQL policy statement added (G01/G08). Section 6.1: all-verses-fail error rule added (G05); partial completion rule updated (G02); revision documentation rule updated (G03). Section 6.2 Step 3: grouping criterion specified (G04). |
| Companion documents | WA-VerseContext-SetupInstruction-v1.1 │ WA-Reference-v5.5 │ WA-VerseContext-ImpactStudy-v3 │ WA-SessionB-DataPrep-Instruction-v5.6 |
...
```json
{
  ...
  "produced_by": "Claude Code — WA-VerseContext-Instruction v1.6",
  "governing_instruction": "WA-VerseContext-Instruction-v1.6-20260330.md",
  "total_verse_count": 0,
  "total_term_count": 0,
...
```json
{
  "_patch_meta": {
    ...
    "batch_id": "VCB-{nnn}",
    "produced_date": "{yyyy-mm-dd}",
    "produced_by": "WA-VerseContext-Instruction-v1.6",
...
```
Verse Context v1.6 startup complete.
Batch: {batch_id}
...
*WA-VerseContext-Instruction-v1.6-20260330 | Supersedes v1.5-20260330 | v1.6: internal version strings and companion document references corrected throughout — no substantive content changes*
