# Session A — Term `H2487` *cha.li.phah* — change
...
a single OWNER term — `H2487` *cha.li.phah* (change) from registry
134 renewal. It contains the STEP-sourced data for this one term only.
...
|---|---|---|---|
| `G0341` | anakainoō | to renew | Greek |
| `G0341` | anakainoō | to renew | Greek |
| `G0342` | anakainōsis | renewal | Greek |
| `G0342` | anakainōsis | renewal | Greek |
| `H2475` | cha.loph | destruction | Hebrew |
| `H2475` | cha.loph | destruction | Hebrew |
| `H2487` | cha.li.phah | change | Hebrew |
| `H2500` | che.leph | for | Hebrew |
| `H2500` | che.leph | for | Hebrew |
| `H4252` | ma.cha.laph | knife | Hebrew |
| `H4252` | ma.cha.laph | knife | Hebrew |
| `H4253` | ma.cha.la.phah | lock | Hebrew |
| `H4253` | ma.cha.la.phah | lock | Hebrew |
...
| `H2498` | cha.laph | to pass | — | to pass |
| `H2498` | cha.laph | to pass | 202 | transformation |
...
`mti_term_id = 1098`. On apply, Claude Code flips
...
*End of Session A prose for term H2487
(134 renewal).*
