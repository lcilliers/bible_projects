# Session A — Term `H7589` *she.at* — scorn

**Registry:** 189 malice  
**mti_term_id:** 1275  
**Language:** Hebrew  
**md_version:** `v1`  ⚠ the patch's `_patch_meta.input_versions[1275]` must equal `1` at submission time or the applicator will reject it as stale (A-03 version gate).  
...
a single OWNER term — `H7589` *she.at* (scorn) from registry
189 malice. It contains the STEP-sourced data for this one term only.
...
- `SHEAT` (Hebrew) — scorn — Backfilled 2026-04-09 from wa_term_related_words clustering

**Data-quality flags (informational):**

- `NO_WORD_ANALYSIS` — meaning field is null for H7589. STEP returned no word analysis block for this term.
- `PROSE_ONLY_MEANING` — Meaning for H7589 stored as single prose block. STEP medium_def contains no structured sense numbering. No further subdivision available.
- `VERSE_EVIDENCE_CONCENTRATED` — Only 3 confirmed verse records for H7589. Threshold is 5.
...
|---|---|---|
| `1275-001` | Term names malice as an inner disposition of the soul — the soul's rejoicing in another's destruction, driven by deep-seated enmity and contempt | active |

**Verses:**

**vid=54652** — `Eze 25:6`
*target word in verse:* `malice`
...
_Prior classification: **relevant** · **anchor** · group=`1275-001`_
...
**vid=54653** — `Eze 36:5`
*target word in verse:* `utter contempt`
...
_Prior classification: **relevant** · related · group=`1275-001`_
...
|---|---|---|---|
| `H7589` | she.at | scorn | Hebrew |

### XREF terms (OWNER elsewhere)

| Strong's | Translit. | Gloss | OWNER registry | OWNER word |
|---|---|---|---:|---|
| `G2549` | kakia | evil | — | evil |
| `G2549` | kakia | evil | 57 | evil |
| `G2556G` | kakos | evil/harm: evil | — | evil/harm: evil |
| `G2556G` | kakos | evil/harm: evil | 57 | evil |
| `G2556G` | kakos | evil/harm: evil | — | evil/harm: evil |
| `G2556H` | kakos | evil/harm: harm | — | evil/harm: harm |
| `G2556H` | kakos | evil/harm: harm | — | evil/harm: harm |
| `G2556H` | kakos | evil/harm: harm | 57 | evil/harm: harm |
| `G4189` | ponēria | evil | — | evil |
| `G4189` | ponēria | evil | — | evil |
| `G4189` | ponēria | evil | 57 | evil |
| `G4190` | ponēros | evil/bad | — | evil/bad |
| `G4190` | ponēros | evil/bad | — | evil/bad |
| `G4190` | ponēros | evil/bad | 57 | evil |
| `H4827` | me.ra | mischief | — | mischief |
| `H4827` | me.ra | mischief | — | mischief |
| `H4827` | me.ra | mischief | — | mischief |
| `H4827` | me.ra | mischief | — | mischief |
| `H4827` | me.ra | mischief | — | mischief |
| `H4827` | me.ra | mischief | — | mischief |
| `H4827` | me.ra | mischief | 5 | mischief |
| `H7451A` | ra | bad: harmful | — | bad: harmful |
| `H7451A` | ra | bad: harmful | — | bad: harmful |
| `H7451A` | ra | bad: harmful | — | bad: harmful |
| `H7451A` | ra | bad: harmful | — | bad: harmful |
| `H7451A` | ra | bad: harmful | — | bad: harmful |
| `H7451A` | ra | bad: harmful | — | bad: harmful |
| `H7451A` | ra | bad: harmful | 51 | distress |
| `H7451B` | ra | bad: evil | — | bad: evil |
| `H7451B` | ra | bad: evil | — | bad: evil |
| `H7451B` | ra | bad: evil | — | bad: evil |
| `H7451B` | ra | bad: evil | — | bad: evil |
| `H7451B` | ra | bad: evil | — | bad: evil |
| `H7451B` | ra | bad: evil | — | bad: evil |
| `H7451B` | ra | bad: evil | 5 | bad: evil |
| `H7451C` | ra.ah | distress: harm | — | distress: harm |
| `H7451C` | ra.ah | distress: harm | — | distress: harm |
| `H7451C` | ra.ah | distress: harm | — | distress: harm |
| `H7451C` | ra.ah | distress: harm | — | distress: harm |
| `H7451C` | ra.ah | distress: harm | — | distress: harm |
| `H7451C` | ra.ah | distress: harm | — | distress: harm |
| `H7451C` | ra.ah | distress: harm | 5 | anguish |
| `H7451H` | ra | bad: evil | — | bad: evil |
| `H7451H` | ra | bad: evil | — | bad: evil |
| `H7451H` | ra | bad: evil | — | bad: evil |
| `H7451H` | ra | bad: evil | — | bad: evil |
| `H7451H` | ra | bad: evil | — | bad: evil |
| `H7451H` | ra | bad: evil | — | bad: evil |
| `H7451H` | ra | bad: evil | 5 | bad: evil |
| `H7451I` | ra.ah | distress: evil | — | distress: evil |
| `H7451I` | ra.ah | distress: evil | — | distress: evil |
| `H7451I` | ra.ah | distress: evil | — | distress: evil |
| `H7451I` | ra.ah | distress: evil | — | distress: evil |
| `H7451I` | ra.ah | distress: evil | — | distress: evil |
| `H7451I` | ra.ah | distress: evil | — | distress: evil |
| `H7451I` | ra.ah | distress: evil | 51 | distress |
| `H7455` | ro.a | evil | — | evil |
| `H7455` | ro.a | evil | — | evil |
| `H7455` | ro.a | evil | — | evil |
| `H7455` | ro.a | evil | — | evil |
| `H7455` | ro.a | evil | — | evil |
| `H7455` | ro.a | evil | — | evil |
| `H7455` | ro.a | evil | — | evil |
| `H7455` | ro.a | evil | 151 | sorrow |
| `H7489A` | ra.a | be evil | — | be evil |
| `H7489A` | ra.a | be evil | — | be evil |
| `H7489A` | ra.a | be evil | — | be evil |
| `H7489A` | ra.a | be evil | — | be evil |
| `H7489A` | ra.a | be evil | — | be evil |
| `H7489A` | ra.a | be evil | — | be evil |
| `H7489A` | ra.a | be evil | 51 | distress |
| `H7489B` | ra.a | to shatter | — | to shatter |
| `H7489B` | ra.a | to shatter | — | to shatter |
| `H7489B` | ra.a | to shatter | — | to shatter |
| `H7489B` | ra.a | to shatter | — | to shatter |
| `H7489B` | ra.a | to shatter | — | to shatter |
| `H7489B` | ra.a | to shatter | — | to shatter |
| `H7489B` | ra.a | to shatter | 5 | to shatter |
| `H7590` | shut | to despise | — | to despise |
| `H7590` | shut | to despise | 190 | contempt |
...
`mti_term_id = 1275`. On apply, Claude Code flips
...
*End of Session A prose for term H7589
(189 malice).*
