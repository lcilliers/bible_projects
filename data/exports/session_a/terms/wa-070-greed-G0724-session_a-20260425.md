# Session A — Term `G0724` *harpagē* — plunder

**Registry:** 070 greed  
**mti_term_id:** 892  
**Language:** Greek  
**md_version:** `v1`  ⚠ the patch's `_patch_meta.input_versions[892]` must equal `1` at submission time or the applicator will reject it as stale (A-03 version gate).  
...
a single OWNER term — `G0724` *harpagē* (plunder) from registry
...
- **mti_term_id:** 892
- **STEP gloss:** plunder
- **Word-analysis gloss:** plunder
- **Mounce short def:** greediness, confiscation, robbery, plunder
- **Occurrence count:** 9

**Parsed senses:**

- `1` greediness, confiscation, robbery, plunder 
plunder, pillage; confiscation, robbery; greediness; the act of plundering, Heb. 10:34; prey, spoil Mt. 23:25; Lk. 11:39*
...
- `NO_WORD_ANALYSIS` — meaning field is null for G0724. STEP returned no word analysis block for this term.
- `PROSE_ONLY_MEANING` — Meaning for G0724 stored as single prose block. STEP medium_def contains no structured sense numbering. No further subdivision available.
- `VERSE_EVIDENCE_CONCENTRATED` — Only 3 confirmed verse records for G0724. Threshold is 5.
...
### G0724 · *harpagē* — 3 active verse(s)
...
|---|---|---|
| `892-001` | Term names greed as an inner-being condition of the person — the inner fullness of rapacious desire that contradicts external religious propriety, and whose opposite is the inner freedom that accepts loss with joy | active |

**Verses:**

**vid=167990** — `Mat 23:25`
...
_Prior classification: **relevant** · **anchor** · group=`892-001`_


**vid=167989** — `Luk 11:39`
*target word in verse:* `greed`
...
_Prior classification: **relevant** · related · group=`892-001`_


**vid=24867** — `Heb 10:34`
*target word in verse:* `plundering`
...
`mti_term_id = 892`. On apply, Claude Code flips
...
*End of Session A prose for term G0724
(070 greed).*
