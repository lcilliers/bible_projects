# WA-VerseContext-Instruction-v2_1-20260401
...
*WA-VerseContext-Instruction-v2.1-20260401 | Supersedes v2.0-20260331 | v2.1: (1) Section 6.2 Step 6: Classification block integrity rules added — unique group codes, mid-stream revision protocol with SUPERSEDED marking; (2) Section 6.4: observations file write discipline strengthened — per-term write with version increment and confirmation, session log version reference, new session startup confirmation; (3) Section 7.5 added: Decision context requirement — full verse texts, patch consequences, and Claude AI assessment required for all researcher decisions during patch construction*
