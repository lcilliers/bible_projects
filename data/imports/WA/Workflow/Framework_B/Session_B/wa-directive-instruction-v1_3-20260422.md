# wa-directive-instruction-v1_3-20260422

> Framework B Soul Word Analysis Programme — Directive Preparation and Execution
> Version: v1_3 | Date: 20260422
> Supersedes: wa-directive-instruction-v1_2-20260421.md (v1_0 consolidated addenda; v1_1 applied GR-REF-002 sweep; v1_2 added §10 Schema enablement directives; v1_3 tightens the directive-vs-patch boundary for prose lifecycle operations — routes all non-schema prose work to patches per wa-patch-instruction [current] §14)
  ...
  "operations": [
    {
      ...
      "record": {
        ...
        "version": 1,
        "author": "claude_ai",
        "source_file": "outputs/investigations/programme-prose-session-bundle-v1-20260421.md"
      }
    }
...
Patches are the primary mechanism. Directives are the remediation-and-investigation mechanism, and — per §10 — the schema enablement mechanism. When in doubt, prefer patches; directives exist because some tasks genuinely cannot be specified as patches in advance.

---

*wa-directive-instruction-v1_3-20260422 | Supersedes wa-directive-instruction-v1_2-20260421 | Prior (v1_2): §10 Schema enablement directives | Prior (v1_1): GR-REF-002 sweep | Prior (v1_0): consolidated global rules addenda ADD-PATCHDIR-002, -003, -005, -006, -008, -009 | v1_3 tightens the directive-vs-patch boundary for prose lifecycle (new §1.5 routing table + §10.7 hard exclusions) routing all non-schema prose work to patches per wa-patch-instruction [current] §14*
