...
**Filename:** wa-global-sessionC-prose-rule-v1-2026-04-13.md
**Date:** 2026-04-13
**Version:** 1.0
**Previous output ref:** wa-global-general-rules-v1-2026-04-13.json; wa-global-obs-schema-v1-2026-04-13.md; wa-global-pass-close-procedure-v1-2026-04-13.md
**Status:** Draft rule for incorporation into the Session C instruction document at its next revision.

## Change note
Version 1.0. Initial draft. Operationalises GR-OBS-006 (Session C prose must derive from observations) as a procedure that Session C writers must follow when producing reader-facing word studies.
