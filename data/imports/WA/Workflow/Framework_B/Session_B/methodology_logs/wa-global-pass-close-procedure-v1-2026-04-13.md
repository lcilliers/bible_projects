...
**Filename:** wa-global-pass-close-procedure-v1-2026-04-13.md
**Date:** 2026-04-13
**Version:** 1.0
**Previous output ref:** wa-global-general-rules-v1-2026-04-13.json; wa-global-obs-schema-v1-2026-04-13.md
**Status:** Draft procedure for incorporation into the Session B instruction document at its next revision.

## Change note
Version 1.0. Initial draft. The pass-close procedure is the mechanism that operationalises GR-PASS-001 (pass-close download) and GR-PASS-002 (write-on-discovery to database). It is to be added as a named procedure to the Session B instruction document and referenced from Session C and Session D instructions as applicable.
