...
>
> **v2_10 (20260427) — Architecture v2 addendum: Session B writes via the obslog-to-DB capture pipeline, not via patches.** Source-of-truth: [outputs/investigations/db-capture-phase1-results-and-table-architecture-v1-20260427.md](../../../outputs/investigations/db-capture-phase1-results-and-table-architecture-v1-20260427.md) Parts 10-12.
>
> Under v2:
>
