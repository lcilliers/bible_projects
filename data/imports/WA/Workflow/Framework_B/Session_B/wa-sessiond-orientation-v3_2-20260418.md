# wa-sessiond-orientation-v3_2-20260418

**Framework B — Soul Word Analysis Programme**
**Session D: Cross-Registry Synthesis**
Orientation and Process Instruction

Version 3_2 | 20260418 | Status: Active governing document

| **Document** | **Value** |
|---|---|
| Filename | wa-sessiond-orientation-v3_2-20260418.md |
| Supersedes | wa-sessiond-orientation-v3_1-20260414.md |
...
| Change note | **v3_2 (20260418):** GR-REF-002 sweep. (1) Filename migrated to current naming convention (underscored version, compact date, lowercase per GR-FILE-003/-007/-009). (2) Governing Rules section: stale `wa-global-general-rules-v2-20260414.json` → `[current]`; State-aloud example replaced with GR-LOAD-001 reference. (3) Companion documents row: retired `WA-SessionB-Instruction-v4.8`, `WA-Registry-Management-Guide-v5.8`, `WA-Reference-v5.5`, `patch_specification-v1.10` replaced with current corpus — wa-sessionb-analysis-readiness, wa-sessionb-analysis-output, wa-registry-management-guide, wa-reference, wa-patch-instruction — all `[current]`. (4) Footer refreshed. Historical v3.1 change note retained below.<br />**v3.1 (20260414):** Global rules integration. (1) Governing Rules header added — mandatory load of wa-global-general-rules-v2-20260414.json before session start. (2) Section 10.5 synthesis document filename example corrected from hyphenated date to compact date format per GR-FILE-009. (3) Companion document dates updated to compact format. (4) Footer date updated to compact format. |
| Companion documents | wa-sessionb-analysis-readiness [current] │ wa-sessionb-analysis-output [current] │ wa-registry-management-guide [current] │ wa-reference [current] │ wa-patch-instruction [current] │ wa-dimensionreview-instruction [current] |
...
- Filename: `wa-sd-[theme]-synthesis-v1-[date].md` — date in compact format YYYYMMDD per GR-FILE-009
...
*wa-sessiond-orientation-v3_2-20260418 | Supersedes wa-sessiond-orientation-v3_1-20260414 | v3_2: GR-REF-002 sweep — filename migrated to current naming convention; governing rules and companion documents use `[current]` token*

*Historical: WA-SessionD-Orientation-v3.1 | 20260414 | Supersedes v3.0-20260412 | Global rules integration; synthesis filename compact date corrected*
