# WA-SessionD-Orientation-v3.1-20260414

**Framework B — Soul Word Analysis Programme**
**Session D: Cross-Registry Synthesis**
Orientation and Process Instruction

Version 3.1 | 20260414 | Status: Active governing document

| **Document** | **Value** |
|---|---|
| Filename | WA-SessionD-Orientation-v3.1-20260414.md |
| Supersedes | WA-SessionD-Orientation-v3.0-20260412.md |
...
| Change note | v3.1 (20260414): Global rules integration. (1) Governing Rules header added — mandatory load of wa-global-general-rules-v2-20260414.json before session start. (2) Section 10.5 synthesis document filename example corrected from hyphenated date to compact date format per GR-FILE-009. (3) Companion document dates updated to compact format. (4) Footer date updated to compact format. |
| Companion documents | WA-SessionB-Instruction-v4.8-20260414 │ WA-Registry-Management-Guide-v5.8-20260412 │ WA-Reference-v5.5-20260330 │ patch_specification-v1.10-20260412 |
...
*WA-SessionD-Orientation-v3.1 | 20260414 | Supersedes v3.0-20260412 | Global rules integration; synthesis filename compact date corrected*
