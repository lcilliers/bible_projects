...
Version 1.0 | 20260416 | Status: Draft — for researcher review**

| **Document** | **Value** |
|---|---|
| Filename | wa-sessionb-analysis-readiness-v1-20260416.md |
| Supersedes | wa-global-sessionb-instruction-v5_0-20260415.md (Stage 1 only) |
| Companion documents | wa-global-general-rules-v2_2-20260415.json │ wa-dimensionreview-instruction-v[current].md │ wa-versecontext-instruction-v[current].md │ wa-sessionb-cc-instructions-v[current].md │ wa-patch-specification-v[current].md |
...
This instruction is governed by **wa-global-general-rules-v2_2-20260415.json**.

Claude AI must confirm the global rules file has been loaded before beginning any work. State aloud: *"Global rules wa-global-general-rules-v2_2-20260415.json loaded."*
...
**v1.0 (20260416):** New document. Extracted from wa-global-sessionb-instruction-v5_0-20260415.md Stage 1 and fully redesigned. Principal changes from v5.0 Stage 1:
...
*wa-sessionb-analysis-readiness-v1-20260416.md*
*Framework B — Soul Word Analysis Programme*
