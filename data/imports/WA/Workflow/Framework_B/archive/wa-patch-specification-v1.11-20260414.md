...
**Version:** 1.11 | **Date:** 20260414
**Filename:** wa-patch-specification-v1.11-20260414.md
**Applicator:** `scripts/apply_session_patch.py`
**Supersedes:** patch_specification v1.10-20260412

## Governing Rules

This document is governed by **wa-global-general-rules-v2-20260414.json**.

Claude AI must confirm the global rules file has been loaded before producing or applying any patch. Per GR-PROC-003: all database changes go through patches. Per GR-PROC-004: no patch is applied without researcher review.
...
*patch_specification_v1.10 | 20260412 | Supersedes v1.9-20260412 | Three applicator gaps documented: update on wa_session_research_flags unsupported; insert on wa_dimension_index unsupported; session_b_status null rejected for SDPOINTERS type*
