# WA-SessionB-ClaudeCode-Instructions
...
> This document is the single reference for Claude Code's role, responsibilities,
> and operational procedures within the Session B programme.
...
| Value | Meaning |
|-------|---------|
| NULL | No Session B work started |
| Ready for Analysis | Data preparation complete |
...
### 8.3 Evidential Status (new — wa_term_inventory.evidential_status)
| Value | Meaning |
|-------|---------|
...
### 8.4 Session B Flag Codes (new)
SB_FINDING | SB_DIMENSION | SB_INNER_BEING | SD_POINTER | SD_CLUSTER

### 8.5 Patch Types
PREANALYSIS | SESSIONB | SESSIOND | CLUSTERING
...
## 12. Engine and Script Status (v3.7.0)
